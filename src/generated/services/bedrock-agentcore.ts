...
export class BedrockAgentcoreActions {
	...
	static readonly CREATE_AGENT_RUNTIME_ENDPOINT =
		"bedrock-agentcore:CreateAgentRuntimeEndpoint";
	/** [Write] bedrock-agentcore:CreateApiKeyCredentialProvider */
	static readonly CREATE_API_KEY_CREDENTIAL_PROVIDER =
	...
	static readonly CREATE_DATASET_VERSION =
	...
	static readonly CREATE_GATEWAY_RATE_LIMIT =
	...
	static readonly CREATE_GATEWAY_TARGET =
	...
	static readonly CREATE_HARNESS_ENDPOINT =
	...
	static readonly CREATE_WORKLOAD_IDENTITY =
	...
	static readonly DELETE_AGENT_RUNTIME_ENDPOINT =
		"bedrock-agentcore:DeleteAgentRuntimeEndpoint";
	/** [Write] bedrock-agentcore:DeleteApiKeyCredentialProvider */
	static readonly DELETE_API_KEY_CREDENTIAL_PROVIDER =
		"bedrock-agentcore:DeleteApiKeyCredentialProvider";
	/** [Write] bedrock-agentcore:DeleteBatchEvaluation */
	static readonly DELETE_BATCH_EVALUATION =
	...
	static readonly DELETE_DATASET_EXAMPLES =
	...
	static readonly DELETE_GATEWAY_RATE_LIMIT =
	...
	static readonly DELETE_GATEWAY_TARGET =
	...
	static readonly DELETE_HARNESS_ENDPOINT =
	...
	static readonly DELETE_RECOMMENDATION =
	...
	static readonly DELETE_WORKLOAD_IDENTITY =
	...
	static readonly GET_AGENT_RUNTIME_ENDPOINT =
		"bedrock-agentcore:GetAgentRuntimeEndpoint";
	/** [Read] bedrock-agentcore:GetApiKeyCredentialProvider */
	static readonly GET_API_KEY_CREDENTIAL_PROVIDER =
	...
	static readonly GET_CAPACITY_PROVIDER =
	...
	static readonly GET_CODE_INTERPRETER_SESSION =
		"bedrock-agentcore:GetCodeInterpreterSession";
	/** [Read] bedrock-agentcore:GetConfigurationBundle */
	static readonly GET_CONFIGURATION_BUNDLE =
		"bedrock-agentcore:GetConfigurationBundle";
	/** [Read] bedrock-agentcore:GetConfigurationBundleVersion */
	static readonly GET_CONFIGURATION_BUNDLE_VERSION =
	...
	static readonly GET_GATEWAY_RATE_LIMIT =
	...
	static readonly GET_RESOURCE_OAUTH2_TOKEN =
		"bedrock-agentcore:GetResourceOauth2Token";
	/** [Read] bedrock-agentcore:GetResourcePaymentToken */
	static readonly GET_RESOURCE_PAYMENT_TOKEN =
	...
	static readonly GET_WORKLOAD_ACCESS_TOKEN =
		"bedrock-agentcore:GetWorkloadAccessToken";
	/** [Write] bedrock-agentcore:GetWorkloadAccessTokenForJWT */
	static readonly GET_WORKLOAD_ACCESS_TOKEN_FOR_JWT =
		"bedrock-agentcore:GetWorkloadAccessTokenForJWT";
	/** [Write] bedrock-agentcore:GetWorkloadAccessTokenForUserId */
	static readonly GET_WORKLOAD_ACCESS_TOKEN_FOR_USER_ID =
		"bedrock-agentcore:GetWorkloadAccessTokenForUserId";
	/** [Read] bedrock-agentcore:GetWorkloadIdentity */
	static readonly GET_WORKLOAD_IDENTITY =
	...
	static readonly LIST_AGENT_RUNTIME_ENDPOINTS =
		"bedrock-agentcore:ListAgentRuntimeEndpoints";
	/** [List] bedrock-agentcore:ListAgentRuntimeVersions */
	static readonly LIST_AGENT_RUNTIME_VERSIONS =
		"bedrock-agentcore:ListAgentRuntimeVersions";
	/** [List] bedrock-agentcore:ListAgentRuntimeVersionsByCapacityProvider */
	static readonly LIST_AGENT_RUNTIME_VERSIONS_BY_CAPACITY_PROVIDER =
	...
	static readonly LIST_GATEWAY_RATE_LIMITS =
	...
	static readonly LIST_MEMORY_EXTRACTION_JOBS =
	...
	static readonly LIST_POLICY_ENGINE_SUMMARIES =
	...
	static readonly LIST_POLICY_SUMMARIES =
	...
	static readonly LIST_REGISTRY_RECORDS =
	...
	static readonly LIST_WORKLOAD_IDENTITIES =
	...
	static readonly MANAGE_RESOURCE_SCOPED_POLICY =
		"bedrock-agentcore:ManageResourceScopedPolicy";
	/** [PermissionManagement] bedrock-agentcore:PartiallyAuthorizeActions */
	static readonly PARTIALLY_AUTHORIZE_ACTIONS =
		"bedrock-agentcore:PartiallyAuthorizeActions";
	/** [Write] bedrock-agentcore:PassCapacityProvider */
	static readonly PASS_CAPACITY_PROVIDER =
	...
	static readonly STOP_CODE_INTERPRETER_SESSION =
	...
	static readonly SYNCHRONIZE_GATEWAY_TARGETS =
	...
	static readonly UPDATE_DATASET_EXAMPLES =
	...
	static readonly UPDATE_GATEWAY_RATE_LIMIT =
	...
	static readonly UPDATE_GATEWAY_TARGET =
	...
	static readonly UPDATE_HARNESS_ENDPOINT =
	...
	static readonly UPDATE_WORKLOAD_IDENTITY =
		"bedrock-agentcore:UpdateWorkloadIdentity";

	/** All read-level actions. */
	static readonly READ_ACTIONS: string[] = [
		BedrockAgentcoreActions.COMPLETE_RESOURCE_TOKEN_AUTH,
		BedrockAgentcoreActions.CONNECT_BROWSER_AUTOMATION_STREAM,
		BedrockAgentcoreActions.CONNECT_BROWSER_LIVE_VIEW_STREAM,
		BedrockAgentcoreActions.GATEWAY_GET_WEB_ACL_FOR_RESOURCE,
		BedrockAgentcoreActions.GET_AB_TEST,
		BedrockAgentcoreActions.GET_AGENT_CARD,
		BedrockAgentcoreActions.GET_AGENT_RUNTIME,
		BedrockAgentcoreActions.GET_AGENT_RUNTIME_ENDPOINT,
		BedrockAgentcoreActions.GET_API_KEY_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.GET_BATCH_EVALUATION,
		BedrockAgentcoreActions.GET_BROWSER,
		BedrockAgentcoreActions.GET_BROWSER_PROFILE,
		BedrockAgentcoreActions.GET_BROWSER_SESSION,
		BedrockAgentcoreActions.GET_CAPACITY_PROVIDER,
		BedrockAgentcoreActions.GET_CODE_INTERPRETER,
		BedrockAgentcoreActions.GET_CODE_INTERPRETER_SESSION,
		BedrockAgentcoreActions.GET_CONFIGURATION_BUNDLE,
		BedrockAgentcoreActions.GET_CONFIGURATION_BUNDLE_VERSION,
		BedrockAgentcoreActions.GET_DATASET,
		BedrockAgentcoreActions.GET_EVALUATOR,
		BedrockAgentcoreActions.GET_EVENT,
		BedrockAgentcoreActions.GET_GATEWAY,
		BedrockAgentcoreActions.GET_GATEWAY_RATE_LIMIT,
		BedrockAgentcoreActions.GET_GATEWAY_RULE,
		BedrockAgentcoreActions.GET_GATEWAY_TARGET,
		BedrockAgentcoreActions.GET_HARNESS,
		BedrockAgentcoreActions.GET_HARNESS_ENDPOINT,
		BedrockAgentcoreActions.GET_MEMORY,
		BedrockAgentcoreActions.GET_MEMORY_RECORD,
		BedrockAgentcoreActions.GET_OAUTH2_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.GET_ONLINE_EVALUATION_CONFIG,
		BedrockAgentcoreActions.GET_PAYMENT_CONNECTOR,
		BedrockAgentcoreActions.GET_PAYMENT_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.GET_PAYMENT_INSTRUMENT,
		BedrockAgentcoreActions.GET_PAYMENT_INSTRUMENT_BALANCE,
		BedrockAgentcoreActions.GET_PAYMENT_MANAGER,
		BedrockAgentcoreActions.GET_PAYMENT_SESSION,
		BedrockAgentcoreActions.GET_POLICY,
		BedrockAgentcoreActions.GET_POLICY_ENGINE,
		BedrockAgentcoreActions.GET_POLICY_ENGINE_SUMMARY,
		BedrockAgentcoreActions.GET_POLICY_GENERATION,
		BedrockAgentcoreActions.GET_POLICY_GENERATION_SUMMARY,
		BedrockAgentcoreActions.GET_POLICY_SUMMARY,
		BedrockAgentcoreActions.GET_RECOMMENDATION,
		BedrockAgentcoreActions.GET_REGISTRY,
		BedrockAgentcoreActions.GET_REGISTRY_RECORD,
		BedrockAgentcoreActions.GET_RESOURCE_API_KEY,
		BedrockAgentcoreActions.GET_RESOURCE_OAUTH2_TOKEN,
		BedrockAgentcoreActions.GET_RESOURCE_PAYMENT_TOKEN,
		BedrockAgentcoreActions.GET_RESOURCE_POLICY,
		BedrockAgentcoreActions.GET_TOKEN_VAULT,
		BedrockAgentcoreActions.GET_WORKLOAD_IDENTITY,
		BedrockAgentcoreActions.INVOKE_REGISTRY_MCP,
		BedrockAgentcoreActions.LIST_API_KEY_CREDENTIAL_PROVIDERS,
		BedrockAgentcoreActions.LIST_OAUTH2_CREDENTIAL_PROVIDERS,
		BedrockAgentcoreActions.LIST_WORKLOAD_IDENTITIES,
		BedrockAgentcoreActions.SEARCH_REGISTRY_RECORDS,
	];
	/** All write-level actions. */
	static readonly WRITE_ACTIONS: string[] = [
		BedrockAgentcoreActions.ADD_DATASET_EXAMPLES,
		BedrockAgentcoreActions.BATCH_CREATE_MEMORY_RECORDS,
		BedrockAgentcoreActions.BATCH_DELETE_MEMORY_RECORDS,
		BedrockAgentcoreActions.BATCH_PUT_GATEWAY_RATE_LIMITS,
		BedrockAgentcoreActions.BATCH_UPDATE_MEMORY_RECORDS,
		BedrockAgentcoreActions.CREATE_AB_TEST,
		BedrockAgentcoreActions.CREATE_AGENT_RUNTIME,
		BedrockAgentcoreActions.CREATE_AGENT_RUNTIME_ENDPOINT,
		BedrockAgentcoreActions.CREATE_API_KEY_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.CREATE_BROWSER,
		BedrockAgentcoreActions.CREATE_BROWSER_PROFILE,
		BedrockAgentcoreActions.CREATE_CAPACITY_PROVIDER,
		BedrockAgentcoreActions.CREATE_CODE_INTERPRETER,
		BedrockAgentcoreActions.CREATE_CONFIGURATION_BUNDLE,
		BedrockAgentcoreActions.CREATE_DATASET,
		BedrockAgentcoreActions.CREATE_DATASET_VERSION,
		BedrockAgentcoreActions.CREATE_EVALUATOR,
		BedrockAgentcoreActions.CREATE_EVENT,
		BedrockAgentcoreActions.CREATE_GATEWAY,
		BedrockAgentcoreActions.CREATE_GATEWAY_RATE_LIMIT,
		BedrockAgentcoreActions.CREATE_GATEWAY_RULE,
		BedrockAgentcoreActions.CREATE_GATEWAY_TARGET,
		BedrockAgentcoreActions.CREATE_HARNESS,
		BedrockAgentcoreActions.CREATE_HARNESS_ENDPOINT,
		BedrockAgentcoreActions.CREATE_MEMORY,
		BedrockAgentcoreActions.CREATE_OAUTH2_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.CREATE_ONLINE_EVALUATION_CONFIG,
		BedrockAgentcoreActions.CREATE_PAYMENT_CONNECTOR,
		BedrockAgentcoreActions.CREATE_PAYMENT_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.CREATE_PAYMENT_INSTRUMENT,
		BedrockAgentcoreActions.CREATE_PAYMENT_MANAGER,
		BedrockAgentcoreActions.CREATE_PAYMENT_SESSION,
		BedrockAgentcoreActions.CREATE_POLICY,
		BedrockAgentcoreActions.CREATE_POLICY_ENGINE,
		BedrockAgentcoreActions.CREATE_REGISTRY,
		BedrockAgentcoreActions.CREATE_REGISTRY_RECORD,
		BedrockAgentcoreActions.CREATE_WORKLOAD_IDENTITY,
		BedrockAgentcoreActions.DELETE_AB_TEST,
		BedrockAgentcoreActions.DELETE_AGENT_RUNTIME,
		BedrockAgentcoreActions.DELETE_AGENT_RUNTIME_ENDPOINT,
		BedrockAgentcoreActions.DELETE_API_KEY_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.DELETE_BATCH_EVALUATION,
		BedrockAgentcoreActions.DELETE_BROWSER,
		BedrockAgentcoreActions.DELETE_BROWSER_PROFILE,
		BedrockAgentcoreActions.DELETE_CAPACITY_PROVIDER,
		BedrockAgentcoreActions.DELETE_CAPACITY_PROVIDER_SESSION,
		BedrockAgentcoreActions.DELETE_CODE_INTERPRETER,
		BedrockAgentcoreActions.DELETE_CONFIGURATION_BUNDLE,
		BedrockAgentcoreActions.DELETE_DATASET,
		BedrockAgentcoreActions.DELETE_DATASET_EXAMPLES,
		BedrockAgentcoreActions.DELETE_EVALUATOR,
		BedrockAgentcoreActions.DELETE_EVENT,
		BedrockAgentcoreActions.DELETE_GATEWAY,
		BedrockAgentcoreActions.DELETE_GATEWAY_RATE_LIMIT,
		BedrockAgentcoreActions.DELETE_GATEWAY_RULE,
		BedrockAgentcoreActions.DELETE_GATEWAY_TARGET,
		BedrockAgentcoreActions.DELETE_HARNESS,
		BedrockAgentcoreActions.DELETE_HARNESS_ENDPOINT,
		BedrockAgentcoreActions.DELETE_MEMORY,
		BedrockAgentcoreActions.DELETE_MEMORY_RECORD,
		BedrockAgentcoreActions.DELETE_OAUTH2_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.DELETE_ONLINE_EVALUATION_CONFIG,
		BedrockAgentcoreActions.DELETE_PAYMENT_CONNECTOR,
		BedrockAgentcoreActions.DELETE_PAYMENT_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.DELETE_PAYMENT_INSTRUMENT,
		BedrockAgentcoreActions.DELETE_PAYMENT_MANAGER,
		BedrockAgentcoreActions.DELETE_PAYMENT_SESSION,
		BedrockAgentcoreActions.DELETE_POLICY,
		BedrockAgentcoreActions.DELETE_POLICY_ENGINE,
		BedrockAgentcoreActions.DELETE_RECOMMENDATION,
		BedrockAgentcoreActions.DELETE_REGISTRY,
		BedrockAgentcoreActions.DELETE_REGISTRY_RECORD,
		BedrockAgentcoreActions.DELETE_RESOURCE_POLICY,
		BedrockAgentcoreActions.DELETE_WORKLOAD_IDENTITY,
		BedrockAgentcoreActions.EVALUATE,
		BedrockAgentcoreActions.GATEWAY_ASSOCIATE_WEB_ACL,
		BedrockAgentcoreActions.GATEWAY_DISASSOCIATE_WEB_ACL,
		BedrockAgentcoreActions.GET_WORKLOAD_ACCESS_TOKEN,
		BedrockAgentcoreActions.GET_WORKLOAD_ACCESS_TOKEN_FOR_JWT,
		BedrockAgentcoreActions.GET_WORKLOAD_ACCESS_TOKEN_FOR_USER_ID,
		BedrockAgentcoreActions.INVOKE_AGENT_RUNTIME,
		BedrockAgentcoreActions.INVOKE_AGENT_RUNTIME_COMMAND,
		BedrockAgentcoreActions.INVOKE_AGENT_RUNTIME_COMMAND_SHELL,
		BedrockAgentcoreActions.INVOKE_AGENT_RUNTIME_FOR_USER,
		BedrockAgentcoreActions.INVOKE_AGENT_RUNTIME_WITH_WEB_SOCKET_STREAM,
		BedrockAgentcoreActions.INVOKE_AGENT_RUNTIME_WITH_WEB_SOCKET_STREAM_FOR_USER,
		BedrockAgentcoreActions.INVOKE_CODE_INTERPRETER,
		BedrockAgentcoreActions.INVOKE_HARNESS,
		BedrockAgentcoreActions.PASS_CAPACITY_PROVIDER,
		BedrockAgentcoreActions.PROCESS_PAYMENT,
		BedrockAgentcoreActions.PUT_RESOURCE_POLICY,
		BedrockAgentcoreActions.PUT_SYSTEM_LOG_EVENTS,
		BedrockAgentcoreActions.SAVE_BROWSER_SESSION_PROFILE,
		BedrockAgentcoreActions.SET_TOKEN_VAULT_CMK,
		BedrockAgentcoreActions.START_BATCH_EVALUATION,
		BedrockAgentcoreActions.START_BROWSER_SESSION,
		BedrockAgentcoreActions.START_CODE_INTERPRETER_SESSION,
		BedrockAgentcoreActions.START_MEMORY_EXTRACTION_JOB,
		BedrockAgentcoreActions.START_POLICY_GENERATION,
		BedrockAgentcoreActions.START_RECOMMENDATION,
		BedrockAgentcoreActions.STOP_BATCH_EVALUATION,
		BedrockAgentcoreActions.STOP_BROWSER_SESSION,
		BedrockAgentcoreActions.STOP_CODE_INTERPRETER_SESSION,
		BedrockAgentcoreActions.STOP_RUNTIME_SESSION,
		BedrockAgentcoreActions.SUBMIT_REGISTRY_RECORD_FOR_APPROVAL,
		BedrockAgentcoreActions.UPDATE_AB_TEST,
		BedrockAgentcoreActions.UPDATE_AGENT_RUNTIME,
		BedrockAgentcoreActions.UPDATE_AGENT_RUNTIME_ENDPOINT,
		BedrockAgentcoreActions.UPDATE_API_KEY_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.UPDATE_BROWSER_STREAM,
		BedrockAgentcoreActions.UPDATE_CAPACITY_PROVIDER,
		BedrockAgentcoreActions.UPDATE_CONFIGURATION_BUNDLE,
		BedrockAgentcoreActions.UPDATE_DATASET,
		BedrockAgentcoreActions.UPDATE_DATASET_EXAMPLES,
		BedrockAgentcoreActions.UPDATE_EVALUATOR,
		BedrockAgentcoreActions.UPDATE_GATEWAY,
		BedrockAgentcoreActions.UPDATE_GATEWAY_RATE_LIMIT,
		BedrockAgentcoreActions.UPDATE_GATEWAY_RULE,
		BedrockAgentcoreActions.UPDATE_GATEWAY_TARGET,
		BedrockAgentcoreActions.UPDATE_HARNESS,
		BedrockAgentcoreActions.UPDATE_HARNESS_ENDPOINT,
		BedrockAgentcoreActions.UPDATE_MEMORY,
		BedrockAgentcoreActions.UPDATE_OAUTH2_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.UPDATE_ONLINE_EVALUATION_CONFIG,
		BedrockAgentcoreActions.UPDATE_PAYMENT_CONNECTOR,
		BedrockAgentcoreActions.UPDATE_PAYMENT_CREDENTIAL_PROVIDER,
		BedrockAgentcoreActions.UPDATE_PAYMENT_MANAGER,
		BedrockAgentcoreActions.UPDATE_POLICY,
		BedrockAgentcoreActions.UPDATE_POLICY_ENGINE,
		BedrockAgentcoreActions.UPDATE_REGISTRY,
		BedrockAgentcoreActions.UPDATE_REGISTRY_RECORD,
		BedrockAgentcoreActions.UPDATE_REGISTRY_RECORD_STATUS,
		BedrockAgentcoreActions.UPDATE_WORKLOAD_IDENTITY,
	];
	/** All list-level actions. */
	static readonly LIST_ACTIONS: string[] = [
		BedrockAgentcoreActions.GATEWAY_LIST_RESOURCES_FOR_WEB_ACL,
		BedrockAgentcoreActions.LIST_AB_TESTS,
		BedrockAgentcoreActions.LIST_ACTORS,
		BedrockAgentcoreActions.LIST_AGENT_RUNTIME_ENDPOINTS,
		BedrockAgentcoreActions.LIST_AGENT_RUNTIME_VERSIONS,
		BedrockAgentcoreActions.LIST_AGENT_RUNTIME_VERSIONS_BY_CAPACITY_PROVIDER,
		BedrockAgentcoreActions.LIST_AGENT_RUNTIMES,
		BedrockAgentcoreActions.LIST_BATCH_EVALUATIONS,
		BedrockAgentcoreActions.LIST_BROWSER_PROFILES,
		BedrockAgentcoreActions.LIST_BROWSER_SESSIONS,
		BedrockAgentcoreActions.LIST_BROWSERS,
		BedrockAgentcoreActions.LIST_CAPACITY_PROVIDERS,
		BedrockAgentcoreActions.LIST_CODE_INTERPRETER_SESSIONS,
		BedrockAgentcoreActions.LIST_CODE_INTERPRETERS,
		BedrockAgentcoreActions.LIST_CONFIGURATION_BUNDLE_VERSIONS,
		BedrockAgentcoreActions.LIST_CONFIGURATION_BUNDLES,
		BedrockAgentcoreActions.LIST_DATASET_EXAMPLES,
		BedrockAgentcoreActions.LIST_DATASET_VERSIONS,
		BedrockAgentcoreActions.LIST_DATASETS,
		BedrockAgentcoreActions.LIST_EVALUATORS,
		BedrockAgentcoreActions.LIST_EVENTS,
		BedrockAgentcoreActions.LIST_GATEWAY_RATE_LIMITS,
		BedrockAgentcoreActions.LIST_GATEWAY_RULES,
		BedrockAgentcoreActions.LIST_GATEWAY_TARGETS,
		BedrockAgentcoreActions.LIST_GATEWAYS,
		BedrockAgentcoreActions.LIST_HARNESS_ENDPOINTS,
		BedrockAgentcoreActions.LIST_HARNESS_VERSIONS,
		BedrockAgentcoreActions.LIST_HARNESSES,
		BedrockAgentcoreActions.LIST_MEMORIES,
		BedrockAgentcoreActions.LIST_MEMORY_EXTRACTION_JOBS,
		BedrockAgentcoreActions.LIST_MEMORY_RECORDS,
		BedrockAgentcoreActions.LIST_ONLINE_EVALUATION_CONFIGS,
		BedrockAgentcoreActions.LIST_PAYMENT_CONNECTORS,
		BedrockAgentcoreActions.LIST_PAYMENT_CREDENTIAL_PROVIDERS,
		BedrockAgentcoreActions.LIST_PAYMENT_INSTRUMENTS,
		BedrockAgentcoreActions.LIST_PAYMENT_MANAGERS,
		BedrockAgentcoreActions.LIST_PAYMENT_SESSIONS,
		BedrockAgentcoreActions.LIST_POLICIES,
		BedrockAgentcoreActions.LIST_POLICY_ENGINE_SUMMARIES,
		BedrockAgentcoreActions.LIST_POLICY_ENGINES,
		BedrockAgentcoreActions.LIST_POLICY_GENERATION_ASSETS,
		BedrockAgentcoreActions.LIST_POLICY_GENERATION_SUMMARIES,
		BedrockAgentcoreActions.LIST_POLICY_GENERATIONS,
		BedrockAgentcoreActions.LIST_POLICY_SUMMARIES,
		BedrockAgentcoreActions.LIST_RECOMMENDATIONS,
		BedrockAgentcoreActions.LIST_REGISTRIES,
		BedrockAgentcoreActions.LIST_REGISTRY_RECORDS,
		BedrockAgentcoreActions.LIST_SESSIONS,
		BedrockAgentcoreActions.LIST_TAGS_FOR_RESOURCE,
		BedrockAgentcoreActions.RETRIEVE_MEMORY_RECORDS,
	];
	/** All permission-management-level actions. */
	static readonly PERMISSION_MANAGEMENT_ACTIONS: string[] = [
		BedrockAgentcoreActions.ALLOW_VENDED_LOG_DELIVERY_FOR_RESOURCE,
		BedrockAgentcoreActions.AUTHORIZE_ACTION,
		BedrockAgentcoreActions.INVOKE_GATEWAY,
		BedrockAgentcoreActions.INVOKE_WEB_SEARCH,
		BedrockAgentcoreActions.MANAGE_ADMIN_POLICY,
		BedrockAgentcoreActions.MANAGE_RESOURCE_SCOPED_POLICY,
		BedrockAgentcoreActions.PARTIALLY_AUTHORIZE_ACTIONS,
		BedrockAgentcoreActions.SYNCHRONIZE_GATEWAY_TARGETS,
	];
	/** All tagging-level actions. */
	static readonly TAGGING_ACTIONS: string[] = [
		BedrockAgentcoreActions.TAG_RESOURCE,
		BedrockAgentcoreActions.UNTAG_RESOURCE,
	];
}

const AbTestArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):bedrock-agentcore:(?<region>[^:]*):(?<account>[^:]*):ab-test/(?<abTestId>[^:/?]+)$",
);
const ApikeycredentialproviderArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):bedrock-agentcore:(?<region>[^:]*):(?<account>[^:]*):token-vault/(?<tokenVaultId>[^:/?]+)/apikeycredentialprovider/(?<name>[^:/?]+)$",
);
const BatchEvaluateArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):bedrock-agentcore:(?<region>[^:]*):(?<account>[^:]*):batch-evaluate/(?<batchEvaluationId>[^:/?]+)$",
);
const BrowserArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):bedrock-agentcore:(?<region>[^:]*):aws:browser/(?<browserId>[^:/?]+)$",
);
const BrowserCustomArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):bedrock-agentcore:(?<region>[^:]*):(?<account>[^:]*):browser-custom/(?<browserId>[^:/?]+)$",
);
const BrowserProfileArnRegex = new RegExp(
...
const EvaluatorArnRegex = new RegExp(
...
const WorkloadIdentityDirectoryArnRegex = new RegExp(
...
export class BedrockAgentcoreResources {
	 ...
	 */
	static parseAbTestArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		abTestId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseApikeycredentialproviderArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		tokenVaultId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseBatchEvaluateArn(arn: string): {
		partition: string;
		region: string;
		account: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseBrowserArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		browserId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseBrowserCustomArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		browserId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseBrowserProfileArn(arn: string): {
		partition: string;
		region: string;
		account: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseCodeInterpreterArn(arn: string): {
		partition: string;
		region: string;
		account: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseCodeInterpreterCustomArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		codeInterpreterId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseConfigurationBundleArn(arn: string): {
		partition: string;
		region: string;
		account: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseEvaluatorArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		evaluatorId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseHarnessArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		harnessId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseHarnessEndpointArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		harnessId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseMemoryArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		memoryId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseOauth2credentialproviderArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		tokenVaultId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseOnlineEvaluationConfigArn(arn: string): {
		partition: string;
		region: string;
		account: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parsePaymentManagerArn(arn: string): {
		partition: string;
		region: string;
		account: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parsePaymentcredentialproviderArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		tokenVaultId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parsePolicyEngineArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		policyEngineId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parsePolicyGenerationArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		policyEngineId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseRecommendationArn(arn: string): {
		partition: string;
		region: string;
		account: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseRuntimeArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		runtimeId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseRuntimeEndpointArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		runtimeId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseTokenVaultArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		tokenVaultId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseWebSearchArn(arn: string): {
		partition: string;
		region: string;
		account: string;
	} {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseWorkloadIdentityArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		directoryId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseWorkloadIdentityDirectoryArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		directoryId: string;
...
export class BedrockAgentcoreOperations {
	...
	static readonly CREATE_AGENT_RUNTIME_ENDPOINT: string[] = [
		"bedrock-agentcore:CreateAgentRuntimeEndpoint",
		"bedrock-agentcore:TagResource",
	];
	/** IAM actions required for the CreateApiKeyCredentialProvider API call. */
	static readonly CREATE_API_KEY_CREDENTIAL_PROVIDER: string[] = [
		"bedrock-agentcore:CreateApiKeyCredentialProvider",
		"bedrock-agentcore:TagResource",
	];
	/** IAM actions required for the CreateBrowser API call. */
	static readonly CREATE_BROWSER: string[] = [
		"bedrock-agentcore:CreateBrowser",
		"iam:PassRole",
		"bedrock-agentcore:TagResource",
	];
	/** IAM actions required for the CreateBrowserProfile API call. */
	static readonly CREATE_BROWSER_PROFILE: string[] = [
		"bedrock-agentcore:CreateBrowserProfile",
		"bedrock-agentcore:TagResource",
	];
	...
	static readonly CREATE_CODE_INTERPRETER: string[] = [
		"bedrock-agentcore:CreateCodeInterpreter",
		"iam:PassRole",
		"bedrock-agentcore:TagResource",
	];
	/** IAM actions required for the CreateConfigurationBundle API call. */
	static readonly CREATE_CONFIGURATION_BUNDLE: string[] = [
		"bedrock-agentcore:CreateConfigurationBundle",
		"bedrock-agentcore:TagResource",
	];
	...
	static readonly CREATE_DATASET_VERSION: string[] = [
		"bedrock-agentcore:CreateDatasetVersion",
	];
	/** IAM actions required for the CreateEvaluator API call. */
	static readonly CREATE_EVALUATOR: string[] = [
	...
	static readonly CREATE_POLICY_ENGINE: string[] = [
	...
	static readonly CREATE_WORKLOAD_IDENTITY: string[] = [
		"bedrock-agentcore:CreateWorkloadIdentity",
		"bedrock-agentcore:TagResource",
	];
	...
	static readonly DELETE_CAPACITY_PROVIDER_SESSION: string[] = [
		"bedrock-agentcore:DeleteCapacityProviderSession",
	];
	/** IAM actions required for the DeleteCodeInterpreter API call. */
	static readonly DELETE_CODE_INTERPRETER: string[] = [
		"bedrock-agentcore:DeleteCodeInterpreter",
	];
	/** IAM actions required for the DeleteConfigurationBundle API call. */
	static readonly DELETE_CONFIGURATION_BUNDLE: string[] = [
		"bedrock-agentcore:DeleteConfigurationBundle",
	];
	...
	static readonly DELETE_DATASET_EXAMPLES: string[] = [
		"bedrock-agentcore:DeleteDatasetExamples",
	];
	/** IAM actions required for the DeleteEvaluator API call. */
	static readonly DELETE_EVALUATOR: string[] = [
	...
	static readonly DELETE_POLICY_ENGINE: string[] = [
		"bedrock-agentcore:DeletePolicyEngine",
	];
	/** IAM actions required for the DeleteRecommendation API call. */
	static readonly DELETE_RECOMMENDATION: string[] = [
		"bedrock-agentcore:DeleteRecommendation",
	];
	/** IAM actions required for the DeleteRegistry API call. */
	static readonly DELETE_REGISTRY: string[] = [
	...
	static readonly DELETE_WORKLOAD_IDENTITY: string[] = [
		"bedrock-agentcore:DeleteWorkloadIdentity",
	];
	...
	static readonly GET_HARNESS_ENDPOINT: string[] = [
	...
	static readonly GET_RESOURCE_API_KEY: string[] = [
		"bedrock-agentcore:GetResourceApiKey",
	];
	/** IAM actions required for the GetResourceOauth2Token API call. */
	static readonly GET_RESOURCE_OAUTH2_TOKEN: string[] = [
		"bedrock-agentcore:GetResourceOauth2Token",
	];
	/** IAM actions required for the GetResourcePaymentToken API call. */
	static readonly GET_RESOURCE_PAYMENT_TOKEN: string[] = [
		"bedrock-agentcore:GetResourcePaymentToken",
	];
	...
	static readonly INVOKE_CODE_INTERPRETER: string[] = [
		"bedrock-agentcore:InvokeCodeInterpreter",
		"bedrock-agentcore:StartCodeInterpreterSession",
	];
	/** IAM actions required for the InvokeHarness API call. */
	static readonly INVOKE_HARNESS: string[] = [
		"bedrock-agentcore:InvokeAgentRuntime",
	...
	static readonly LIST_EVALUATORS: string[] = [
	...
	static readonly LIST_HARNESS_ENDPOINTS: string[] = [
		"bedrock-agentcore:ListHarnessEndpoints",
	];
	/** IAM actions required for the ListHarnessVersions API call. */
	static readonly LIST_HARNESS_VERSIONS: string[] = [
		"bedrock-agentcore:ListHarnessVersions",
	];
	/** IAM actions required for the ListHarnesses API call. */
	static readonly LIST_HARNESSES: string[] = [
	...
	static readonly LIST_POLICY_ENGINE_SUMMARIES: string[] = [
		"bedrock-agentcore:ListPolicyEngineSummaries",
	];
	/** IAM actions required for the ListPolicyEngines API call. */
	static readonly LIST_POLICY_ENGINES: string[] = [
		"bedrock-agentcore:ListPolicyEngines",
	];
	/** IAM actions required for the ListPolicyGenerationAssets API call. */
	static readonly LIST_POLICY_GENERATION_ASSETS: string[] = [
		"bedrock-agentcore:ListPolicyGenerationAssets",
	];
	/** IAM actions required for the ListPolicyGenerationSummaries API call. */
	static readonly LIST_POLICY_GENERATION_SUMMARIES: string[] = [
		"bedrock-agentcore:ListPolicyGenerationSummaries",
	];
	...
	static readonly LIST_POLICY_SUMMARIES: string[] = [
		"bedrock-agentcore:ListPolicySummaries",
	];
	...
	static readonly LIST_REGISTRIES: string[] = [
	...
	static readonly LIST_WORKLOAD_IDENTITIES: string[] = [
		"bedrock-agentcore:ListWorkloadIdentities",
	];
	/** IAM actions required for the ProcessPayment API call. */
	static readonly PROCESS_PAYMENT: string[] = [
	...
	static readonly SYNCHRONIZE_GATEWAY_TARGETS: string[] = [
		"bedrock-agentcore:SynchronizeGatewayTargets",
	];
	...
	static readonly UPDATE_CONFIGURATION_BUNDLE: string[] = [
		"bedrock-agentcore:UpdateConfigurationBundle",
	];
	...
	static readonly UPDATE_WORKLOAD_IDENTITY: string[] = [
		"bedrock-agentcore:UpdateWorkloadIdentity",
	];
}
...
export class BedrockAgentcoreConditions {
	...
	static readonly BATCH_CREATE_MEMORY_RECORDS_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:namespace",
	];
	/** Condition keys applicable to the BatchUpdateMemoryRecords action. */
	static readonly BATCH_UPDATE_MEMORY_RECORDS_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:namespace",
	];
	/** Condition keys applicable to the CompleteResourceTokenAuth action. */
	static readonly COMPLETE_RESOURCE_TOKEN_AUTH_CONDITION_KEYS: string[] = [
	...
	static readonly CREATE_AGENT_RUNTIME_CONDITION_KEYS: string[] = [
	...
	static readonly CREATE_AGENT_RUNTIME_ENDPOINT_CONDITION_KEYS: string[] = [
		"aws:RequestTag/${TagKey}",
		"aws:TagKeys",
	];
	/** Condition keys applicable to the CreateApiKeyCredentialProvider action. */
	static readonly CREATE_API_KEY_CREDENTIAL_PROVIDER_CONDITION_KEYS: string[] =
		["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateBrowser action. */
	static readonly CREATE_BROWSER_CONDITION_KEYS: string[] = [
		"aws:RequestTag/${TagKey}",
		"aws:TagKeys",
		"bedrock-agentcore:securityGroups",
		"bedrock-agentcore:subnets",
	...
	static readonly CREATE_BROWSER_PROFILE_CONDITION_KEYS: string[] = [
		"aws:RequestTag/${TagKey}",
		"aws:TagKeys",
	];
	...
	static readonly CREATE_CODE_INTERPRETER_CONDITION_KEYS: string[] = [
		"aws:RequestTag/${TagKey}",
		"aws:TagKeys",
		"bedrock-agentcore:securityGroups",
		"bedrock-agentcore:subnets",
	...
	static readonly CREATE_EVALUATOR_CONDITION_KEYS: string[] = [
		"aws:RequestTag/${TagKey}",
		"aws:ResourceTag/${TagKey}",
		"aws:TagKeys",
	];
	...
	static readonly GET_WORKLOAD_ACCESS_TOKEN_FOR_JWT_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:InboundJwtClaim/aud",
		"bedrock-agentcore:InboundJwtClaim/client_id",
		"bedrock-agentcore:InboundJwtClaim/iss",
		"bedrock-agentcore:InboundJwtClaim/scope",
	...
	static readonly GET_WORKLOAD_ACCESS_TOKEN_FOR_USER_ID_CONDITION_KEYS: string[] =
		["bedrock-agentcore:userid"];
	...
	static readonly LIST_MEMORY_RECORDS_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:namespace",
	...
	static readonly PUT_SYSTEM_LOG_EVENTS_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:runtimeSessionId",
	];
	/** Condition keys applicable to the RetrieveMemoryRecords action. */
	static readonly RETRIEVE_MEMORY_RECORDS_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:namespace",
		"bedrock-agentcore:strategyId",
	];
	/** Condition keys applicable to the StartMemoryExtractionJob action. */
	static readonly START_MEMORY_EXTRACTION_JOB_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:actorId",
		"bedrock-agentcore:sessionId",
		"bedrock-agentcore:strategyId",
	];
	...
	static readonly UPDATE_AGENT_RUNTIME_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:RuntimeAuthorizerType",
		"bedrock-agentcore:securityGroups",
		"bedrock-agentcore:subnets",
	];
	/** Condition keys applicable to the UpdatePaymentManager action. */
	static readonly UPDATE_PAYMENT_MANAGER_CONDITION_KEYS: string[] = [
		"bedrock-agentcore:DiscoveryUrl",
	];
