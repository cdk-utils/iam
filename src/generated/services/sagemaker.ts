...
export class SageMakerActions {
	...
	static readonly ASSOCIATE_TRIAL_COMPONENT = "sagemaker:AssociateTrialComponent";
	/** [Write] sagemaker:AttachClusterNodeVolume */
	static readonly ATTACH_CLUSTER_NODE_VOLUME = "sagemaker:AttachClusterNodeVolume";
	...
	static readonly BATCH_DELETE_CLUSTER_NODES = "sagemaker:BatchDeleteClusterNodes";
	/** [Read] sagemaker:BatchDescribeModelPackage */
	static readonly BATCH_DESCRIBE_MODEL_PACKAGE = "sagemaker:BatchDescribeModelPackage";
	...
	static readonly CREATE_AI_RECOMMENDATION_JOB = "sagemaker:CreateAIRecommendationJob";
	/** [Write] sagemaker:CreateAIWorkloadConfig */
	static readonly CREATE_AI_WORKLOAD_CONFIG = "sagemaker:CreateAIWorkloadConfig";
	...
	static readonly CREATE_CLUSTER_SCHEDULER_CONFIG = "sagemaker:CreateClusterSchedulerConfig";
	...
	static readonly CREATE_DATA_QUALITY_JOB_DEFINITION = "sagemaker:CreateDataQualityJobDefinition";
	...
	static readonly CREATE_EDGE_DEPLOYMENT_PLAN = "sagemaker:CreateEdgeDeploymentPlan";
	/** [Write] sagemaker:CreateEdgeDeploymentStage */
	static readonly CREATE_EDGE_DEPLOYMENT_STAGE = "sagemaker:CreateEdgeDeploymentStage";
	/** [Write] sagemaker:CreateEdgePackagingJob */
	static readonly CREATE_EDGE_PACKAGING_JOB = "sagemaker:CreateEdgePackagingJob";
	...
	static readonly CREATE_HUB_CONTENT_PRESIGNED_URLS = "sagemaker:CreateHubContentPresignedUrls";
	/** [Write] sagemaker:CreateHubContentReference */
	static readonly CREATE_HUB_CONTENT_REFERENCE = "sagemaker:CreateHubContentReference";
	...
	static readonly CREATE_HYPER_PARAMETER_TUNING_JOB = "sagemaker:CreateHyperParameterTuningJob";
	...
	static readonly CREATE_INFERENCE_COMPONENT = "sagemaker:CreateInferenceComponent";
	/** [Write] sagemaker:CreateInferenceExperiment */
	static readonly CREATE_INFERENCE_EXPERIMENT = "sagemaker:CreateInferenceExperiment";
	/** [Write] sagemaker:CreateInferenceRecommendationsJob */
	static readonly CREATE_INFERENCE_RECOMMENDATIONS_JOB = "sagemaker:CreateInferenceRecommendationsJob";
	...
	static readonly CREATE_LINEAGE_GROUP_POLICY = "sagemaker:CreateLineageGroupPolicy";
	...
	static readonly CREATE_MLFLOW_TRACKING_SERVER = "sagemaker:CreateMlflowTrackingServer";
	...
	static readonly CREATE_MODEL_BIAS_JOB_DEFINITION = "sagemaker:CreateModelBiasJobDefinition";
	...
	static readonly CREATE_MODEL_CARD_EXPORT_JOB = "sagemaker:CreateModelCardExportJob";
	/** [Write] sagemaker:CreateModelExplainabilityJobDefinition */
	static readonly CREATE_MODEL_EXPLAINABILITY_JOB_DEFINITION = "sagemaker:CreateModelExplainabilityJobDefinition";
	...
	static readonly CREATE_MODEL_PACKAGE_GROUP = "sagemaker:CreateModelPackageGroup";
	/** [Write] sagemaker:CreateModelQualityJobDefinition */
	static readonly CREATE_MODEL_QUALITY_JOB_DEFINITION = "sagemaker:CreateModelQualityJobDefinition";
	/** [Write] sagemaker:CreateMonitoringSchedule */
	static readonly CREATE_MONITORING_SCHEDULE = "sagemaker:CreateMonitoringSchedule";
	...
	static readonly CREATE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG = "sagemaker:CreateNotebookInstanceLifecycleConfig";
	...
	static readonly CREATE_PARTNER_APP_PRESIGNED_URL = "sagemaker:CreatePartnerAppPresignedUrl";
	...
	static readonly CREATE_PRESIGNED_DOMAIN_URL = "sagemaker:CreatePresignedDomainUrl";
	/** [Write] sagemaker:CreatePresignedMlflowAppUrl */
	static readonly CREATE_PRESIGNED_MLFLOW_APP_URL = "sagemaker:CreatePresignedMlflowAppUrl";
	/** [Write] sagemaker:CreatePresignedMlflowTrackingServerUrl */
	static readonly CREATE_PRESIGNED_MLFLOW_TRACKING_SERVER_URL = "sagemaker:CreatePresignedMlflowTrackingServerUrl";
	/** [Write] sagemaker:CreatePresignedNotebookInstanceUrl */
	static readonly CREATE_PRESIGNED_NOTEBOOK_INSTANCE_URL = "sagemaker:CreatePresignedNotebookInstanceUrl";
	...
	static readonly CREATE_STUDIO_LIFECYCLE_CONFIG = "sagemaker:CreateStudioLifecycleConfig";
	...
	static readonly DELETE_AI_RECOMMENDATION_JOB = "sagemaker:DeleteAIRecommendationJob";
	/** [Write] sagemaker:DeleteAIWorkloadConfig */
	static readonly DELETE_AI_WORKLOAD_CONFIG = "sagemaker:DeleteAIWorkloadConfig";
	...
	static readonly DELETE_CLUSTER_SCHEDULER_CONFIG = "sagemaker:DeleteClusterSchedulerConfig";
	...
	static readonly DELETE_DATA_QUALITY_JOB_DEFINITION = "sagemaker:DeleteDataQualityJobDefinition";
	...
	static readonly DELETE_EDGE_DEPLOYMENT_PLAN = "sagemaker:DeleteEdgeDeploymentPlan";
	/** [Write] sagemaker:DeleteEdgeDeploymentStage */
	static readonly DELETE_EDGE_DEPLOYMENT_STAGE = "sagemaker:DeleteEdgeDeploymentStage";
	...
	static readonly DELETE_HUB_CONTENT_REFERENCE = "sagemaker:DeleteHubContentReference";
	...
	static readonly DELETE_HYPER_PARAMETER_TUNING_JOB = "sagemaker:DeleteHyperParameterTuningJob";
	...
	static readonly DELETE_INFERENCE_COMPONENT = "sagemaker:DeleteInferenceComponent";
	/** [Write] sagemaker:DeleteInferenceExperiment */
	static readonly DELETE_INFERENCE_EXPERIMENT = "sagemaker:DeleteInferenceExperiment";
	/** [Write] sagemaker:DeleteJob */
	static readonly DELETE_JOB = "sagemaker:DeleteJob";
	/** [Write] sagemaker:DeleteLineageGroupPolicy */
	static readonly DELETE_LINEAGE_GROUP_POLICY = "sagemaker:DeleteLineageGroupPolicy";
	...
	static readonly DELETE_MLFLOW_TRACKING_SERVER = "sagemaker:DeleteMlflowTrackingServer";
	...
	static readonly DELETE_MODEL_BIAS_JOB_DEFINITION = "sagemaker:DeleteModelBiasJobDefinition";
	...
	static readonly DELETE_MODEL_EXPLAINABILITY_JOB_DEFINITION = "sagemaker:DeleteModelExplainabilityJobDefinition";
	...
	static readonly DELETE_MODEL_PACKAGE_GROUP = "sagemaker:DeleteModelPackageGroup";
	/** [Write] sagemaker:DeleteModelPackageGroupPolicy */
	static readonly DELETE_MODEL_PACKAGE_GROUP_POLICY = "sagemaker:DeleteModelPackageGroupPolicy";
	/** [Write] sagemaker:DeleteModelQualityJobDefinition */
	static readonly DELETE_MODEL_QUALITY_JOB_DEFINITION = "sagemaker:DeleteModelQualityJobDefinition";
	/** [Write] sagemaker:DeleteMonitoringSchedule */
	static readonly DELETE_MONITORING_SCHEDULE = "sagemaker:DeleteMonitoringSchedule";
	...
	static readonly DELETE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG = "sagemaker:DeleteNotebookInstanceLifecycleConfig";
	...
	static readonly DELETE_STUDIO_LIFECYCLE_CONFIG = "sagemaker:DeleteStudioLifecycleConfig";
	...
	static readonly DESCRIBE_AI_BENCHMARK_JOB = "sagemaker:DescribeAIBenchmarkJob";
	/** [Read] sagemaker:DescribeAIRecommendationJob */
	static readonly DESCRIBE_AI_RECOMMENDATION_JOB = "sagemaker:DescribeAIRecommendationJob";
	/** [Read] sagemaker:DescribeAIWorkloadConfig */
	static readonly DESCRIBE_AI_WORKLOAD_CONFIG = "sagemaker:DescribeAIWorkloadConfig";
	...
	static readonly DESCRIBE_APP_IMAGE_CONFIG = "sagemaker:DescribeAppImageConfig";
	...
	static readonly DESCRIBE_CLUSTER_INFERENCE = "sagemaker:DescribeClusterInference";
	...
	static readonly DESCRIBE_CLUSTER_SCHEDULER_CONFIG = "sagemaker:DescribeClusterSchedulerConfig";
	...
	static readonly DESCRIBE_DATA_QUALITY_JOB_DEFINITION = "sagemaker:DescribeDataQualityJobDefinition";
	...
	static readonly DESCRIBE_EDGE_DEPLOYMENT_PLAN = "sagemaker:DescribeEdgeDeploymentPlan";
	/** [Read] sagemaker:DescribeEdgePackagingJob */
	static readonly DESCRIBE_EDGE_PACKAGING_JOB = "sagemaker:DescribeEdgePackagingJob";
	...
	static readonly DESCRIBE_FEATURE_METADATA = "sagemaker:DescribeFeatureMetadata";
	...
	static readonly DESCRIBE_HYPER_PARAMETER_TUNING_JOB = "sagemaker:DescribeHyperParameterTuningJob";
	...
	static readonly DESCRIBE_INFERENCE_COMPONENT = "sagemaker:DescribeInferenceComponent";
	/** [Read] sagemaker:DescribeInferenceExperiment */
	static readonly DESCRIBE_INFERENCE_EXPERIMENT = "sagemaker:DescribeInferenceExperiment";
	/** [Read] sagemaker:DescribeInferenceRecommendationsJob */
	static readonly DESCRIBE_INFERENCE_RECOMMENDATIONS_JOB = "sagemaker:DescribeInferenceRecommendationsJob";
	/** [Read] sagemaker:DescribeJob */
	static readonly DESCRIBE_JOB = "sagemaker:DescribeJob";
	/** [Read] sagemaker:DescribeJobSchemaVersion */
	static readonly DESCRIBE_JOB_SCHEMA_VERSION = "sagemaker:DescribeJobSchemaVersion";
	...
	static readonly DESCRIBE_MLFLOW_TRACKING_SERVER = "sagemaker:DescribeMlflowTrackingServer";
	...
	static readonly DESCRIBE_MODEL_BIAS_JOB_DEFINITION = "sagemaker:DescribeModelBiasJobDefinition";
	...
	static readonly DESCRIBE_MODEL_CARD_EXPORT_JOB = "sagemaker:DescribeModelCardExportJob";
	/** [Read] sagemaker:DescribeModelExplainabilityJobDefinition */
	static readonly DESCRIBE_MODEL_EXPLAINABILITY_JOB_DEFINITION = "sagemaker:DescribeModelExplainabilityJobDefinition";
	...
	static readonly DESCRIBE_MODEL_PACKAGE_GROUP = "sagemaker:DescribeModelPackageGroup";
	/** [Read] sagemaker:DescribeModelQualityJobDefinition */
	static readonly DESCRIBE_MODEL_QUALITY_JOB_DEFINITION = "sagemaker:DescribeModelQualityJobDefinition";
	/** [Read] sagemaker:DescribeMonitoringSchedule */
	static readonly DESCRIBE_MONITORING_SCHEDULE = "sagemaker:DescribeMonitoringSchedule";
	/** [Read] sagemaker:DescribeNotebookInstance */
	static readonly DESCRIBE_NOTEBOOK_INSTANCE = "sagemaker:DescribeNotebookInstance";
	/** [Read] sagemaker:DescribeNotebookInstanceLifecycleConfig */
	static readonly DESCRIBE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG = "sagemaker:DescribeNotebookInstanceLifecycleConfig";
	/** [Read] sagemaker:DescribeOptimizationJob */
	static readonly DESCRIBE_OPTIMIZATION_JOB = "sagemaker:DescribeOptimizationJob";
	...
	static readonly DESCRIBE_PIPELINE_DEFINITION_FOR_EXECUTION = "sagemaker:DescribePipelineDefinitionForExecution";
	/** [Read] sagemaker:DescribePipelineExecution */
	static readonly DESCRIBE_PIPELINE_EXECUTION = "sagemaker:DescribePipelineExecution";
	...
	static readonly DESCRIBE_RESERVED_CAPACITY = "sagemaker:DescribeReservedCapacity";
	...
	static readonly DESCRIBE_STUDIO_LIFECYCLE_CONFIG = "sagemaker:DescribeStudioLifecycleConfig";
	/** [Read] sagemaker:DescribeSubscribedWorkteam */
	static readonly DESCRIBE_SUBSCRIBED_WORKTEAM = "sagemaker:DescribeSubscribedWorkteam";
	...
	static readonly DETACH_CLUSTER_NODE_VOLUME = "sagemaker:DetachClusterNodeVolume";
	/** [Write] sagemaker:DisableSagemakerServicecatalogPortfolio */
	static readonly DISABLE_SAGEMAKER_SERVICECATALOG_PORTFOLIO = "sagemaker:DisableSagemakerServicecatalogPortfolio";
	/** [Write] sagemaker:DisassociateTrialComponent */
	static readonly DISASSOCIATE_TRIAL_COMPONENT = "sagemaker:DisassociateTrialComponent";
	/** [Write] sagemaker:EnableSagemakerServicecatalogPortfolio */
	static readonly ENABLE_SAGEMAKER_SERVICECATALOG_PORTFOLIO = "sagemaker:EnableSagemakerServicecatalogPortfolio";
	...
	static readonly GET_MODEL_PACKAGE_GROUP_POLICY = "sagemaker:GetModelPackageGroupPolicy";
	...
	static readonly GET_SAGEMAKER_SERVICECATALOG_PORTFOLIO_STATUS = "sagemaker:GetSagemakerServicecatalogPortfolioStatus";
	/** [Read] sagemaker:GetScalingConfigurationRecommendation */
	static readonly GET_SCALING_CONFIGURATION_RECOMMENDATION = "sagemaker:GetScalingConfigurationRecommendation";
	...
	static readonly INVOKE_ENDPOINT_WITH_RESPONSE_STREAM = "sagemaker:InvokeEndpointWithResponseStream";
	...
	static readonly LIST_AI_RECOMMENDATION_JOBS = "sagemaker:ListAIRecommendationJobs";
	...
	static readonly LIST_CANDIDATES_FOR_AUTO_ML_JOB = "sagemaker:ListCandidatesForAutoMLJob";
	...
	static readonly LIST_CLUSTER_SCHEDULER_CONFIGS = "sagemaker:ListClusterSchedulerConfigs";
	...
	static readonly LIST_DATA_QUALITY_JOB_DEFINITIONS = "sagemaker:ListDataQualityJobDefinitions";
	...
	static readonly LIST_EDGE_DEPLOYMENT_PLANS = "sagemaker:ListEdgeDeploymentPlans";
	...
	static readonly LIST_HUB_CONTENT_VERSIONS = "sagemaker:ListHubContentVersions";
	...
	static readonly LIST_HYPER_PARAMETER_TUNING_JOBS = "sagemaker:ListHyperParameterTuningJobs";
	...
	static readonly LIST_INFERENCE_COMPONENTS = "sagemaker:ListInferenceComponents";
	/** [List] sagemaker:ListInferenceExperiments */
	static readonly LIST_INFERENCE_EXPERIMENTS = "sagemaker:ListInferenceExperiments";
	/** [List] sagemaker:ListInferenceRecommendationsJobSteps */
	static readonly LIST_INFERENCE_RECOMMENDATIONS_JOB_STEPS = "sagemaker:ListInferenceRecommendationsJobSteps";
	/** [List] sagemaker:ListInferenceRecommendationsJobs */
	static readonly LIST_INFERENCE_RECOMMENDATIONS_JOBS = "sagemaker:ListInferenceRecommendationsJobs";
	...
	static readonly LIST_LABELING_JOBS_FOR_WORKTEAM = "sagemaker:ListLabelingJobsForWorkteam";
	...
	static readonly LIST_MLFLOW_TRACKING_SERVERS = "sagemaker:ListMlflowTrackingServers";
	/** [List] sagemaker:ListModelBiasJobDefinitions */
	static readonly LIST_MODEL_BIAS_JOB_DEFINITIONS = "sagemaker:ListModelBiasJobDefinitions";
	/** [List] sagemaker:ListModelCardExportJobs */
	static readonly LIST_MODEL_CARD_EXPORT_JOBS = "sagemaker:ListModelCardExportJobs";
	...
	static readonly LIST_MODEL_EXPLAINABILITY_JOB_DEFINITIONS = "sagemaker:ListModelExplainabilityJobDefinitions";
	...
	static readonly LIST_MODEL_PACKAGE_GROUPS = "sagemaker:ListModelPackageGroups";
	...
	static readonly LIST_MODEL_QUALITY_JOB_DEFINITIONS = "sagemaker:ListModelQualityJobDefinitions";
	/** [List] sagemaker:ListModels */
	static readonly LIST_MODELS = "sagemaker:ListModels";
	/** [List] sagemaker:ListMonitoringAlertHistory */
	static readonly LIST_MONITORING_ALERT_HISTORY = "sagemaker:ListMonitoringAlertHistory";
	...
	static readonly LIST_MONITORING_EXECUTIONS = "sagemaker:ListMonitoringExecutions";
	/** [List] sagemaker:ListMonitoringSchedules */
	static readonly LIST_MONITORING_SCHEDULES = "sagemaker:ListMonitoringSchedules";
	/** [List] sagemaker:ListNotebookInstanceLifecycleConfigs */
	static readonly LIST_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIGS = "sagemaker:ListNotebookInstanceLifecycleConfigs";
	...
	static readonly LIST_PIPELINE_EXECUTION_STEPS = "sagemaker:ListPipelineExecutionSteps";
	...
	static readonly LIST_PIPELINE_PARAMETERS_FOR_EXECUTION = "sagemaker:ListPipelineParametersForExecution";
	...
	static readonly LIST_SHARED_MODEL_VERSIONS = "sagemaker:ListSharedModelVersions";
	...
	static readonly LIST_STUDIO_LIFECYCLE_CONFIGS = "sagemaker:ListStudioLifecycleConfigs";
	/** [List] sagemaker:ListSubscribedWorkteams */
	static readonly LIST_SUBSCRIBED_WORKTEAMS = "sagemaker:ListSubscribedWorkteams";
	...
	static readonly LIST_TRAINING_JOBS_FOR_HYPER_PARAMETER_TUNING_JOB = "sagemaker:ListTrainingJobsForHyperParameterTuningJob";
	...
	static readonly LIST_ULTRA_SERVERS_BY_RESERVED_CAPACITY = "sagemaker:ListUltraServersByReservedCapacity";
	...
	static readonly PUT_MODEL_PACKAGE_GROUP_POLICY = "sagemaker:PutModelPackageGroupPolicy";
	...
	static readonly SAMPLE_WITH_RESPONSE_STREAM = "sagemaker:SampleWithResponseStream";
	/** [Read] sagemaker:Search */
	static readonly SEARCH = "sagemaker:Search";
	/** [Read] sagemaker:SearchTrainingPlanOfferings */
	static readonly SEARCH_TRAINING_PLAN_OFFERINGS = "sagemaker:SearchTrainingPlanOfferings";
	...
	static readonly SEND_PIPELINE_EXECUTION_STEP_FAILURE = "sagemaker:SendPipelineExecutionStepFailure";
	/** [Write] sagemaker:SendPipelineExecutionStepSuccess */
	static readonly SEND_PIPELINE_EXECUTION_STEP_SUCCESS = "sagemaker:SendPipelineExecutionStepSuccess";
	...
	static readonly START_CLUSTER_HEALTH_CHECK = "sagemaker:StartClusterHealthCheck";
	/** [Write] sagemaker:StartEdgeDeploymentStage */
	static readonly START_EDGE_DEPLOYMENT_STAGE = "sagemaker:StartEdgeDeploymentStage";
	...
	static readonly START_INFERENCE_EXPERIMENT = "sagemaker:StartInferenceExperiment";
	/** [Write] sagemaker:StartMlflowTrackingServer */
	static readonly START_MLFLOW_TRACKING_SERVER = "sagemaker:StartMlflowTrackingServer";
	/** [Write] sagemaker:StartMonitoringSchedule */
	static readonly START_MONITORING_SCHEDULE = "sagemaker:StartMonitoringSchedule";
	...
	static readonly STOP_AI_RECOMMENDATION_JOB = "sagemaker:StopAIRecommendationJob";
	...
	static readonly STOP_EDGE_DEPLOYMENT_STAGE = "sagemaker:StopEdgeDeploymentStage";
	...
	static readonly STOP_HYPER_PARAMETER_TUNING_JOB = "sagemaker:StopHyperParameterTuningJob";
	/** [Write] sagemaker:StopInferenceExperiment */
	static readonly STOP_INFERENCE_EXPERIMENT = "sagemaker:StopInferenceExperiment";
	/** [Write] sagemaker:StopInferenceRecommendationsJob */
	static readonly STOP_INFERENCE_RECOMMENDATIONS_JOB = "sagemaker:StopInferenceRecommendationsJob";
	...
	static readonly STOP_MLFLOW_TRACKING_SERVER = "sagemaker:StopMlflowTrackingServer";
	...
	static readonly UPDATE_CLUSTER_SCHEDULER_CONFIG = "sagemaker:UpdateClusterSchedulerConfig";
	...
	static readonly UPDATE_ENDPOINT_WEIGHTS_AND_CAPACITIES = "sagemaker:UpdateEndpointWeightsAndCapacities";
	...
	static readonly UPDATE_HUB_CONTENT_REFERENCE = "sagemaker:UpdateHubContentReference";
	...
	static readonly UPDATE_INFERENCE_COMPONENT = "sagemaker:UpdateInferenceComponent";
	/** [Write] sagemaker:UpdateInferenceComponentRuntimeConfig */
	static readonly UPDATE_INFERENCE_COMPONENT_RUNTIME_CONFIG = "sagemaker:UpdateInferenceComponentRuntimeConfig";
	/** [Write] sagemaker:UpdateInferenceExperiment */
	static readonly UPDATE_INFERENCE_EXPERIMENT = "sagemaker:UpdateInferenceExperiment";
	...
	static readonly UPDATE_MLFLOW_TRACKING_SERVER = "sagemaker:UpdateMlflowTrackingServer";
	...
	static readonly UPDATE_MONITORING_SCHEDULE = "sagemaker:UpdateMonitoringSchedule";
	...
	static readonly UPDATE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG = "sagemaker:UpdateNotebookInstanceLifecycleConfig";
	...
	static readonly UPDATE_PIPELINE_EXECUTION = "sagemaker:UpdatePipelineExecution";
	...
	static readonly READ_ACTIONS: string[] = [SageMakerActions.ACCESS_MODEL_PACKAGE, SageMakerActions.BATCH_DESCRIBE_MODEL_PACKAGE, SageMakerActions.BATCH_GET_METRICS, SageMakerActions.BATCH_GET_RECORD, SageMakerActions.CALL_WITH_BEARER_TOKEN, SageMakerActions.CREATE_HUB_CONTENT_PRESIGNED_URLS, SageMakerActions.DESCRIBE_AI_BENCHMARK_JOB, SageMakerActions.DESCRIBE_AI_RECOMMENDATION_JOB, SageMakerActions.DESCRIBE_AI_WORKLOAD_CONFIG, SageMakerActions.DESCRIBE_ACTION, SageMakerActions.DESCRIBE_ALGORITHM, SageMakerActions.DESCRIBE_APP, SageMakerActions.DESCRIBE_APP_IMAGE_CONFIG, SageMakerActions.DESCRIBE_ARTIFACT, SageMakerActions.DESCRIBE_AUTO_ML_JOB, SageMakerActions.DESCRIBE_AUTO_ML_JOB_V2, SageMakerActions.DESCRIBE_CLUSTER, SageMakerActions.DESCRIBE_CLUSTER_EVENT, SageMakerActions.DESCRIBE_CLUSTER_INFERENCE, SageMakerActions.DESCRIBE_CLUSTER_NODE, SageMakerActions.DESCRIBE_CLUSTER_SCHEDULER_CONFIG, SageMakerActions.DESCRIBE_CODE_REPOSITORY, SageMakerActions.DESCRIBE_COMPILATION_JOB, SageMakerActions.DESCRIBE_COMPUTE_QUOTA, SageMakerActions.DESCRIBE_CONTEXT, SageMakerActions.DESCRIBE_DATA_QUALITY_JOB_DEFINITION, SageMakerActions.DESCRIBE_DEVICE, SageMakerActions.DESCRIBE_DEVICE_FLEET, SageMakerActions.DESCRIBE_DOMAIN, SageMakerActions.DESCRIBE_EDGE_DEPLOYMENT_PLAN, SageMakerActions.DESCRIBE_EDGE_PACKAGING_JOB, SageMakerActions.DESCRIBE_ENDPOINT, SageMakerActions.DESCRIBE_ENDPOINT_CONFIG, SageMakerActions.DESCRIBE_EXPERIMENT, SageMakerActions.DESCRIBE_FEATURE_GROUP, SageMakerActions.DESCRIBE_FEATURE_METADATA, SageMakerActions.DESCRIBE_FLOW_DEFINITION, SageMakerActions.DESCRIBE_HUB, SageMakerActions.DESCRIBE_HUB_CONTENT, SageMakerActions.DESCRIBE_HUMAN_LOOP, SageMakerActions.DESCRIBE_HUMAN_TASK_UI, SageMakerActions.DESCRIBE_HYPER_PARAMETER_TUNING_JOB, SageMakerActions.DESCRIBE_IMAGE, SageMakerActions.DESCRIBE_IMAGE_VERSION, SageMakerActions.DESCRIBE_INFERENCE_COMPONENT, SageMakerActions.DESCRIBE_INFERENCE_EXPERIMENT, SageMakerActions.DESCRIBE_INFERENCE_RECOMMENDATIONS_JOB, SageMakerActions.DESCRIBE_JOB, SageMakerActions.DESCRIBE_JOB_SCHEMA_VERSION, SageMakerActions.DESCRIBE_LABELING_JOB, SageMakerActions.DESCRIBE_LINEAGE_GROUP, SageMakerActions.DESCRIBE_MLFLOW_APP, SageMakerActions.DESCRIBE_MLFLOW_TRACKING_SERVER, SageMakerActions.DESCRIBE_MODEL, SageMakerActions.DESCRIBE_MODEL_BIAS_JOB_DEFINITION, SageMakerActions.DESCRIBE_MODEL_CARD, SageMakerActions.DESCRIBE_MODEL_CARD_EXPORT_JOB, SageMakerActions.DESCRIBE_MODEL_EXPLAINABILITY_JOB_DEFINITION, SageMakerActions.DESCRIBE_MODEL_PACKAGE, SageMakerActions.DESCRIBE_MODEL_PACKAGE_GROUP, SageMakerActions.DESCRIBE_MODEL_QUALITY_JOB_DEFINITION, SageMakerActions.DESCRIBE_MONITORING_SCHEDULE, SageMakerActions.DESCRIBE_NOTEBOOK_INSTANCE, SageMakerActions.DESCRIBE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG, SageMakerActions.DESCRIBE_OPTIMIZATION_JOB, SageMakerActions.DESCRIBE_PARTNER_APP, SageMakerActions.DESCRIBE_PIPELINE, SageMakerActions.DESCRIBE_PIPELINE_DEFINITION_FOR_EXECUTION, SageMakerActions.DESCRIBE_PIPELINE_EXECUTION, SageMakerActions.DESCRIBE_PROCESSING_JOB, SageMakerActions.DESCRIBE_PROJECT, SageMakerActions.DESCRIBE_RESERVED_CAPACITY, SageMakerActions.DESCRIBE_SHARED_MODEL, SageMakerActions.DESCRIBE_SPACE, SageMakerActions.DESCRIBE_STUDIO_LIFECYCLE_CONFIG, SageMakerActions.DESCRIBE_SUBSCRIBED_WORKTEAM, SageMakerActions.DESCRIBE_TRAINING_JOB, SageMakerActions.DESCRIBE_TRAINING_PLAN, SageMakerActions.DESCRIBE_TRANSFORM_JOB, SageMakerActions.DESCRIBE_TRIAL, SageMakerActions.DESCRIBE_TRIAL_COMPONENT, SageMakerActions.DESCRIBE_USER_PROFILE, SageMakerActions.DESCRIBE_WORKFORCE, SageMakerActions.DESCRIBE_WORKTEAM, SageMakerActions.GET_DEPLOYMENTS, SageMakerActions.GET_DEVICE_FLEET_REPORT, SageMakerActions.GET_DEVICE_REGISTRATION, SageMakerActions.GET_LINEAGE_GROUP_POLICY, SageMakerActions.GET_MODEL_PACKAGE_GROUP_POLICY, SageMakerActions.GET_RECORD, SageMakerActions.GET_RESOURCE_POLICY, SageMakerActions.GET_SAGEMAKER_SERVICECATALOG_PORTFOLIO_STATUS, SageMakerActions.GET_SCALING_CONFIGURATION_RECOMMENDATION, SageMakerActions.GET_SEARCH_SUGGESTIONS, SageMakerActions.INVOKE_ENDPOINT, SageMakerActions.INVOKE_ENDPOINT_ASYNC, SageMakerActions.INVOKE_ENDPOINT_WITH_RESPONSE_STREAM, SageMakerActions.RENDER_UI_TEMPLATE, SageMakerActions.SEARCH, SageMakerActions.SEARCH_TRAINING_PLAN_OFFERINGS];
	/** All write-level actions. */
	static readonly WRITE_ACTIONS: string[] = [SageMakerActions.ADD_ASSOCIATION, SageMakerActions.ASSOCIATE_TRIAL_COMPONENT, SageMakerActions.ATTACH_CLUSTER_NODE_VOLUME, SageMakerActions.BATCH_ADD_CLUSTER_NODES, SageMakerActions.BATCH_DELETE_CLUSTER_NODES, SageMakerActions.BATCH_PUT_METRICS, SageMakerActions.BATCH_WRITE_RECORD, SageMakerActions.CALL_MLFLOW_APP_API, SageMakerActions.CALL_PARTNER_APP_API, SageMakerActions.COMPLETE_ROLLOUT, SageMakerActions.CREATE_AI_BENCHMARK_JOB, SageMakerActions.CREATE_AI_RECOMMENDATION_JOB, SageMakerActions.CREATE_AI_WORKLOAD_CONFIG, SageMakerActions.CREATE_ACTION, SageMakerActions.CREATE_ALGORITHM, SageMakerActions.CREATE_APP, SageMakerActions.CREATE_APP_IMAGE_CONFIG, SageMakerActions.CREATE_ARTIFACT, SageMakerActions.CREATE_AUTO_ML_JOB, SageMakerActions.CREATE_AUTO_ML_JOB_V2, SageMakerActions.CREATE_CLUSTER, SageMakerActions.CREATE_CLUSTER_SCHEDULER_CONFIG, SageMakerActions.CREATE_CODE_REPOSITORY, SageMakerActions.CREATE_COMPILATION_JOB, SageMakerActions.CREATE_COMPUTE_QUOTA, SageMakerActions.CREATE_CONTEXT, SageMakerActions.CREATE_DATA_QUALITY_JOB_DEFINITION, SageMakerActions.CREATE_DEVICE_FLEET, SageMakerActions.CREATE_DOMAIN, SageMakerActions.CREATE_EDGE_DEPLOYMENT_PLAN, SageMakerActions.CREATE_EDGE_DEPLOYMENT_STAGE, SageMakerActions.CREATE_EDGE_PACKAGING_JOB, SageMakerActions.CREATE_ENDPOINT, SageMakerActions.CREATE_ENDPOINT_CONFIG, SageMakerActions.CREATE_EXPERIMENT, SageMakerActions.CREATE_FEATURE_GROUP, SageMakerActions.CREATE_FLOW_DEFINITION, SageMakerActions.CREATE_HUB, SageMakerActions.CREATE_HUB_CONTENT_REFERENCE, SageMakerActions.CREATE_HUMAN_TASK_UI, SageMakerActions.CREATE_HYPER_PARAMETER_TUNING_JOB, SageMakerActions.CREATE_IMAGE, SageMakerActions.CREATE_IMAGE_VERSION, SageMakerActions.CREATE_INFERENCE_COMPONENT, SageMakerActions.CREATE_INFERENCE_EXPERIMENT, SageMakerActions.CREATE_INFERENCE_RECOMMENDATIONS_JOB, SageMakerActions.CREATE_JOB, SageMakerActions.CREATE_LABELING_JOB, SageMakerActions.CREATE_LINEAGE_GROUP_POLICY, SageMakerActions.CREATE_MLFLOW_APP, SageMakerActions.CREATE_MLFLOW_TRACKING_SERVER, SageMakerActions.CREATE_MODEL, SageMakerActions.CREATE_MODEL_BIAS_JOB_DEFINITION, SageMakerActions.CREATE_MODEL_CARD, SageMakerActions.CREATE_MODEL_CARD_EXPORT_JOB, SageMakerActions.CREATE_MODEL_EXPLAINABILITY_JOB_DEFINITION, SageMakerActions.CREATE_MODEL_PACKAGE, SageMakerActions.CREATE_MODEL_PACKAGE_GROUP, SageMakerActions.CREATE_MODEL_QUALITY_JOB_DEFINITION, SageMakerActions.CREATE_MONITORING_SCHEDULE, SageMakerActions.CREATE_NOTEBOOK_INSTANCE, SageMakerActions.CREATE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG, SageMakerActions.CREATE_OPTIMIZATION_JOB, SageMakerActions.CREATE_PARTNER_APP, SageMakerActions.CREATE_PARTNER_APP_PRESIGNED_URL, SageMakerActions.CREATE_PIPELINE, SageMakerActions.CREATE_PRESIGNED_DOMAIN_URL, SageMakerActions.CREATE_PRESIGNED_MLFLOW_APP_URL, SageMakerActions.CREATE_PRESIGNED_MLFLOW_TRACKING_SERVER_URL, SageMakerActions.CREATE_PRESIGNED_NOTEBOOK_INSTANCE_URL, SageMakerActions.CREATE_PROCESSING_JOB, SageMakerActions.CREATE_PROJECT, SageMakerActions.CREATE_RESERVED_CAPACITY, SageMakerActions.CREATE_SHARED_MODEL, SageMakerActions.CREATE_SPACE, SageMakerActions.CREATE_STUDIO_LIFECYCLE_CONFIG, SageMakerActions.CREATE_TRAINING_JOB, SageMakerActions.CREATE_TRAINING_PLAN, SageMakerActions.CREATE_TRANSFORM_JOB, SageMakerActions.CREATE_TRIAL, SageMakerActions.CREATE_TRIAL_COMPONENT, SageMakerActions.CREATE_USER_PROFILE, SageMakerActions.CREATE_WORKFORCE, SageMakerActions.CREATE_WORKTEAM, SageMakerActions.DELETE_AI_BENCHMARK_JOB, SageMakerActions.DELETE_AI_RECOMMENDATION_JOB, SageMakerActions.DELETE_AI_WORKLOAD_CONFIG, SageMakerActions.DELETE_ACTION, SageMakerActions.DELETE_ALGORITHM, SageMakerActions.DELETE_APP, SageMakerActions.DELETE_APP_IMAGE_CONFIG, SageMakerActions.DELETE_ARTIFACT, SageMakerActions.DELETE_ASSOCIATION, SageMakerActions.DELETE_CLUSTER, SageMakerActions.DELETE_CLUSTER_SCHEDULER_CONFIG, SageMakerActions.DELETE_CODE_REPOSITORY, SageMakerActions.DELETE_COMPILATION_JOB, SageMakerActions.DELETE_COMPUTE_QUOTA, SageMakerActions.DELETE_CONTEXT, SageMakerActions.DELETE_DATA_QUALITY_JOB_DEFINITION, SageMakerActions.DELETE_DEVICE_FLEET, SageMakerActions.DELETE_DOMAIN, SageMakerActions.DELETE_EDGE_DEPLOYMENT_PLAN, SageMakerActions.DELETE_EDGE_DEPLOYMENT_STAGE, SageMakerActions.DELETE_ENDPOINT, SageMakerActions.DELETE_ENDPOINT_CONFIG, SageMakerActions.DELETE_EXPERIMENT, SageMakerActions.DELETE_FEATURE_GROUP, SageMakerActions.DELETE_FLOW_DEFINITION, SageMakerActions.DELETE_HUB, SageMakerActions.DELETE_HUB_CONTENT, SageMakerActions.DELETE_HUB_CONTENT_REFERENCE, SageMakerActions.DELETE_HUMAN_LOOP, SageMakerActions.DELETE_HUMAN_TASK_UI, SageMakerActions.DELETE_HYPER_PARAMETER_TUNING_JOB, SageMakerActions.DELETE_IMAGE, SageMakerActions.DELETE_IMAGE_VERSION, SageMakerActions.DELETE_INFERENCE_COMPONENT, SageMakerActions.DELETE_INFERENCE_EXPERIMENT, SageMakerActions.DELETE_JOB, SageMakerActions.DELETE_LINEAGE_GROUP_POLICY, SageMakerActions.DELETE_MLFLOW_APP, SageMakerActions.DELETE_MLFLOW_TRACKING_SERVER, SageMakerActions.DELETE_MODEL, SageMakerActions.DELETE_MODEL_BIAS_JOB_DEFINITION, SageMakerActions.DELETE_MODEL_CARD, SageMakerActions.DELETE_MODEL_EXPLAINABILITY_JOB_DEFINITION, SageMakerActions.DELETE_MODEL_PACKAGE, SageMakerActions.DELETE_MODEL_PACKAGE_GROUP, SageMakerActions.DELETE_MODEL_PACKAGE_GROUP_POLICY, SageMakerActions.DELETE_MODEL_QUALITY_JOB_DEFINITION, SageMakerActions.DELETE_MONITORING_SCHEDULE, SageMakerActions.DELETE_NOTEBOOK_INSTANCE, SageMakerActions.DELETE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG, SageMakerActions.DELETE_OPTIMIZATION_JOB, SageMakerActions.DELETE_PARTNER_APP, SageMakerActions.DELETE_PIPELINE, SageMakerActions.DELETE_PROCESSING_JOB, SageMakerActions.DELETE_PROJECT, SageMakerActions.DELETE_RECORD, SageMakerActions.DELETE_RESOURCE_POLICY, SageMakerActions.DELETE_SPACE, SageMakerActions.DELETE_STUDIO_LIFECYCLE_CONFIG, SageMakerActions.DELETE_TRAINING_JOB, SageMakerActions.DELETE_TRIAL, SageMakerActions.DELETE_TRIAL_COMPONENT, SageMakerActions.DELETE_USER_PROFILE, SageMakerActions.DELETE_WORKFORCE, SageMakerActions.DELETE_WORKTEAM, SageMakerActions.DEPLOY_HUB_MODEL, SageMakerActions.DEREGISTER_DEVICES, SageMakerActions.DETACH_CLUSTER_NODE_VOLUME, SageMakerActions.DISABLE_SAGEMAKER_SERVICECATALOG_PORTFOLIO, SageMakerActions.DISASSOCIATE_TRIAL_COMPONENT, SageMakerActions.ENABLE_SAGEMAKER_SERVICECATALOG_PORTFOLIO, SageMakerActions.IMPORT_HUB_CONTENT, SageMakerActions.PUT_LINEAGE_GROUP_POLICY, SageMakerActions.PUT_MODEL_PACKAGE_GROUP_POLICY, SageMakerActions.PUT_RECORD, SageMakerActions.PUT_RESOURCE_POLICY, SageMakerActions.REGISTER_DEVICES, SageMakerActions.RETRY_PIPELINE_EXECUTION, SageMakerActions.SAMPLE, SageMakerActions.SAMPLE_WITH_RESPONSE_STREAM, SageMakerActions.SEND_HEARTBEAT, SageMakerActions.SEND_PIPELINE_EXECUTION_STEP_FAILURE, SageMakerActions.SEND_PIPELINE_EXECUTION_STEP_SUCCESS, SageMakerActions.SEND_SHARED_MODEL_EVENT, SageMakerActions.START_CLUSTER_HEALTH_CHECK, SageMakerActions.START_EDGE_DEPLOYMENT_STAGE, SageMakerActions.START_HUMAN_LOOP, SageMakerActions.START_INFERENCE_EXPERIMENT, SageMakerActions.START_MLFLOW_TRACKING_SERVER, SageMakerActions.START_MONITORING_SCHEDULE, SageMakerActions.START_NOTEBOOK_INSTANCE, SageMakerActions.START_PIPELINE_EXECUTION, SageMakerActions.START_SESSION, SageMakerActions.STOP_AI_BENCHMARK_JOB, SageMakerActions.STOP_AI_RECOMMENDATION_JOB, SageMakerActions.STOP_AUTO_ML_JOB, SageMakerActions.STOP_COMPILATION_JOB, SageMakerActions.STOP_EDGE_DEPLOYMENT_STAGE, SageMakerActions.STOP_EDGE_PACKAGING_JOB, SageMakerActions.STOP_HUMAN_LOOP, SageMakerActions.STOP_HYPER_PARAMETER_TUNING_JOB, SageMakerActions.STOP_INFERENCE_EXPERIMENT, SageMakerActions.STOP_INFERENCE_RECOMMENDATIONS_JOB, SageMakerActions.STOP_JOB, SageMakerActions.STOP_LABELING_JOB, SageMakerActions.STOP_MLFLOW_TRACKING_SERVER, SageMakerActions.STOP_MONITORING_SCHEDULE, SageMakerActions.STOP_NOTEBOOK_INSTANCE, SageMakerActions.STOP_OPTIMIZATION_JOB, SageMakerActions.STOP_PIPELINE_EXECUTION, SageMakerActions.STOP_PROCESSING_JOB, SageMakerActions.STOP_TRAINING_JOB, SageMakerActions.STOP_TRANSFORM_JOB, SageMakerActions.TRAIN_HUB_MODEL, SageMakerActions.UPDATE_ACTION, SageMakerActions.UPDATE_APP_IMAGE_CONFIG, SageMakerActions.UPDATE_ARTIFACT, SageMakerActions.UPDATE_CLUSTER, SageMakerActions.UPDATE_CLUSTER_INFERENCE, SageMakerActions.UPDATE_CLUSTER_SCHEDULER_CONFIG, SageMakerActions.UPDATE_CLUSTER_SOFTWARE, SageMakerActions.UPDATE_CODE_REPOSITORY, SageMakerActions.UPDATE_COMPUTE_QUOTA, SageMakerActions.UPDATE_CONTEXT, SageMakerActions.UPDATE_DEVICE_FLEET, SageMakerActions.UPDATE_DEVICES, SageMakerActions.UPDATE_DOMAIN, SageMakerActions.UPDATE_ENDPOINT, SageMakerActions.UPDATE_ENDPOINT_WEIGHTS_AND_CAPACITIES, SageMakerActions.UPDATE_EXPERIMENT, SageMakerActions.UPDATE_FEATURE_GROUP, SageMakerActions.UPDATE_FEATURE_METADATA, SageMakerActions.UPDATE_HUB, SageMakerActions.UPDATE_HUB_CONTENT, SageMakerActions.UPDATE_HUB_CONTENT_REFERENCE, SageMakerActions.UPDATE_IMAGE, SageMakerActions.UPDATE_IMAGE_VERSION, SageMakerActions.UPDATE_INFERENCE_COMPONENT, SageMakerActions.UPDATE_INFERENCE_COMPONENT_RUNTIME_CONFIG, SageMakerActions.UPDATE_INFERENCE_EXPERIMENT, SageMakerActions.UPDATE_MLFLOW_APP, SageMakerActions.UPDATE_MLFLOW_TRACKING_SERVER, SageMakerActions.UPDATE_MODEL_CARD, SageMakerActions.UPDATE_MODEL_PACKAGE, SageMakerActions.UPDATE_MONITORING_ALERT, SageMakerActions.UPDATE_MONITORING_SCHEDULE, SageMakerActions.UPDATE_NOTEBOOK_INSTANCE, SageMakerActions.UPDATE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG, SageMakerActions.UPDATE_PARTNER_APP, SageMakerActions.UPDATE_PIPELINE, SageMakerActions.UPDATE_PIPELINE_EXECUTION, SageMakerActions.UPDATE_PIPELINE_VERSION, SageMakerActions.UPDATE_PROJECT, SageMakerActions.UPDATE_REWARD, SageMakerActions.UPDATE_SHARED_MODEL, SageMakerActions.UPDATE_SPACE, SageMakerActions.UPDATE_TRAINING_JOB, SageMakerActions.UPDATE_TRIAL, SageMakerActions.UPDATE_TRIAL_COMPONENT, SageMakerActions.UPDATE_USER_PROFILE, SageMakerActions.UPDATE_WORKFORCE, SageMakerActions.UPDATE_WORKTEAM];
	/** All list-level actions. */
	static readonly LIST_ACTIONS: string[] = [SageMakerActions.LIST_AI_BENCHMARK_JOBS, SageMakerActions.LIST_AI_RECOMMENDATION_JOBS, SageMakerActions.LIST_AI_WORKLOAD_CONFIGS, SageMakerActions.LIST_ACTIONS, SageMakerActions.LIST_ALGORITHMS, SageMakerActions.LIST_ALIASES, SageMakerActions.LIST_APP_IMAGE_CONFIGS, SageMakerActions.LIST_APPS, SageMakerActions.LIST_ARTIFACTS, SageMakerActions.LIST_ASSOCIATIONS, SageMakerActions.LIST_AUTO_ML_JOBS, SageMakerActions.LIST_CANDIDATES_FOR_AUTO_ML_JOB, SageMakerActions.LIST_CLUSTER_EVENTS, SageMakerActions.LIST_CLUSTER_NODES, SageMakerActions.LIST_CLUSTER_SCHEDULER_CONFIGS, SageMakerActions.LIST_CLUSTERS, SageMakerActions.LIST_CODE_REPOSITORIES, SageMakerActions.LIST_COMPILATION_JOBS, SageMakerActions.LIST_COMPUTE_QUOTAS, SageMakerActions.LIST_CONTEXTS, SageMakerActions.LIST_DATA_QUALITY_JOB_DEFINITIONS, SageMakerActions.LIST_DEVICE_FLEETS, SageMakerActions.LIST_DEVICES, SageMakerActions.LIST_DOMAINS, SageMakerActions.LIST_EDGE_DEPLOYMENT_PLANS, SageMakerActions.LIST_EDGE_PACKAGING_JOBS, SageMakerActions.LIST_ENDPOINT_CONFIGS, SageMakerActions.LIST_ENDPOINTS, SageMakerActions.LIST_EXPERIMENTS, SageMakerActions.LIST_FEATURE_GROUPS, SageMakerActions.LIST_FLOW_DEFINITIONS, SageMakerActions.LIST_HUB_CONTENT_VERSIONS, SageMakerActions.LIST_HUB_CONTENTS, SageMakerActions.LIST_HUBS, SageMakerActions.LIST_HUMAN_LOOPS, SageMakerActions.LIST_HUMAN_TASK_UIS, SageMakerActions.LIST_HYPER_PARAMETER_TUNING_JOBS, SageMakerActions.LIST_IMAGE_VERSIONS, SageMakerActions.LIST_IMAGES, SageMakerActions.LIST_INFERENCE_COMPONENTS, SageMakerActions.LIST_INFERENCE_EXPERIMENTS, SageMakerActions.LIST_INFERENCE_RECOMMENDATIONS_JOB_STEPS, SageMakerActions.LIST_INFERENCE_RECOMMENDATIONS_JOBS, SageMakerActions.LIST_JOB_SCHEMA_VERSIONS, SageMakerActions.LIST_JOBS, SageMakerActions.LIST_LABELING_JOBS, SageMakerActions.LIST_LABELING_JOBS_FOR_WORKTEAM, SageMakerActions.LIST_LINEAGE_GROUPS, SageMakerActions.LIST_MLFLOW_APPS, SageMakerActions.LIST_MLFLOW_TRACKING_SERVERS, SageMakerActions.LIST_MODEL_BIAS_JOB_DEFINITIONS, SageMakerActions.LIST_MODEL_CARD_EXPORT_JOBS, SageMakerActions.LIST_MODEL_CARD_VERSIONS, SageMakerActions.LIST_MODEL_CARDS, SageMakerActions.LIST_MODEL_EXPLAINABILITY_JOB_DEFINITIONS, SageMakerActions.LIST_MODEL_METADATA, SageMakerActions.LIST_MODEL_PACKAGE_GROUPS, SageMakerActions.LIST_MODEL_PACKAGES, SageMakerActions.LIST_MODEL_QUALITY_JOB_DEFINITIONS, SageMakerActions.LIST_MODELS, SageMakerActions.LIST_MONITORING_ALERT_HISTORY, SageMakerActions.LIST_MONITORING_ALERTS, SageMakerActions.LIST_MONITORING_EXECUTIONS, SageMakerActions.LIST_MONITORING_SCHEDULES, SageMakerActions.LIST_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIGS, SageMakerActions.LIST_NOTEBOOK_INSTANCES, SageMakerActions.LIST_OPTIMIZATION_JOBS, SageMakerActions.LIST_PARTNER_APPS, SageMakerActions.LIST_PIPELINE_EXECUTION_STEPS, SageMakerActions.LIST_PIPELINE_EXECUTIONS, SageMakerActions.LIST_PIPELINE_PARAMETERS_FOR_EXECUTION, SageMakerActions.LIST_PIPELINE_VERSIONS, SageMakerActions.LIST_PIPELINES, SageMakerActions.LIST_PROCESSING_JOBS, SageMakerActions.LIST_PROJECTS, SageMakerActions.LIST_RECORDS, SageMakerActions.LIST_RESOURCE_CATALOGS, SageMakerActions.LIST_SHARED_MODEL_EVENTS, SageMakerActions.LIST_SHARED_MODEL_VERSIONS, SageMakerActions.LIST_SHARED_MODELS, SageMakerActions.LIST_SPACES, SageMakerActions.LIST_STAGE_DEVICES, SageMakerActions.LIST_STUDIO_LIFECYCLE_CONFIGS, SageMakerActions.LIST_SUBSCRIBED_WORKTEAMS, SageMakerActions.LIST_TAGS, SageMakerActions.LIST_TRAINING_JOBS, SageMakerActions.LIST_TRAINING_JOBS_FOR_HYPER_PARAMETER_TUNING_JOB, SageMakerActions.LIST_TRAINING_PLANS, SageMakerActions.LIST_TRANSFORM_JOBS, SageMakerActions.LIST_TRIAL_COMPONENTS, SageMakerActions.LIST_TRIALS, SageMakerActions.LIST_ULTRA_SERVERS_BY_RESERVED_CAPACITY, SageMakerActions.LIST_USER_PROFILES, SageMakerActions.LIST_WORKFORCES, SageMakerActions.LIST_WORKTEAMS, SageMakerActions.QUERY_LINEAGE];
	/** All permission-management-level actions. */
	static readonly PERMISSION_MANAGEMENT_ACTIONS: string[] = [];
	/** All tagging-level actions. */
	static readonly TAGGING_ACTIONS: string[] = [SageMakerActions.ADD_TAGS, SageMakerActions.DELETE_TAGS];
}

const ActionArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):action/(?<actionName>[^:/?]+)$");
const AiBenchmarkJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):ai-benchmark-job/(?<aiBenchmarkJobName>[^:/?]+)$");
const AiRecommendationJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):ai-recommendation-job/(?<aiRecommendationJobName>[^:/?]+)$");
const AiWorkloadConfigArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):ai-workload-config/(?<aiWorkloadConfigName>[^:/?]+)$");
const AlgorithmArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):algorithm/(?<algorithmName>[^:/?]+)$");
const AppArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):app/(?<domainId>[^:/?]+)/(?<userProfileName>[^:/?]+)/(?<appType>[^:/?]+)/(?<appName>[^:/?]+)$");
const AppImageConfigArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):app-image-config/(?<appImageConfigName>[^:/?]+)$");
const ArtifactArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):artifact/(?<hashOfArtifactSource>[^:/?]+)$");
const AutomlJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):automl-job/(?<autoMlJobJobName>[^:/?]+)$");
const ClusterArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):cluster/(?<clusterId>[^:/?]+)$");
const ClusterSchedulerConfigArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):cluster-scheduler-config/(?<clusterSchedulerConfigId>[^:/?]+)$");
const CodeRepositoryArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):code-repository/(?<codeRepositoryName>[^:/?]+)$");
const CompilationJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):compilation-job/(?<compilationJobName>[^:/?]+)$");
const ComputeQuotaArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):compute-quota/(?<computeQuotaId>[^:/?]+)$");
const ContextArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):context/(?<contextName>[^:/?]+)$");
const DataQualityJobDefinitionArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):data-quality-job-definition/(?<dataQualityJobDefinitionName>[^:/?]+)$");
const DeviceArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):device-fleet/(?<deviceFleetName>[^:/?]+)/device/(?<deviceName>[^:/?]+)$");
const DeviceFleetArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):device-fleet/(?<deviceFleetName>[^:/?]+)$");
const DomainArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):domain/(?<domainId>[^:/?]+)$");
const EdgeDeploymentPlanArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):edge-deployment/(?<edgeDeploymentPlanName>[^:/?]+)$");
const EdgePackagingJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):edge-packaging-job/(?<edgePackagingJobName>[^:/?]+)$");
const EndpointArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):endpoint/(?<endpointName>[^:/?]+)$");
const EndpointConfigArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):endpoint-config/(?<endpointConfigName>[^:/?]+)$");
const ExperimentArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):experiment/(?<experimentName>[^:/?]+)$");
const ExperimentTrialArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):experiment-trial/(?<trialName>[^:/?]+)$");
const ExperimentTrialComponentArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):experiment-trial-component/(?<trialComponentName>[^:/?]+)$");
const FeatureGroupArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):feature-group/(?<featureGroupName>[^:/?]+)$");
const FlowDefinitionArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):flow-definition/(?<flowDefinitionName>[^:/?]+)$");
const HubArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):hub/(?<hubName>[^:/?]+)$");
const HubContentArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):hub-content/(?<hubName>[^:/?]+)/(?<hubContentType>[^:/?]+)/(?<hubContentName>[^:/?]+)$");
const HumanLoopArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):human-loop/(?<humanLoopName>[^:/?]+)$");
const HumanTaskUiArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):human-task-ui/(?<humanTaskUiName>[^:/?]+)$");
const HyperParameterTuningJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):hyper-parameter-tuning-job/(?<hyperParameterTuningJobName>[^:/?]+)$");
const ImageArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):image/(?<imageName>[^:/?]+)$");
const ImageVersionArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):image-version/(?<imageName>[^:/?]+)/(?<version>[^:/?]+)$");
const InferenceComponentArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):inference-component/(?<inferenceComponentName>[^:/?]+)$");
const InferenceExperimentArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):inference-experiment/(?<inferenceExperimentName>[^:/?]+)$");
const InferenceRecommendationsJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):inference-recommendations-job/(?<inferenceRecommendationsJobName>[^:/?]+)$");
const JobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):job/(?<jobCategory>[^:/?]+)/(?<jobName>[^:/?]+)$");
const LabelingJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):labeling-job/(?<labelingJobName>[^:/?]+)$");
const LineageGroupArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):lineage-group/(?<lineageGroupName>[^:/?]+)$");
const MlflowAppArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):mlflow-app/(?<mLflowAppId>[^:/?]+)$");
const MlflowTrackingServerArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):mlflow-tracking-server/(?<mlflowTrackingServerName>[^:/?]+)$");
const ModelArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):model/(?<modelName>[^:/?]+)$");
const ModelBiasJobDefinitionArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):model-bias-job-definition/(?<modelBiasJobDefinitionName>[^:/?]+)$");
const ModelCardArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):model-card/(?<modelCardName>[^:/?]+)$");
const ModelCardExportJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):model-card/(?<modelCardName>[^:/?]+)/export-job/(?<exportJobName>[^:/?]+)$");
const ModelExplainabilityJobDefinitionArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):model-explainability-job-definition/(?<modelExplainabilityJobDefinitionName>[^:/?]+)$");
const ModelPackageArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):model-package/(?<modelPackageName>[^:/?]+)$");
const ModelPackageGroupArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):model-package-group/(?<modelPackageGroupName>[^:/?]+)$");
const ModelQualityJobDefinitionArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):model-quality-job-definition/(?<modelQualityJobDefinitionName>[^:/?]+)$");
const MonitoringScheduleArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):monitoring-schedule/(?<monitoringScheduleName>[^:/?]+)$");
const MonitoringScheduleAlertArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):monitoring-schedule/(?<monitoringScheduleName>[^:/?]+)/alert/(?<monitoringScheduleAlertName>[^:/?]+)$");
const NotebookInstanceArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):notebook-instance/(?<notebookInstanceName>[^:/?]+)$");
const NotebookInstanceLifecycleConfigArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):notebook-instance-lifecycle-config/(?<notebookInstanceLifecycleConfigName>[^:/?]+)$");
const OptimizationJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):optimization-job/(?<optimizationJobName>[^:/?]+)$");
const PartnerAppArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):partner-app/(?<appId>[^:/?]+)$");
const PipelineArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):pipeline/(?<pipelineName>[^:/?]+)$");
const PipelineExecutionArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):pipeline/(?<pipelineName>[^:/?]+)/execution/(?<randomString>[^:/?]+)$");
const ProcessingJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):processing-job/(?<processingJobName>[^:/?]+)$");
const ProjectArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):project/(?<projectName>[^:/?]+)$");
const ReservedCapacityArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):reserved-capacity/(?<randomString>[^:/?]+)$");
const SagemakerCatalogArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):sagemaker-catalog/(?<resourceCatalogName>[^:/?]+)$");
const SharedModelArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):shared-model/(?<sharedModelId>[^:/?]+)$");
const SharedModelEventArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):shared-model-event/(?<eventId>[^:/?]+)$");
const SpaceArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):space/(?<domainId>[^:/?]+)/(?<spaceName>[^:/?]+)$");
const StudioLifecycleConfigArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):studio-lifecycle-config/(?<studioLifecycleConfigName>[^:/?]+)$");
const TrainingJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):training-job/(?<trainingJobName>[^:/?]+)$");
const TrainingPlanArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):training-plan/(?<trainingPlanName>[^:/?]+)$");
const TransformJobArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):transform-job/(?<transformJobName>[^:/?]+)$");
const UserProfileArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):user-profile/(?<domainId>[^:/?]+)/(?<userProfileName>[^:/?]+)$");
const WorkforceArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):workforce/(?<workforceName>[^:/?]+)$");
const WorkteamArnRegex = new RegExp("^arn:(?<partition>[^:]+):sagemaker:(?<region>[^:]*):(?<account>[^:]*):workteam/(?<workteamName>[^:/?]+)$");
...
export class SageMakerResources {
	 ...
	 */
	static parseActionArn(arn: string): { partition: string; region: string; account: string; actionName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAiBenchmarkJobArn(arn: string): { partition: string; region: string; account: string; aiBenchmarkJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAiRecommendationJobArn(arn: string): { partition: string; region: string; account: string; aiRecommendationJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAiWorkloadConfigArn(arn: string): { partition: string; region: string; account: string; aiWorkloadConfigName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAlgorithmArn(arn: string): { partition: string; region: string; account: string; algorithmName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAppArn(arn: string): { partition: string; region: string; account: string; domainId: string; userProfileName: string; appType: string; appName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAppImageConfigArn(arn: string): { partition: string; region: string; account: string; appImageConfigName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseArtifactArn(arn: string): { partition: string; region: string; account: string; hashOfArtifactSource: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAutomlJobArn(arn: string): { partition: string; region: string; account: string; autoMlJobJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseClusterArn(arn: string): { partition: string; region: string; account: string; clusterId: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseClusterSchedulerConfigArn(arn: string): { partition: string; region: string; account: string; clusterSchedulerConfigId: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseCodeRepositoryArn(arn: string): { partition: string; region: string; account: string; codeRepositoryName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseCompilationJobArn(arn: string): { partition: string; region: string; account: string; compilationJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseComputeQuotaArn(arn: string): { partition: string; region: string; account: string; computeQuotaId: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseContextArn(arn: string): { partition: string; region: string; account: string; contextName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseDataQualityJobDefinitionArn(arn: string): { partition: string; region: string; account: string; dataQualityJobDefinitionName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseDeviceArn(arn: string): { partition: string; region: string; account: string; deviceFleetName: string; deviceName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseDeviceFleetArn(arn: string): { partition: string; region: string; account: string; deviceFleetName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseDomainArn(arn: string): { partition: string; region: string; account: string; domainId: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseEdgeDeploymentPlanArn(arn: string): { partition: string; region: string; account: string; edgeDeploymentPlanName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseEdgePackagingJobArn(arn: string): { partition: string; region: string; account: string; edgePackagingJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseEndpointArn(arn: string): { partition: string; region: string; account: string; endpointName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseEndpointConfigArn(arn: string): { partition: string; region: string; account: string; endpointConfigName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseExperimentArn(arn: string): { partition: string; region: string; account: string; experimentName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseExperimentTrialArn(arn: string): { partition: string; region: string; account: string; trialName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseExperimentTrialComponentArn(arn: string): { partition: string; region: string; account: string; trialComponentName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseFeatureGroupArn(arn: string): { partition: string; region: string; account: string; featureGroupName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseFlowDefinitionArn(arn: string): { partition: string; region: string; account: string; flowDefinitionName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseHubArn(arn: string): { partition: string; region: string; account: string; hubName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseHubContentArn(arn: string): { partition: string; region: string; account: string; hubName: string; hubContentType: string; hubContentName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseHumanLoopArn(arn: string): { partition: string; region: string; account: string; humanLoopName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseHumanTaskUiArn(arn: string): { partition: string; region: string; account: string; humanTaskUiName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseHyperParameterTuningJobArn(arn: string): { partition: string; region: string; account: string; hyperParameterTuningJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseImageArn(arn: string): { partition: string; region: string; account: string; imageName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseImageVersionArn(arn: string): { partition: string; region: string; account: string; imageName: string; version: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseInferenceComponentArn(arn: string): { partition: string; region: string; account: string; inferenceComponentName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseInferenceExperimentArn(arn: string): { partition: string; region: string; account: string; inferenceExperimentName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseInferenceRecommendationsJobArn(arn: string): { partition: string; region: string; account: string; inferenceRecommendationsJobName: string } {
		...
		return {
			...
			region: match.groups.region,
			account: match.groups.account,
			inferenceRecommendationsJobName: match.groups!.inferenceRecommendationsJobName,
		};
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseJobArn(arn: string): { partition: string; region: string; account: string; jobCategory: string; jobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseLabelingJobArn(arn: string): { partition: string; region: string; account: string; labelingJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseLineageGroupArn(arn: string): { partition: string; region: string; account: string; lineageGroupName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseMlflowAppArn(arn: string): { partition: string; region: string; account: string; mLflowAppId: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseMlflowTrackingServerArn(arn: string): { partition: string; region: string; account: string; mlflowTrackingServerName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseModelArn(arn: string): { partition: string; region: string; account: string; modelName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseModelBiasJobDefinitionArn(arn: string): { partition: string; region: string; account: string; modelBiasJobDefinitionName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseModelCardArn(arn: string): { partition: string; region: string; account: string; modelCardName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseModelCardExportJobArn(arn: string): { partition: string; region: string; account: string; modelCardName: string; exportJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseModelExplainabilityJobDefinitionArn(arn: string): { partition: string; region: string; account: string; modelExplainabilityJobDefinitionName: string } {
		const match = ModelExplainabilityJobDefinitionArnRegex.exec(arn);
		if (!match?.groups) {
			throw new Error(`Invalid model-explainability-job-definition ARN: ${arn}`);
		}
		return {
			partition: match.groups.partition,
			region: match.groups.region,
			account: match.groups.account,
			modelExplainabilityJobDefinitionName: match.groups!.modelExplainabilityJobDefinitionName,
		};
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseModelPackageArn(arn: string): { partition: string; region: string; account: string; modelPackageName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseModelPackageGroupArn(arn: string): { partition: string; region: string; account: string; modelPackageGroupName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseModelQualityJobDefinitionArn(arn: string): { partition: string; region: string; account: string; modelQualityJobDefinitionName: string } {
		...
		return {
			...
			region: match.groups.region,
			account: match.groups.account,
			modelQualityJobDefinitionName: match.groups!.modelQualityJobDefinitionName,
		};
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseMonitoringScheduleArn(arn: string): { partition: string; region: string; account: string; monitoringScheduleName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseMonitoringScheduleAlertArn(arn: string): { partition: string; region: string; account: string; monitoringScheduleName: string; monitoringScheduleAlertName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseNotebookInstanceArn(arn: string): { partition: string; region: string; account: string; notebookInstanceName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseNotebookInstanceLifecycleConfigArn(arn: string): { partition: string; region: string; account: string; notebookInstanceLifecycleConfigName: string } {
		...
		return {
			...
			region: match.groups.region,
			account: match.groups.account,
			notebookInstanceLifecycleConfigName: match.groups!.notebookInstanceLifecycleConfigName,
		};
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseOptimizationJobArn(arn: string): { partition: string; region: string; account: string; optimizationJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parsePartnerAppArn(arn: string): { partition: string; region: string; account: string; appId: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parsePipelineArn(arn: string): { partition: string; region: string; account: string; pipelineName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parsePipelineExecutionArn(arn: string): { partition: string; region: string; account: string; pipelineName: string; randomString: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseProcessingJobArn(arn: string): { partition: string; region: string; account: string; processingJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseProjectArn(arn: string): { partition: string; region: string; account: string; projectName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseReservedCapacityArn(arn: string): { partition: string; region: string; account: string; randomString: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseSagemakerCatalogArn(arn: string): { partition: string; region: string; account: string; resourceCatalogName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseSharedModelArn(arn: string): { partition: string; region: string; account: string; sharedModelId: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseSharedModelEventArn(arn: string): { partition: string; region: string; account: string; eventId: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseSpaceArn(arn: string): { partition: string; region: string; account: string; domainId: string; spaceName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseStudioLifecycleConfigArn(arn: string): { partition: string; region: string; account: string; studioLifecycleConfigName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseTrainingJobArn(arn: string): { partition: string; region: string; account: string; trainingJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseTrainingPlanArn(arn: string): { partition: string; region: string; account: string; trainingPlanName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseTransformJobArn(arn: string): { partition: string; region: string; account: string; transformJobName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseUserProfileArn(arn: string): { partition: string; region: string; account: string; domainId: string; userProfileName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseWorkforceArn(arn: string): { partition: string; region: string; account: string; workforceName: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseWorkteamArn(arn: string): { partition: string; region: string; account: string; workteamName: string } {
...
export class SageMakerOperations {
	...
	static readonly ASSOCIATE_TRIAL_COMPONENT: string[] = ["sagemaker:AssociateTrialComponent"];
	/** IAM actions required for the AttachClusterNodeVolume API call. */
	static readonly ATTACH_CLUSTER_NODE_VOLUME: string[] = ["sagemaker:AttachClusterNodeVolume"];
	/** IAM actions required for the BatchAddClusterNodes API call. */
	static readonly BATCH_ADD_CLUSTER_NODES: string[] = ["sagemaker:BatchAddClusterNodes"];
	/** IAM actions required for the BatchDeleteClusterNodes API call. */
	static readonly BATCH_DELETE_CLUSTER_NODES: string[] = ["sagemaker:BatchDeleteClusterNodes"];
	/** IAM actions required for the BatchDescribeModelPackage API call. */
	static readonly BATCH_DESCRIBE_MODEL_PACKAGE: string[] = ["sagemaker:BatchDescribeModelPackage"];
	...
	static readonly BATCH_WRITE_RECORD: string[] = ["sagemaker:BatchWriteRecord", "sagemaker:PutRecord"];
	/** IAM actions required for the CompleteRollout API call. */
	static readonly COMPLETE_ROLLOUT: string[] = ["sagemaker:CallWithBearerToken", "sagemaker:CompleteRollout"];
	/** IAM actions required for the CreateAIBenchmarkJob API call. */
	static readonly CREATE_AI_BENCHMARK_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateAIBenchmarkJob", "iam:PassRole"];
	/** IAM actions required for the CreateAIRecommendationJob API call. */
	static readonly CREATE_AI_RECOMMENDATION_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateAIRecommendationJob", "iam:PassRole"];
	/** IAM actions required for the CreateAIWorkloadConfig API call. */
	static readonly CREATE_AI_WORKLOAD_CONFIG: string[] = ["sagemaker:AddTags", "sagemaker:CreateAIWorkloadConfig"];
	/** IAM actions required for the CreateAction API call. */
	static readonly CREATE_ACTION: string[] = ["sagemaker:AddTags", "sagemaker:CreateAction"];
	/** IAM actions required for the CreateAlgorithm API call. */
	static readonly CREATE_ALGORITHM: string[] = ["sagemaker:AddTags", "sagemaker:CreateAlgorithm", "iam:PassRole"];
	/** IAM actions required for the CreateApp API call. */
	static readonly CREATE_APP: string[] = ["sagemaker:AddTags", "sagemaker:CreateApp"];
	/** IAM actions required for the CreateAppImageConfig API call. */
	static readonly CREATE_APP_IMAGE_CONFIG: string[] = ["sagemaker:AddTags", "sagemaker:CreateAppImageConfig"];
	/** IAM actions required for the CreateArtifact API call. */
	static readonly CREATE_ARTIFACT: string[] = ["sagemaker:AddTags", "sagemaker:CreateArtifact"];
	/** IAM actions required for the CreateAutoMLJob API call. */
	static readonly CREATE_AUTO_ML_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateAutoMLJob", "iam:PassRole"];
	/** IAM actions required for the CreateAutoMLJobV2 API call. */
	static readonly CREATE_AUTO_ML_JOB_V2: string[] = ["sagemaker:AddTags", "sagemaker:CreateAutoMLJobV2", "iam:PassRole"];
	/** IAM actions required for the CreateCluster API call. */
	static readonly CREATE_CLUSTER: string[] = ["sagemaker:AddTags", "sagemaker:CreateCluster", "iam:PassRole", "sagemaker:UpdateClusterSoftware"];
	/** IAM actions required for the CreateClusterSchedulerConfig API call. */
	static readonly CREATE_CLUSTER_SCHEDULER_CONFIG: string[] = ["sagemaker:AddTags", "sagemaker:CreateClusterSchedulerConfig"];
	/** IAM actions required for the CreateCodeRepository API call. */
	static readonly CREATE_CODE_REPOSITORY: string[] = ["sagemaker:AddTags", "sagemaker:CreateCodeRepository"];
	/** IAM actions required for the CreateCompilationJob API call. */
	static readonly CREATE_COMPILATION_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateCompilationJob", "iam:PassRole"];
	/** IAM actions required for the CreateComputeQuota API call. */
	static readonly CREATE_COMPUTE_QUOTA: string[] = ["sagemaker:AddTags", "sagemaker:CreateComputeQuota"];
	/** IAM actions required for the CreateContext API call. */
	static readonly CREATE_CONTEXT: string[] = ["sagemaker:AddTags", "sagemaker:CreateContext"];
	/** IAM actions required for the CreateDataQualityJobDefinition API call. */
	static readonly CREATE_DATA_QUALITY_JOB_DEFINITION: string[] = ["sagemaker:AddTags", "sagemaker:CreateDataQualityJobDefinition", "iam:PassRole"];
	...
	static readonly CREATE_DOMAIN: string[] = ["sagemaker:AddTags", "sagemaker:CreateDomain", "iam:PassRole"];
	...
	static readonly CREATE_ENDPOINT: string[] = ["sagemaker:AddTags", "sagemaker:CreateEndpoint"];
	/** IAM actions required for the CreateEndpointConfig API call. */
	static readonly CREATE_ENDPOINT_CONFIG: string[] = ["sagemaker:AddTags", "sagemaker:CreateEndpointConfig", "iam:PassRole"];
	/** IAM actions required for the CreateExperiment API call. */
	static readonly CREATE_EXPERIMENT: string[] = ["sagemaker:AddTags", "sagemaker:CreateExperiment"];
	/** IAM actions required for the CreateFeatureGroup API call. */
	static readonly CREATE_FEATURE_GROUP: string[] = ["sagemaker:AddTags", "sagemaker:CreateFeatureGroup", "iam:PassRole"];
	/** IAM actions required for the CreateFlowDefinition API call. */
	static readonly CREATE_FLOW_DEFINITION: string[] = ["sagemaker:AddTags", "sagemaker:CreateFlowDefinition", "iam:PassRole"];
	/** IAM actions required for the CreateHub API call. */
	static readonly CREATE_HUB: string[] = ["sagemaker:AddTags", "sagemaker:CreateHub"];
	/** IAM actions required for the CreateHubContentPresignedUrls API call. */
	static readonly CREATE_HUB_CONTENT_PRESIGNED_URLS: string[] = ["sagemaker:CreateHubContentPresignedUrls"];
	/** IAM actions required for the CreateHubContentReference API call. */
	static readonly CREATE_HUB_CONTENT_REFERENCE: string[] = ["sagemaker:AddTags", "sagemaker:CreateHubContentReference"];
	/** IAM actions required for the CreateHumanTaskUi API call. */
	static readonly CREATE_HUMAN_TASK_UI: string[] = ["sagemaker:AddTags", "sagemaker:CreateHumanTaskUi"];
	/** IAM actions required for the CreateHyperParameterTuningJob API call. */
	static readonly CREATE_HYPER_PARAMETER_TUNING_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateHyperParameterTuningJob", "iam:PassRole"];
	/** IAM actions required for the CreateImage API call. */
	static readonly CREATE_IMAGE: string[] = ["sagemaker:AddTags", "sagemaker:CreateImage", "iam:PassRole"];
	/** IAM actions required for the CreateImageVersion API call. */
	static readonly CREATE_IMAGE_VERSION: string[] = ["sagemaker:CreateImageVersion"];
	/** IAM actions required for the CreateInferenceComponent API call. */
	static readonly CREATE_INFERENCE_COMPONENT: string[] = ["sagemaker:AddTags", "sagemaker:CreateInferenceComponent"];
	/** IAM actions required for the CreateInferenceExperiment API call. */
	static readonly CREATE_INFERENCE_EXPERIMENT: string[] = ["sagemaker:AddTags", "sagemaker:CreateInferenceExperiment", "iam:PassRole"];
	/** IAM actions required for the CreateInferenceRecommendationsJob API call. */
	static readonly CREATE_INFERENCE_RECOMMENDATIONS_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateInferenceRecommendationsJob", "iam:PassRole"];
	/** IAM actions required for the CreateJob API call. */
	static readonly CREATE_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateJob", "sagemaker:ImportHubContent", "iam:PassRole", "sagemaker:UpdateHubContent"];
	/** IAM actions required for the CreateLabelingJob API call. */
	static readonly CREATE_LABELING_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateLabelingJob", "iam:PassRole"];
	/** IAM actions required for the CreateMlflowApp API call. */
	static readonly CREATE_MLFLOW_APP: string[] = ["sagemaker:AddTags", "sagemaker:CreateMlflowApp", "iam:PassRole"];
	/** IAM actions required for the CreateMlflowTrackingServer API call. */
	static readonly CREATE_MLFLOW_TRACKING_SERVER: string[] = ["sagemaker:AddTags", "sagemaker:CreateMlflowTrackingServer", "iam:PassRole"];
	/** IAM actions required for the CreateModel API call. */
	static readonly CREATE_MODEL: string[] = ["sagemaker:AddTags", "sagemaker:CreateModel", "sagemaker:DeployHubModel", "iam:PassRole"];
	/** IAM actions required for the CreateModelBiasJobDefinition API call. */
	static readonly CREATE_MODEL_BIAS_JOB_DEFINITION: string[] = ["sagemaker:AddTags", "sagemaker:CreateModelBiasJobDefinition", "iam:PassRole"];
	/** IAM actions required for the CreateModelCard API call. */
	static readonly CREATE_MODEL_CARD: string[] = ["sagemaker:AddTags", "sagemaker:CreateModelCard"];
	/** IAM actions required for the CreateModelCardExportJob API call. */
	static readonly CREATE_MODEL_CARD_EXPORT_JOB: string[] = ["sagemaker:CreateModelCardExportJob"];
	/** IAM actions required for the CreateModelExplainabilityJobDefinition API call. */
	static readonly CREATE_MODEL_EXPLAINABILITY_JOB_DEFINITION: string[] = ["sagemaker:AddTags", "sagemaker:CreateModelExplainabilityJobDefinition", "iam:PassRole"];
	/** IAM actions required for the CreateModelPackage API call. */
	static readonly CREATE_MODEL_PACKAGE: string[] = ["sagemaker:AddTags", "sagemaker:CreateModelPackage", "iam:PassRole"];
	/** IAM actions required for the CreateModelPackageGroup API call. */
	static readonly CREATE_MODEL_PACKAGE_GROUP: string[] = ["sagemaker:AddTags", "sagemaker:CreateModelPackageGroup"];
	/** IAM actions required for the CreateModelQualityJobDefinition API call. */
	static readonly CREATE_MODEL_QUALITY_JOB_DEFINITION: string[] = ["sagemaker:AddTags", "sagemaker:CreateModelQualityJobDefinition", "iam:PassRole"];
	/** IAM actions required for the CreateMonitoringSchedule API call. */
	static readonly CREATE_MONITORING_SCHEDULE: string[] = ["sagemaker:AddTags", "sagemaker:CreateMonitoringSchedule", "iam:PassRole"];
	/** IAM actions required for the CreateNotebookInstance API call. */
	static readonly CREATE_NOTEBOOK_INSTANCE: string[] = ["sagemaker:AddTags", "sagemaker:CreateNotebookInstance", "iam:PassRole"];
	/** IAM actions required for the CreateNotebookInstanceLifecycleConfig API call. */
	static readonly CREATE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG: string[] = ["sagemaker:AddTags", "sagemaker:CreateNotebookInstanceLifecycleConfig"];
	/** IAM actions required for the CreateOptimizationJob API call. */
	static readonly CREATE_OPTIMIZATION_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateOptimizationJob", "iam:PassRole"];
	/** IAM actions required for the CreatePartnerApp API call. */
	static readonly CREATE_PARTNER_APP: string[] = ["sagemaker:AddTags", "sagemaker:CreatePartnerApp", "iam:PassRole"];
	/** IAM actions required for the CreatePartnerAppPresignedUrl API call. */
	static readonly CREATE_PARTNER_APP_PRESIGNED_URL: string[] = ["sagemaker:CreatePartnerAppPresignedUrl"];
	/** IAM actions required for the CreatePipeline API call. */
	static readonly CREATE_PIPELINE: string[] = ["sagemaker:AddTags", "sagemaker:CreatePipeline", "iam:PassRole"];
	/** IAM actions required for the CreatePresignedDomainUrl API call. */
	static readonly CREATE_PRESIGNED_DOMAIN_URL: string[] = ["sagemaker:CreatePresignedDomainUrl"];
	/** IAM actions required for the CreatePresignedMlflowAppUrl API call. */
	static readonly CREATE_PRESIGNED_MLFLOW_APP_URL: string[] = ["sagemaker:CreatePresignedMlflowAppUrl"];
	/** IAM actions required for the CreatePresignedMlflowTrackingServerUrl API call. */
	static readonly CREATE_PRESIGNED_MLFLOW_TRACKING_SERVER_URL: string[] = ["sagemaker:CreatePresignedMlflowTrackingServerUrl"];
	/** IAM actions required for the CreatePresignedNotebookInstanceUrl API call. */
	static readonly CREATE_PRESIGNED_NOTEBOOK_INSTANCE_URL: string[] = ["sagemaker:CreatePresignedNotebookInstanceUrl"];
	/** IAM actions required for the CreateProcessingJob API call. */
	static readonly CREATE_PROCESSING_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateProcessingJob", "iam:PassRole"];
	/** IAM actions required for the CreateProject API call. */
	static readonly CREATE_PROJECT: string[] = ["sagemaker:AddTags", "sagemaker:CreateProject", "iam:PassRole"];
	/** IAM actions required for the CreateSpace API call. */
	static readonly CREATE_SPACE: string[] = ["sagemaker:AddTags", "sagemaker:CreateSpace"];
	/** IAM actions required for the CreateStudioLifecycleConfig API call. */
	static readonly CREATE_STUDIO_LIFECYCLE_CONFIG: string[] = ["sagemaker:AddTags", "sagemaker:CreateStudioLifecycleConfig"];
	/** IAM actions required for the CreateTrainingJob API call. */
	static readonly CREATE_TRAINING_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateTrainingJob", "iam:PassRole"];
	/** IAM actions required for the CreateTrainingPlan API call. */
	static readonly CREATE_TRAINING_PLAN: string[] = ["sagemaker:AddTags", "sagemaker:CreateReservedCapacity", "sagemaker:CreateTrainingPlan"];
	/** IAM actions required for the CreateTransformJob API call. */
	static readonly CREATE_TRANSFORM_JOB: string[] = ["sagemaker:AddTags", "sagemaker:CreateTransformJob"];
	/** IAM actions required for the CreateTrial API call. */
	static readonly CREATE_TRIAL: string[] = ["sagemaker:AddTags", "sagemaker:CreateTrial"];
	/** IAM actions required for the CreateTrialComponent API call. */
	static readonly CREATE_TRIAL_COMPONENT: string[] = ["sagemaker:AddTags", "sagemaker:CreateTrialComponent"];
	/** IAM actions required for the CreateUserProfile API call. */
	static readonly CREATE_USER_PROFILE: string[] = ["sagemaker:AddTags", "sagemaker:CreateUserProfile", "iam:PassRole"];
	/** IAM actions required for the CreateWorkforce API call. */
	static readonly CREATE_WORKFORCE: string[] = ["sagemaker:AddTags", "sagemaker:CreateWorkforce"];
	/** IAM actions required for the CreateWorkteam API call. */
	static readonly CREATE_WORKTEAM: string[] = ["sagemaker:AddTags", "sagemaker:CreateWorkteam"];
	/** IAM actions required for the DeleteAIBenchmarkJob API call. */
	static readonly DELETE_AI_BENCHMARK_JOB: string[] = ["sagemaker:DeleteAIBenchmarkJob"];
	/** IAM actions required for the DeleteAIRecommendationJob API call. */
	static readonly DELETE_AI_RECOMMENDATION_JOB: string[] = ["sagemaker:DeleteAIRecommendationJob"];
	/** IAM actions required for the DeleteAIWorkloadConfig API call. */
	static readonly DELETE_AI_WORKLOAD_CONFIG: string[] = ["sagemaker:DeleteAIWorkloadConfig"];
	...
	static readonly DELETE_APP_IMAGE_CONFIG: string[] = ["sagemaker:DeleteAppImageConfig"];
	...
	static readonly DELETE_ASSOCIATION: string[] = ["sagemaker:DeleteAssociation"];
	...
	static readonly DELETE_CLUSTER_SCHEDULER_CONFIG: string[] = ["sagemaker:DeleteClusterSchedulerConfig"];
	/** IAM actions required for the DeleteCodeRepository API call. */
	static readonly DELETE_CODE_REPOSITORY: string[] = ["sagemaker:DeleteCodeRepository"];
	/** IAM actions required for the DeleteCompilationJob API call. */
	static readonly DELETE_COMPILATION_JOB: string[] = ["sagemaker:DeleteCompilationJob"];
	/** IAM actions required for the DeleteComputeQuota API call. */
	static readonly DELETE_COMPUTE_QUOTA: string[] = ["sagemaker:DeleteComputeQuota"];
	...
	static readonly DELETE_DATA_QUALITY_JOB_DEFINITION: string[] = ["sagemaker:DeleteDataQualityJobDefinition"];
	...
	static readonly DELETE_ENDPOINT_CONFIG: string[] = ["sagemaker:DeleteEndpointConfig"];
	...
	static readonly DELETE_FEATURE_GROUP: string[] = ["sagemaker:DeleteFeatureGroup"];
	/** IAM actions required for the DeleteFlowDefinition API call. */
	static readonly DELETE_FLOW_DEFINITION: string[] = ["sagemaker:DeleteFlowDefinition"];
	...
	static readonly DELETE_HUB_CONTENT_REFERENCE: string[] = ["sagemaker:DeleteHubContentReference"];
	...
	static readonly DELETE_HUMAN_TASK_UI: string[] = ["sagemaker:DeleteHumanTaskUi"];
	/** IAM actions required for the DeleteHyperParameterTuningJob API call. */
	static readonly DELETE_HYPER_PARAMETER_TUNING_JOB: string[] = ["sagemaker:DeleteHyperParameterTuningJob"];
	...
	static readonly DELETE_IMAGE_VERSION: string[] = ["sagemaker:DeleteImageVersion"];
	/** IAM actions required for the DeleteInferenceComponent API call. */
	static readonly DELETE_INFERENCE_COMPONENT: string[] = ["sagemaker:DeleteInferenceComponent"];
	/** IAM actions required for the DeleteInferenceExperiment API call. */
	static readonly DELETE_INFERENCE_EXPERIMENT: string[] = ["sagemaker:DeleteInferenceExperiment"];
	...
	static readonly DELETE_MLFLOW_TRACKING_SERVER: string[] = ["sagemaker:DeleteMlflowTrackingServer"];
	...
	static readonly DELETE_MODEL_BIAS_JOB_DEFINITION: string[] = ["sagemaker:DeleteModelBiasJobDefinition"];
	...
	static readonly DELETE_MODEL_EXPLAINABILITY_JOB_DEFINITION: string[] = ["sagemaker:DeleteModelExplainabilityJobDefinition"];
	/** IAM actions required for the DeleteModelPackage API call. */
	static readonly DELETE_MODEL_PACKAGE: string[] = ["sagemaker:DeleteModelPackage"];
	/** IAM actions required for the DeleteModelPackageGroup API call. */
	static readonly DELETE_MODEL_PACKAGE_GROUP: string[] = ["sagemaker:DeleteModelPackageGroup"];
	/** IAM actions required for the DeleteModelPackageGroupPolicy API call. */
	static readonly DELETE_MODEL_PACKAGE_GROUP_POLICY: string[] = ["sagemaker:DeleteModelPackageGroupPolicy"];
	/** IAM actions required for the DeleteModelQualityJobDefinition API call. */
	static readonly DELETE_MODEL_QUALITY_JOB_DEFINITION: string[] = ["sagemaker:DeleteModelQualityJobDefinition"];
	/** IAM actions required for the DeleteMonitoringSchedule API call. */
	static readonly DELETE_MONITORING_SCHEDULE: string[] = ["sagemaker:DeleteMonitoringSchedule"];
	/** IAM actions required for the DeleteNotebookInstance API call. */
	static readonly DELETE_NOTEBOOK_INSTANCE: string[] = ["sagemaker:DeleteNotebookInstance"];
	/** IAM actions required for the DeleteNotebookInstanceLifecycleConfig API call. */
	static readonly DELETE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG: string[] = ["sagemaker:DeleteNotebookInstanceLifecycleConfig"];
	/** IAM actions required for the DeleteOptimizationJob API call. */
	static readonly DELETE_OPTIMIZATION_JOB: string[] = ["sagemaker:DeleteOptimizationJob"];
	...
	static readonly DELETE_PROCESSING_JOB: string[] = ["sagemaker:DeleteProcessingJob"];
	...
	static readonly DELETE_STUDIO_LIFECYCLE_CONFIG: string[] = ["sagemaker:DeleteStudioLifecycleConfig"];
	...
	static readonly DELETE_TRAINING_JOB: string[] = ["sagemaker:DeleteTrainingJob"];
	...
	static readonly DELETE_TRIAL_COMPONENT: string[] = ["sagemaker:DeleteTrialComponent"];
	/** IAM actions required for the DeleteUserProfile API call. */
	static readonly DELETE_USER_PROFILE: string[] = ["sagemaker:DeleteUserProfile"];
	...
	static readonly DESCRIBE_AI_BENCHMARK_JOB: string[] = ["sagemaker:DescribeAIBenchmarkJob"];
	/** IAM actions required for the DescribeAIRecommendationJob API call. */
	static readonly DESCRIBE_AI_RECOMMENDATION_JOB: string[] = ["sagemaker:DescribeAIRecommendationJob"];
	/** IAM actions required for the DescribeAIWorkloadConfig API call. */
	static readonly DESCRIBE_AI_WORKLOAD_CONFIG: string[] = ["sagemaker:DescribeAIWorkloadConfig"];
	...
	static readonly DESCRIBE_ALGORITHM: string[] = ["sagemaker:DescribeAlgorithm"];
	...
	static readonly DESCRIBE_APP_IMAGE_CONFIG: string[] = ["sagemaker:DescribeAppImageConfig"];
	...
	static readonly DESCRIBE_AUTO_ML_JOB: string[] = ["sagemaker:DescribeAutoMLJob"];
	/** IAM actions required for the DescribeAutoMLJobV2 API call. */
	static readonly DESCRIBE_AUTO_ML_JOB_V2: string[] = ["sagemaker:DescribeAutoMLJobV2"];
	...
	static readonly DESCRIBE_CLUSTER_EVENT: string[] = ["sagemaker:DescribeClusterEvent"];
	/** IAM actions required for the DescribeClusterNode API call. */
	static readonly DESCRIBE_CLUSTER_NODE: string[] = ["sagemaker:DescribeClusterNode"];
	/** IAM actions required for the DescribeClusterSchedulerConfig API call. */
	static readonly DESCRIBE_CLUSTER_SCHEDULER_CONFIG: string[] = ["sagemaker:DescribeClusterSchedulerConfig"];
	/** IAM actions required for the DescribeCodeRepository API call. */
	static readonly DESCRIBE_CODE_REPOSITORY: string[] = ["sagemaker:DescribeCodeRepository"];
	/** IAM actions required for the DescribeCompilationJob API call. */
	static readonly DESCRIBE_COMPILATION_JOB: string[] = ["sagemaker:DescribeCompilationJob"];
	/** IAM actions required for the DescribeComputeQuota API call. */
	static readonly DESCRIBE_COMPUTE_QUOTA: string[] = ["sagemaker:DescribeComputeQuota"];
	...
	static readonly DESCRIBE_DATA_QUALITY_JOB_DEFINITION: string[] = ["sagemaker:DescribeDataQualityJobDefinition"];
	...
	static readonly DESCRIBE_ENDPOINT_CONFIG: string[] = ["sagemaker:DescribeEndpointConfig"];
	/** IAM actions required for the DescribeExperiment API call. */
	static readonly DESCRIBE_EXPERIMENT: string[] = ["sagemaker:DescribeExperiment"];
	/** IAM actions required for the DescribeFeatureGroup API call. */
	static readonly DESCRIBE_FEATURE_GROUP: string[] = ["sagemaker:DescribeFeatureGroup"];
	/** IAM actions required for the DescribeFeatureMetadata API call. */
	static readonly DESCRIBE_FEATURE_METADATA: string[] = ["sagemaker:DescribeFeatureMetadata"];
	/** IAM actions required for the DescribeFlowDefinition API call. */
	static readonly DESCRIBE_FLOW_DEFINITION: string[] = ["sagemaker:DescribeFlowDefinition"];
	...
	static readonly DESCRIBE_HUB_CONTENT: string[] = ["sagemaker:DescribeHubContent"];
	/** IAM actions required for the DescribeHumanLoop API call. */
	static readonly DESCRIBE_HUMAN_LOOP: string[] = ["sagemaker:DescribeHumanLoop"];
	/** IAM actions required for the DescribeHumanTaskUi API call. */
	static readonly DESCRIBE_HUMAN_TASK_UI: string[] = ["sagemaker:DescribeHumanTaskUi"];
	/** IAM actions required for the DescribeHyperParameterTuningJob API call. */
	static readonly DESCRIBE_HYPER_PARAMETER_TUNING_JOB: string[] = ["sagemaker:DescribeHyperParameterTuningJob"];
	...
	static readonly DESCRIBE_IMAGE_VERSION: string[] = ["sagemaker:DescribeImageVersion"];
	/** IAM actions required for the DescribeInferenceComponent API call. */
	static readonly DESCRIBE_INFERENCE_COMPONENT: string[] = ["sagemaker:DescribeInferenceComponent"];
	/** IAM actions required for the DescribeInferenceExperiment API call. */
	static readonly DESCRIBE_INFERENCE_EXPERIMENT: string[] = ["sagemaker:DescribeInferenceExperiment"];
	/** IAM actions required for the DescribeInferenceRecommendationsJob API call. */
	static readonly DESCRIBE_INFERENCE_RECOMMENDATIONS_JOB: string[] = ["sagemaker:DescribeInferenceRecommendationsJob"];
	...
	static readonly DESCRIBE_JOB_SCHEMA_VERSION: string[] = ["sagemaker:DescribeJobSchemaVersion"];
	/** IAM actions required for the DescribeLabelingJob API call. */
	static readonly DESCRIBE_LABELING_JOB: string[] = ["sagemaker:DescribeLabelingJob"];
	/** IAM actions required for the DescribeLineageGroup API call. */
	static readonly DESCRIBE_LINEAGE_GROUP: string[] = ["sagemaker:DescribeLineageGroup"];
	/** IAM actions required for the DescribeMlflowApp API call. */
	static readonly DESCRIBE_MLFLOW_APP: string[] = ["sagemaker:DescribeMlflowApp"];
	/** IAM actions required for the DescribeMlflowTrackingServer API call. */
	static readonly DESCRIBE_MLFLOW_TRACKING_SERVER: string[] = ["sagemaker:DescribeMlflowTrackingServer"];
	...
	static readonly DESCRIBE_MODEL_BIAS_JOB_DEFINITION: string[] = ["sagemaker:DescribeModelBiasJobDefinition"];
	/** IAM actions required for the DescribeModelCard API call. */
	static readonly DESCRIBE_MODEL_CARD: string[] = ["sagemaker:DescribeModelCard"];
	/** IAM actions required for the DescribeModelCardExportJob API call. */
	static readonly DESCRIBE_MODEL_CARD_EXPORT_JOB: string[] = ["sagemaker:DescribeModelCardExportJob"];
	/** IAM actions required for the DescribeModelExplainabilityJobDefinition API call. */
	static readonly DESCRIBE_MODEL_EXPLAINABILITY_JOB_DEFINITION: string[] = ["sagemaker:DescribeModelExplainabilityJobDefinition"];
	/** IAM actions required for the DescribeModelPackage API call. */
	static readonly DESCRIBE_MODEL_PACKAGE: string[] = ["sagemaker:DescribeModelPackage"];
	/** IAM actions required for the DescribeModelPackageGroup API call. */
	static readonly DESCRIBE_MODEL_PACKAGE_GROUP: string[] = ["sagemaker:DescribeModelPackageGroup"];
	/** IAM actions required for the DescribeModelQualityJobDefinition API call. */
	static readonly DESCRIBE_MODEL_QUALITY_JOB_DEFINITION: string[] = ["sagemaker:DescribeModelQualityJobDefinition"];
	/** IAM actions required for the DescribeMonitoringSchedule API call. */
	static readonly DESCRIBE_MONITORING_SCHEDULE: string[] = ["sagemaker:DescribeMonitoringSchedule"];
	/** IAM actions required for the DescribeNotebookInstance API call. */
	static readonly DESCRIBE_NOTEBOOK_INSTANCE: string[] = ["sagemaker:DescribeNotebookInstance"];
	/** IAM actions required for the DescribeNotebookInstanceLifecycleConfig API call. */
	static readonly DESCRIBE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG: string[] = ["sagemaker:DescribeNotebookInstanceLifecycleConfig"];
	/** IAM actions required for the DescribeOptimizationJob API call. */
	static readonly DESCRIBE_OPTIMIZATION_JOB: string[] = ["sagemaker:DescribeOptimizationJob"];
	/** IAM actions required for the DescribePartnerApp API call. */
	static readonly DESCRIBE_PARTNER_APP: string[] = ["sagemaker:DescribePartnerApp"];
	...
	static readonly DESCRIBE_PIPELINE_DEFINITION_FOR_EXECUTION: string[] = ["sagemaker:DescribePipelineDefinitionForExecution"];
	/** IAM actions required for the DescribePipelineExecution API call. */
	static readonly DESCRIBE_PIPELINE_EXECUTION: string[] = ["sagemaker:DescribePipelineExecution"];
	/** IAM actions required for the DescribeProcessingJob API call. */
	static readonly DESCRIBE_PROCESSING_JOB: string[] = ["sagemaker:DescribeProcessingJob"];
	...
	static readonly DESCRIBE_RESERVED_CAPACITY: string[] = ["sagemaker:DescribeReservedCapacity"];
	...
	static readonly DESCRIBE_STUDIO_LIFECYCLE_CONFIG: string[] = ["sagemaker:DescribeStudioLifecycleConfig"];
	/** IAM actions required for the DescribeSubscribedWorkteam API call. */
	static readonly DESCRIBE_SUBSCRIBED_WORKTEAM: string[] = ["sagemaker:DescribeSubscribedWorkteam"];
	/** IAM actions required for the DescribeTrainingJob API call. */
	static readonly DESCRIBE_TRAINING_JOB: string[] = ["sagemaker:DescribeTrainingJob"];
	/** IAM actions required for the DescribeTrainingPlan API call. */
	static readonly DESCRIBE_TRAINING_PLAN: string[] = ["sagemaker:DescribeTrainingPlan"];
	...
	static readonly DESCRIBE_TRANSFORM_JOB: string[] = ["sagemaker:DescribeTransformJob"];
	...
	static readonly DESCRIBE_TRIAL_COMPONENT: string[] = ["sagemaker:DescribeTrialComponent"];
	/** IAM actions required for the DescribeUserProfile API call. */
	static readonly DESCRIBE_USER_PROFILE: string[] = ["sagemaker:DescribeUserProfile"];
	/** IAM actions required for the DescribeWorkforce API call. */
	static readonly DESCRIBE_WORKFORCE: string[] = ["sagemaker:DescribeWorkforce"];
	...
	static readonly DETACH_CLUSTER_NODE_VOLUME: string[] = ["sagemaker:DetachClusterNodeVolume"];
	/** IAM actions required for the DisableSagemakerServicecatalogPortfolio API call. */
	static readonly DISABLE_SAGEMAKER_SERVICECATALOG_PORTFOLIO: string[] = ["sagemaker:DisableSagemakerServicecatalogPortfolio"];
	/** IAM actions required for the DisassociateTrialComponent API call. */
	static readonly DISASSOCIATE_TRIAL_COMPONENT: string[] = ["sagemaker:DisassociateTrialComponent"];
	/** IAM actions required for the EnableSagemakerServicecatalogPortfolio API call. */
	static readonly ENABLE_SAGEMAKER_SERVICECATALOG_PORTFOLIO: string[] = ["sagemaker:EnableSagemakerServicecatalogPortfolio"];
	...
	static readonly GET_LINEAGE_GROUP_POLICY: string[] = ["sagemaker:GetLineageGroupPolicy"];
	/** IAM actions required for the GetModelPackageGroupPolicy API call. */
	static readonly GET_MODEL_PACKAGE_GROUP_POLICY: string[] = ["sagemaker:GetModelPackageGroupPolicy"];
	...
	static readonly GET_SAGEMAKER_SERVICECATALOG_PORTFOLIO_STATUS: string[] = ["sagemaker:GetSagemakerServicecatalogPortfolioStatus"];
	/** IAM actions required for the GetScalingConfigurationRecommendation API call. */
	static readonly GET_SCALING_CONFIGURATION_RECOMMENDATION: string[] = ["sagemaker:GetScalingConfigurationRecommendation"];
	/** IAM actions required for the GetSearchSuggestions API call. */
	static readonly GET_SEARCH_SUGGESTIONS: string[] = ["sagemaker:GetSearchSuggestions"];
	/** IAM actions required for the ImportHubContent API call. */
	static readonly IMPORT_HUB_CONTENT: string[] = ["sagemaker:AddTags", "sagemaker:ImportHubContent", "iam:PassRole"];
	...
	static readonly INVOKE_ENDPOINT_ASYNC: string[] = ["sagemaker:InvokeEndpointAsync"];
	/** IAM actions required for the InvokeEndpointWithResponseStream API call. */
	static readonly INVOKE_ENDPOINT_WITH_RESPONSE_STREAM: string[] = ["sagemaker:CallWithBearerToken", "sagemaker:InvokeEndpoint"];
	/** IAM actions required for the ListAIBenchmarkJobs API call. */
	static readonly LIST_AI_BENCHMARK_JOBS: string[] = ["sagemaker:ListAIBenchmarkJobs"];
	/** IAM actions required for the ListAIRecommendationJobs API call. */
	static readonly LIST_AI_RECOMMENDATION_JOBS: string[] = ["sagemaker:ListAIRecommendationJobs"];
	/** IAM actions required for the ListAIWorkloadConfigs API call. */
	static readonly LIST_AI_WORKLOAD_CONFIGS: string[] = ["sagemaker:ListAIWorkloadConfigs"];
	...
	static readonly LIST_APP_IMAGE_CONFIGS: string[] = ["sagemaker:ListAppImageConfigs"];
	...
	static readonly LIST_CANDIDATES_FOR_AUTO_ML_JOB: string[] = ["sagemaker:ListCandidatesForAutoMLJob"];
	/** IAM actions required for the ListClusterEvents API call. */
	static readonly LIST_CLUSTER_EVENTS: string[] = ["sagemaker:ListClusterEvents"];
	...
	static readonly LIST_CLUSTER_SCHEDULER_CONFIGS: string[] = ["sagemaker:ListClusterSchedulerConfigs"];
	...
	static readonly LIST_CODE_REPOSITORIES: string[] = ["sagemaker:ListCodeRepositories"];
	/** IAM actions required for the ListCompilationJobs API call. */
	static readonly LIST_COMPILATION_JOBS: string[] = ["sagemaker:ListCompilationJobs"];
	/** IAM actions required for the ListComputeQuotas API call. */
	static readonly LIST_COMPUTE_QUOTAS: string[] = ["sagemaker:ListComputeQuotas"];
	...
	static readonly LIST_DATA_QUALITY_JOB_DEFINITIONS: string[] = ["sagemaker:ListDataQualityJobDefinitions"];
	...
	static readonly LIST_ENDPOINT_CONFIGS: string[] = ["sagemaker:ListEndpointConfigs"];
	...
	static readonly LIST_FEATURE_GROUPS: string[] = ["sagemaker:ListFeatureGroups"];
	/** IAM actions required for the ListFlowDefinitions API call. */
	static readonly LIST_FLOW_DEFINITIONS: string[] = ["sagemaker:ListFlowDefinitions"];
	/** IAM actions required for the ListHubContentVersions API call. */
	static readonly LIST_HUB_CONTENT_VERSIONS: string[] = ["sagemaker:ListHubContentVersions"];
	...
	static readonly LIST_HUMAN_TASK_UIS: string[] = ["sagemaker:ListHumanTaskUis"];
	/** IAM actions required for the ListHyperParameterTuningJobs API call. */
	static readonly LIST_HYPER_PARAMETER_TUNING_JOBS: string[] = ["sagemaker:ListHyperParameterTuningJobs"];
	/** IAM actions required for the ListImageVersions API call. */
	static readonly LIST_IMAGE_VERSIONS: string[] = ["sagemaker:ListImageVersions"];
	...
	static readonly LIST_INFERENCE_COMPONENTS: string[] = ["sagemaker:ListInferenceComponents"];
	/** IAM actions required for the ListInferenceExperiments API call. */
	static readonly LIST_INFERENCE_EXPERIMENTS: string[] = ["sagemaker:ListInferenceExperiments"];
	/** IAM actions required for the ListInferenceRecommendationsJobSteps API call. */
	static readonly LIST_INFERENCE_RECOMMENDATIONS_JOB_STEPS: string[] = ["sagemaker:ListInferenceRecommendationsJobSteps"];
	/** IAM actions required for the ListInferenceRecommendationsJobs API call. */
	static readonly LIST_INFERENCE_RECOMMENDATIONS_JOBS: string[] = ["sagemaker:ListInferenceRecommendationsJobs"];
	/** IAM actions required for the ListJobSchemaVersions API call. */
	static readonly LIST_JOB_SCHEMA_VERSIONS: string[] = ["sagemaker:ListJobSchemaVersions"];
	...
	static readonly LIST_LABELING_JOBS_FOR_WORKTEAM: string[] = ["sagemaker:ListLabelingJobsForWorkteam"];
	/** IAM actions required for the ListLineageGroups API call. */
	static readonly LIST_LINEAGE_GROUPS: string[] = ["sagemaker:ListLineageGroups"];
	...
	static readonly LIST_MLFLOW_TRACKING_SERVERS: string[] = ["sagemaker:ListMlflowTrackingServers"];
	/** IAM actions required for the ListModelBiasJobDefinitions API call. */
	static readonly LIST_MODEL_BIAS_JOB_DEFINITIONS: string[] = ["sagemaker:ListModelBiasJobDefinitions"];
	/** IAM actions required for the ListModelCardExportJobs API call. */
	static readonly LIST_MODEL_CARD_EXPORT_JOBS: string[] = ["sagemaker:ListModelCardExportJobs"];
	/** IAM actions required for the ListModelCardVersions API call. */
	static readonly LIST_MODEL_CARD_VERSIONS: string[] = ["sagemaker:ListModelCardVersions"];
	...
	static readonly LIST_MODEL_EXPLAINABILITY_JOB_DEFINITIONS: string[] = ["sagemaker:ListModelExplainabilityJobDefinitions"];
	/** IAM actions required for the ListModelMetadata API call. */
	static readonly LIST_MODEL_METADATA: string[] = ["sagemaker:ListModelMetadata"];
	/** IAM actions required for the ListModelPackageGroups API call. */
	static readonly LIST_MODEL_PACKAGE_GROUPS: string[] = ["sagemaker:ListModelPackageGroups"];
	/** IAM actions required for the ListModelPackages API call. */
	static readonly LIST_MODEL_PACKAGES: string[] = ["sagemaker:ListModelPackages"];
	/** IAM actions required for the ListModelQualityJobDefinitions API call. */
	static readonly LIST_MODEL_QUALITY_JOB_DEFINITIONS: string[] = ["sagemaker:ListModelQualityJobDefinitions"];
	...
	static readonly LIST_MONITORING_ALERT_HISTORY: string[] = ["sagemaker:ListMonitoringAlertHistory"];
	/** IAM actions required for the ListMonitoringAlerts API call. */
	static readonly LIST_MONITORING_ALERTS: string[] = ["sagemaker:ListMonitoringAlerts"];
	/** IAM actions required for the ListMonitoringExecutions API call. */
	static readonly LIST_MONITORING_EXECUTIONS: string[] = ["sagemaker:ListMonitoringExecutions"];
	/** IAM actions required for the ListMonitoringSchedules API call. */
	static readonly LIST_MONITORING_SCHEDULES: string[] = ["sagemaker:ListMonitoringSchedules"];
	/** IAM actions required for the ListNotebookInstanceLifecycleConfigs API call. */
	static readonly LIST_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIGS: string[] = ["sagemaker:ListNotebookInstanceLifecycleConfigs"];
	/** IAM actions required for the ListNotebookInstances API call. */
	static readonly LIST_NOTEBOOK_INSTANCES: string[] = ["sagemaker:ListNotebookInstances"];
	/** IAM actions required for the ListOptimizationJobs API call. */
	static readonly LIST_OPTIMIZATION_JOBS: string[] = ["sagemaker:ListOptimizationJobs"];
	...
	static readonly LIST_PIPELINE_EXECUTION_STEPS: string[] = ["sagemaker:ListPipelineExecutionSteps"];
	/** IAM actions required for the ListPipelineExecutions API call. */
	static readonly LIST_PIPELINE_EXECUTIONS: string[] = ["sagemaker:ListPipelineExecutions"];
	/** IAM actions required for the ListPipelineParametersForExecution API call. */
	static readonly LIST_PIPELINE_PARAMETERS_FOR_EXECUTION: string[] = ["sagemaker:ListPipelineParametersForExecution"];
	/** IAM actions required for the ListPipelineVersions API call. */
	static readonly LIST_PIPELINE_VERSIONS: string[] = ["sagemaker:ListPipelineVersions"];
	...
	static readonly LIST_PROCESSING_JOBS: string[] = ["sagemaker:ListProcessingJobs"];
	...
	static readonly LIST_RESOURCE_CATALOGS: string[] = ["sagemaker:ListResourceCatalogs"];
	...
	static readonly LIST_STUDIO_LIFECYCLE_CONFIGS: string[] = ["sagemaker:ListStudioLifecycleConfigs"];
	/** IAM actions required for the ListSubscribedWorkteams API call. */
	static readonly LIST_SUBSCRIBED_WORKTEAMS: string[] = ["sagemaker:ListSubscribedWorkteams"];
	...
	static readonly LIST_TRAINING_JOBS_FOR_HYPER_PARAMETER_TUNING_JOB: string[] = ["sagemaker:ListTrainingJobsForHyperParameterTuningJob"];
	/** IAM actions required for the ListTrainingPlans API call. */
	static readonly LIST_TRAINING_PLANS: string[] = ["sagemaker:ListTrainingPlans"];
	/** IAM actions required for the ListTransformJobs API call. */
	static readonly LIST_TRANSFORM_JOBS: string[] = ["sagemaker:ListTransformJobs"];
	/** IAM actions required for the ListTrialComponents API call. */
	static readonly LIST_TRIAL_COMPONENTS: string[] = ["sagemaker:ListTrialComponents"];
	...
	static readonly LIST_ULTRA_SERVERS_BY_RESERVED_CAPACITY: string[] = ["sagemaker:ListUltraServersByReservedCapacity"];
	...
	static readonly PUT_MODEL_PACKAGE_GROUP_POLICY: string[] = ["sagemaker:PutModelPackageGroupPolicy"];
	...
	static readonly RENDER_UI_TEMPLATE: string[] = ["iam:PassRole", "sagemaker:RenderUiTemplate"];
	/** IAM actions required for the RetryPipelineExecution API call. */
	static readonly RETRY_PIPELINE_EXECUTION: string[] = ["sagemaker:RetryPipelineExecution"];
	/** IAM actions required for the Sample API call. */
	static readonly SAMPLE: string[] = ["sagemaker:CallWithBearerToken", "sagemaker:Sample"];
	/** IAM actions required for the SampleWithResponseStream API call. */
	static readonly SAMPLE_WITH_RESPONSE_STREAM: string[] = ["sagemaker:CallWithBearerToken", "sagemaker:SampleWithResponseStream"];
	...
	static readonly SEARCH_TRAINING_PLAN_OFFERINGS: string[] = ["sagemaker:SearchTrainingPlanOfferings"];
	...
	static readonly SEND_PIPELINE_EXECUTION_STEP_FAILURE: string[] = ["sagemaker:SendPipelineExecutionStepFailure"];
	/** IAM actions required for the SendPipelineExecutionStepSuccess API call. */
	static readonly SEND_PIPELINE_EXECUTION_STEP_SUCCESS: string[] = ["sagemaker:SendPipelineExecutionStepSuccess"];
	/** IAM actions required for the StartClusterHealthCheck API call. */
	static readonly START_CLUSTER_HEALTH_CHECK: string[] = ["sagemaker:StartClusterHealthCheck"];
	...
	static readonly START_INFERENCE_EXPERIMENT: string[] = ["sagemaker:StartInferenceExperiment"];
	/** IAM actions required for the StartMlflowTrackingServer API call. */
	static readonly START_MLFLOW_TRACKING_SERVER: string[] = ["sagemaker:StartMlflowTrackingServer"];
	/** IAM actions required for the StartMonitoringSchedule API call. */
	static readonly START_MONITORING_SCHEDULE: string[] = ["sagemaker:StartMonitoringSchedule"];
	/** IAM actions required for the StartNotebookInstance API call. */
	static readonly START_NOTEBOOK_INSTANCE: string[] = ["sagemaker:StartNotebookInstance"];
	/** IAM actions required for the StartPipelineExecution API call. */
	static readonly START_PIPELINE_EXECUTION: string[] = ["sagemaker:StartPipelineExecution"];
	...
	static readonly STOP_AI_BENCHMARK_JOB: string[] = ["sagemaker:StopAIBenchmarkJob"];
	/** IAM actions required for the StopAIRecommendationJob API call. */
	static readonly STOP_AI_RECOMMENDATION_JOB: string[] = ["sagemaker:StopAIRecommendationJob"];
	...
	static readonly STOP_COMPILATION_JOB: string[] = ["sagemaker:StopCompilationJob"];
	...
	static readonly STOP_HYPER_PARAMETER_TUNING_JOB: string[] = ["sagemaker:StopHyperParameterTuningJob"];
	/** IAM actions required for the StopInferenceExperiment API call. */
	static readonly STOP_INFERENCE_EXPERIMENT: string[] = ["sagemaker:StopInferenceExperiment"];
	/** IAM actions required for the StopInferenceRecommendationsJob API call. */
	static readonly STOP_INFERENCE_RECOMMENDATIONS_JOB: string[] = ["sagemaker:StopInferenceRecommendationsJob"];
	...
	static readonly STOP_MLFLOW_TRACKING_SERVER: string[] = ["sagemaker:StopMlflowTrackingServer"];
	/** IAM actions required for the StopMonitoringSchedule API call. */
	static readonly STOP_MONITORING_SCHEDULE: string[] = ["sagemaker:StopMonitoringSchedule"];
	/** IAM actions required for the StopNotebookInstance API call. */
	static readonly STOP_NOTEBOOK_INSTANCE: string[] = ["sagemaker:StopNotebookInstance"];
	/** IAM actions required for the StopOptimizationJob API call. */
	static readonly STOP_OPTIMIZATION_JOB: string[] = ["sagemaker:StopOptimizationJob"];
	/** IAM actions required for the StopPipelineExecution API call. */
	static readonly STOP_PIPELINE_EXECUTION: string[] = ["sagemaker:StopPipelineExecution"];
	/** IAM actions required for the StopProcessingJob API call. */
	static readonly STOP_PROCESSING_JOB: string[] = ["sagemaker:StopProcessingJob"];
	...
	static readonly UPDATE_APP_IMAGE_CONFIG: string[] = ["sagemaker:UpdateAppImageConfig"];
	...
	static readonly UPDATE_CLUSTER: string[] = ["sagemaker:BatchAddClusterNodes", "sagemaker:BatchDeleteClusterNodes", "iam:PassRole", "sagemaker:UpdateCluster", "sagemaker:UpdateClusterSoftware"];
	/** IAM actions required for the UpdateClusterSchedulerConfig API call. */
	static readonly UPDATE_CLUSTER_SCHEDULER_CONFIG: string[] = ["sagemaker:UpdateClusterSchedulerConfig"];
	/** IAM actions required for the UpdateClusterSoftware API call. */
	static readonly UPDATE_CLUSTER_SOFTWARE: string[] = ["sagemaker:UpdateClusterSoftware"];
	/** IAM actions required for the UpdateCodeRepository API call. */
	static readonly UPDATE_CODE_REPOSITORY: string[] = ["sagemaker:UpdateCodeRepository"];
	/** IAM actions required for the UpdateComputeQuota API call. */
	static readonly UPDATE_COMPUTE_QUOTA: string[] = ["sagemaker:UpdateComputeQuota"];
	...
	static readonly UPDATE_DOMAIN: string[] = ["iam:PassRole", "sagemaker:UpdateDomain"];
	...
	static readonly UPDATE_ENDPOINT_WEIGHTS_AND_CAPACITIES: string[] = ["sagemaker:UpdateEndpointWeightsAndCapacities"];
	...
	static readonly UPDATE_FEATURE_GROUP: string[] = ["sagemaker:UpdateFeatureGroup"];
	/** IAM actions required for the UpdateFeatureMetadata API call. */
	static readonly UPDATE_FEATURE_METADATA: string[] = ["sagemaker:UpdateFeatureMetadata"];
	...
	static readonly UPDATE_HUB_CONTENT_REFERENCE: string[] = ["sagemaker:UpdateHubContentReference"];
	/** IAM actions required for the UpdateImage API call. */
	static readonly UPDATE_IMAGE: string[] = ["iam:PassRole", "sagemaker:UpdateImage"];
	/** IAM actions required for the UpdateImageVersion API call. */
	static readonly UPDATE_IMAGE_VERSION: string[] = ["sagemaker:UpdateImageVersion"];
	/** IAM actions required for the UpdateInferenceComponent API call. */
	static readonly UPDATE_INFERENCE_COMPONENT: string[] = ["sagemaker:UpdateInferenceComponent"];
	/** IAM actions required for the UpdateInferenceComponentRuntimeConfig API call. */
	static readonly UPDATE_INFERENCE_COMPONENT_RUNTIME_CONFIG: string[] = ["sagemaker:UpdateInferenceComponentRuntimeConfig"];
	/** IAM actions required for the UpdateInferenceExperiment API call. */
	static readonly UPDATE_INFERENCE_EXPERIMENT: string[] = ["sagemaker:UpdateInferenceExperiment"];
	...
	static readonly UPDATE_MLFLOW_TRACKING_SERVER: string[] = ["sagemaker:UpdateMlflowTrackingServer"];
	...
	static readonly UPDATE_MODEL_PACKAGE: string[] = ["sagemaker:UpdateModelPackage"];
	/** IAM actions required for the UpdateMonitoringAlert API call. */
	static readonly UPDATE_MONITORING_ALERT: string[] = ["sagemaker:UpdateMonitoringAlert"];
	/** IAM actions required for the UpdateMonitoringSchedule API call. */
	static readonly UPDATE_MONITORING_SCHEDULE: string[] = ["iam:PassRole", "sagemaker:UpdateMonitoringSchedule"];
	/** IAM actions required for the UpdateNotebookInstance API call. */
	static readonly UPDATE_NOTEBOOK_INSTANCE: string[] = ["iam:PassRole", "sagemaker:UpdateNotebookInstance"];
	/** IAM actions required for the UpdateNotebookInstanceLifecycleConfig API call. */
	static readonly UPDATE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG: string[] = ["sagemaker:UpdateNotebookInstanceLifecycleConfig"];
	/** IAM actions required for the UpdatePartnerApp API call. */
	static readonly UPDATE_PARTNER_APP: string[] = ["sagemaker:AddTags", "sagemaker:UpdatePartnerApp"];
	/** IAM actions required for the UpdatePipeline API call. */
	static readonly UPDATE_PIPELINE: string[] = ["iam:PassRole", "sagemaker:UpdatePipeline"];
	/** IAM actions required for the UpdatePipelineExecution API call. */
	static readonly UPDATE_PIPELINE_EXECUTION: string[] = ["sagemaker:UpdatePipelineExecution"];
	/** IAM actions required for the UpdatePipelineVersion API call. */
	static readonly UPDATE_PIPELINE_VERSION: string[] = ["sagemaker:UpdatePipelineVersion"];
	/** IAM actions required for the UpdateProject API call. */
	static readonly UPDATE_PROJECT: string[] = ["sagemaker:AddTags", "sagemaker:UpdateProject"];
	/** IAM actions required for the UpdateReward API call. */
	static readonly UPDATE_REWARD: string[] = ["sagemaker:CallWithBearerToken", "sagemaker:UpdateReward"];
	...
	static readonly UPDATE_TRAINING_JOB: string[] = ["sagemaker:UpdateTrainingJob"];
	...
	static readonly UPDATE_TRIAL_COMPONENT: string[] = ["sagemaker:UpdateTrialComponent"];
	/** IAM actions required for the UpdateUserProfile API call. */
	static readonly UPDATE_USER_PROFILE: string[] = ["iam:PassRole", "sagemaker:UpdateUserProfile"];
...
export class SageMakerConditions {
	...
	static readonly ADD_TAGS_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:TaggingAction"];
	/** Condition keys applicable to the CallWithBearerToken action. */
	static readonly CALL_WITH_BEARER_TOKEN_CONDITION_KEYS: string[] = ["sagemaker:BearerTokenType"];
	/** Condition keys applicable to the CreateAIBenchmarkJob action. */
	static readonly CREATE_AI_BENCHMARK_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateAIRecommendationJob action. */
	static readonly CREATE_AI_RECOMMENDATION_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateAIWorkloadConfig action. */
	static readonly CREATE_AI_WORKLOAD_CONFIG_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateAction action. */
	static readonly CREATE_ACTION_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateAlgorithm action. */
	static readonly CREATE_ALGORITHM_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateApp action. */
	static readonly CREATE_APP_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:ImageArns", "sagemaker:ImageVersionArns", "sagemaker:InstanceTypes", "sagemaker:OwnerUserProfileArn", "sagemaker:SpaceSharingType", "sagemaker:StudioLifecycleConfigArns"];
	/** Condition keys applicable to the CreateAppImageConfig action. */
	static readonly CREATE_APP_IMAGE_CONFIG_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateArtifact action. */
	static readonly CREATE_ARTIFACT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateAutoMLJob action. */
	static readonly CREATE_AUTO_ML_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InterContainerTrafficEncryption", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateAutoMLJobV2 action. */
	static readonly CREATE_AUTO_ML_JOB_V2_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InterContainerTrafficEncryption", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateCluster action. */
	static readonly CREATE_CLUSTER_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateClusterSchedulerConfig action. */
	static readonly CREATE_CLUSTER_SCHEDULER_CONFIG_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateCodeRepository action. */
	static readonly CREATE_CODE_REPOSITORY_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateCompilationJob action. */
	static readonly CREATE_COMPILATION_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateComputeQuota action. */
	static readonly CREATE_COMPUTE_QUOTA_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateContext action. */
	static readonly CREATE_CONTEXT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateDataQualityJobDefinition action. */
	static readonly CREATE_DATA_QUALITY_JOB_DEFINITION_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateDeviceFleet action. */
	static readonly CREATE_DEVICE_FLEET_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateDomain action. */
	static readonly CREATE_DOMAIN_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:AppNetworkAccessType", "sagemaker:DomainSharingOutputKmsKeyArn", "sagemaker:ImageArns", "sagemaker:ImageVersionArns", "sagemaker:InstanceTypes", "sagemaker:StudioLifecycleConfigArns", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateEdgeDeploymentPlan action. */
	static readonly CREATE_EDGE_DEPLOYMENT_PLAN_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateEdgeDeploymentStage action. */
	static readonly CREATE_EDGE_DEPLOYMENT_STAGE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateEdgePackagingJob action. */
	static readonly CREATE_EDGE_PACKAGING_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateEndpoint action. */
	static readonly CREATE_ENDPOINT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateEndpointConfig action. */
	static readonly CREATE_ENDPOINT_CONFIG_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:AcceleratorTypes", "sagemaker:InstanceTypes", "sagemaker:ModelArn", "sagemaker:NetworkIsolation", "sagemaker:ServerlessMaxConcurrency", "sagemaker:ServerlessMemorySize", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateExperiment action. */
	static readonly CREATE_EXPERIMENT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateFeatureGroup action. */
	static readonly CREATE_FEATURE_GROUP_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:FeatureGroupDisableGlueTableCreation", "sagemaker:FeatureGroupEnableOnlineStore", "sagemaker:FeatureGroupOfflineStoreConfig", "sagemaker:FeatureGroupOfflineStoreKmsKeyArn", "sagemaker:FeatureGroupOfflineStoreS3Uri", "sagemaker:FeatureGroupOnlineStoreKmsKeyArn"];
	/** Condition keys applicable to the CreateFlowDefinition action. */
	static readonly CREATE_FLOW_DEFINITION_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:WorkteamArn", "sagemaker:WorkteamType"];
	/** Condition keys applicable to the CreateHub action. */
	static readonly CREATE_HUB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateHubContentReference action. */
	static readonly CREATE_HUB_CONTENT_REFERENCE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateHumanTaskUi action. */
	static readonly CREATE_HUMAN_TASK_UI_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateHyperParameterTuningJob action. */
	static readonly CREATE_HYPER_PARAMETER_TUNING_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:FileSystemAccessMode", "sagemaker:FileSystemDirectoryPath", "sagemaker:FileSystemId", "sagemaker:FileSystemType", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateImage action. */
	static readonly CREATE_IMAGE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateInferenceComponent action. */
	static readonly CREATE_INFERENCE_COMPONENT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:ModelArn"];
	/** Condition keys applicable to the CreateInferenceExperiment action. */
	static readonly CREATE_INFERENCE_EXPERIMENT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateInferenceRecommendationsJob action. */
	static readonly CREATE_INFERENCE_RECOMMENDATIONS_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateJob action. */
	static readonly CREATE_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:OutputKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateLabelingJob action. */
	static readonly CREATE_LABELING_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:WorkteamArn", "sagemaker:WorkteamType"];
	/** Condition keys applicable to the CreateMlflowApp action. */
	static readonly CREATE_MLFLOW_APP_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateMlflowTrackingServer action. */
	static readonly CREATE_MLFLOW_TRACKING_SERVER_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateModel action. */
	static readonly CREATE_MODEL_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:DirectGatedModelAccess", "sagemaker:NetworkIsolation", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateModelBiasJobDefinition action. */
	static readonly CREATE_MODEL_BIAS_JOB_DEFINITION_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateModelCard action. */
	static readonly CREATE_MODEL_CARD_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateModelExplainabilityJobDefinition action. */
	static readonly CREATE_MODEL_EXPLAINABILITY_JOB_DEFINITION_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateModelPackage action. */
	static readonly CREATE_MODEL_PACKAGE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:CustomerMetadataProperties/${MetadataKey}", "sagemaker:ModelApprovalStatus", "sagemaker:ModelLifeCycle:Stage", "sagemaker:ModelLifeCycle:StageStatus"];
	/** Condition keys applicable to the CreateModelPackageGroup action. */
	static readonly CREATE_MODEL_PACKAGE_GROUP_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateModelQualityJobDefinition action. */
	static readonly CREATE_MODEL_QUALITY_JOB_DEFINITION_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateMonitoringSchedule action. */
	static readonly CREATE_MONITORING_SCHEDULE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateNotebookInstance action. */
	static readonly CREATE_NOTEBOOK_INSTANCE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:AcceleratorTypes", "sagemaker:DirectInternetAccess", "sagemaker:InstanceTypes", "sagemaker:MinimumInstanceMetadataServiceVersion", "sagemaker:NotebookInstanceLifecycleConfigArns", "sagemaker:RootAccess", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateNotebookInstanceLifecycleConfig action. */
	static readonly CREATE_NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateOptimizationJob action. */
	static readonly CREATE_OPTIMIZATION_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreatePartnerApp action. */
	static readonly CREATE_PARTNER_APP_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreatePipeline action. */
	static readonly CREATE_PIPELINE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateProcessingJob action. */
	static readonly CREATE_PROCESSING_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateProject action. */
	static readonly CREATE_PROJECT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateReservedCapacity action. */
	static readonly CREATE_RESERVED_CAPACITY_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateSpace action. */
	static readonly CREATE_SPACE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:ImageArns", "sagemaker:ImageVersionArns", "sagemaker:InstanceTypes", "sagemaker:OwnerUserProfileArn", "sagemaker:RemoteAccess", "sagemaker:SpaceSharingType", "sagemaker:StudioLifecycleConfigArns"];
	/** Condition keys applicable to the CreateStudioLifecycleConfig action. */
	static readonly CREATE_STUDIO_LIFECYCLE_CONFIG_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateTrainingJob action. */
	static readonly CREATE_TRAINING_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:DirectGatedModelAccess", "sagemaker:EnableRemoteDebug", "sagemaker:FileSystemAccessMode", "sagemaker:FileSystemDirectoryPath", "sagemaker:FileSystemId", "sagemaker:FileSystemType", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:KeepAlivePeriod", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the CreateTrainingPlan action. */
	static readonly CREATE_TRAINING_PLAN_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateTransformJob action. */
	static readonly CREATE_TRANSFORM_JOB_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:ModelArn", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn"];
	/** Condition keys applicable to the CreateTrial action. */
	static readonly CREATE_TRIAL_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateTrialComponent action. */
	static readonly CREATE_TRIAL_COMPONENT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateUserProfile action. */
	static readonly CREATE_USER_PROFILE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:DomainSharingOutputKmsKeyArn", "sagemaker:ImageArns", "sagemaker:ImageVersionArns", "sagemaker:InstanceTypes", "sagemaker:StudioLifecycleConfigArns", "sagemaker:VpcSecurityGroupIds"];
	/** Condition keys applicable to the CreateWorkforce action. */
	static readonly CREATE_WORKFORCE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the CreateWorkteam action. */
	static readonly CREATE_WORKTEAM_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the DeleteApp action. */
	static readonly DELETE_APP_CONDITION_KEYS: string[] = ["sagemaker:OwnerUserProfileArn", "sagemaker:SpaceSharingType"];
	/** Condition keys applicable to the DeleteFeatureGroup action. */
	static readonly DELETE_FEATURE_GROUP_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}"];
	/** Condition keys applicable to the DeleteSpace action. */
	static readonly DELETE_SPACE_CONDITION_KEYS: string[] = ["sagemaker:OwnerUserProfileArn", "sagemaker:SpaceSharingType"];
	...
	static readonly DESCRIBE_PIPELINE_CONDITION_KEYS: string[] = ["sagemaker:PipelineVersionId"];
	/** Condition keys applicable to the ImportHubContent action. */
	static readonly IMPORT_HUB_CONTENT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the InvokeEndpoint action. */
	static readonly INVOKE_ENDPOINT_CONDITION_KEYS: string[] = ["sagemaker:TargetModel"];
	/** Condition keys applicable to the RegisterDevices action. */
	static readonly REGISTER_DEVICES_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the Search action. */
	static readonly SEARCH_CONDITION_KEYS: string[] = ["sagemaker:SearchVisibilityCondition/${FilterKey}"];
	/** Condition keys applicable to the StartPipelineExecution action. */
	static readonly START_PIPELINE_EXECUTION_CONDITION_KEYS: string[] = ["sagemaker:PipelineVersionId"];
	/** Condition keys applicable to the UpdateCluster action. */
	static readonly UPDATE_CLUSTER_CONDITION_KEYS: string[] = ["sagemaker:InstanceTypes", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the UpdateDomain action. */
	static readonly UPDATE_DOMAIN_CONDITION_KEYS: string[] = ["sagemaker:AppNetworkAccessType", "sagemaker:DomainSharingOutputKmsKeyArn", "sagemaker:ImageArns", "sagemaker:ImageVersionArns", "sagemaker:InstanceTypes", "sagemaker:StudioLifecycleConfigArns", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the UpdateModelPackage action. */
	static readonly UPDATE_MODEL_PACKAGE_CONDITION_KEYS: string[] = ["sagemaker:CustomerMetadataProperties/${MetadataKey}", "sagemaker:CustomerMetadataPropertiesToRemove", "sagemaker:ModelApprovalStatus", "sagemaker:ModelLifeCycle:Stage", "sagemaker:ModelLifeCycle:StageStatus"];
	/** Condition keys applicable to the UpdateMonitoringSchedule action. */
	static readonly UPDATE_MONITORING_SCHEDULE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "sagemaker:InstanceTypes", "sagemaker:InterContainerTrafficEncryption", "sagemaker:MaxRuntimeInSeconds", "sagemaker:NetworkIsolation", "sagemaker:OutputKmsKeyArn", "sagemaker:VolumeKmsKeyArn", "sagemaker:VpcSecurityGroupIds", "sagemaker:VpcSubnets"];
	/** Condition keys applicable to the UpdateNotebookInstance action. */
	static readonly UPDATE_NOTEBOOK_INSTANCE_CONDITION_KEYS: string[] = ["sagemaker:AcceleratorTypes", "sagemaker:InstanceTypes", "sagemaker:MinimumInstanceMetadataServiceVersion", "sagemaker:NotebookInstanceLifecycleConfigArns", "sagemaker:RootAccess"];
	/** Condition keys applicable to the UpdatePipelineVersion action. */
	static readonly UPDATE_PIPELINE_VERSION_CONDITION_KEYS: string[] = ["sagemaker:PipelineVersionId"];
	/** Condition keys applicable to the UpdateProject action. */
	static readonly UPDATE_PROJECT_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys"];
	/** Condition keys applicable to the UpdateSpace action. */
	static readonly UPDATE_SPACE_CONDITION_KEYS: string[] = ["sagemaker:ImageArns", "sagemaker:ImageVersionArns", "sagemaker:InstanceTypes", "sagemaker:OwnerUserProfileArn", "sagemaker:RemoteAccess", "sagemaker:SpaceSharingType", "sagemaker:StudioLifecycleConfigArns"];
	/** Condition keys applicable to the UpdateTrainingJob action. */
	static readonly UPDATE_TRAINING_JOB_CONDITION_KEYS: string[] = ["sagemaker:EnableRemoteDebug", "sagemaker:InstanceTypes", "sagemaker:KeepAlivePeriod"];
	/** Condition keys applicable to the UpdateUserProfile action. */
	static readonly UPDATE_USER_PROFILE_CONDITION_KEYS: string[] = ["sagemaker:DomainSharingOutputKmsKeyArn", "sagemaker:ImageArns", "sagemaker:ImageVersionArns", "sagemaker:InstanceTypes", "sagemaker:InstanceTypes", "sagemaker:StudioLifecycleConfigArns", "sagemaker:VpcSecurityGroupIds"];
	...
	static readonly CURRENT_CUSTOMER_METADATA_PROPERTIES = "sagemaker:CurrentCustomerMetadataProperties/${MetadataKey}";
	/** Condition key: sagemaker:CurrentModelLifeCycleStage (String) */
	static readonly CURRENT_MODEL_LIFE_CYCLE_STAGE = "sagemaker:CurrentModelLifeCycleStage";
	/** Condition key: sagemaker:CurrentModelLifeCycleStageStatus (String) */
	static readonly CURRENT_MODEL_LIFE_CYCLE_STAGE_STATUS = "sagemaker:CurrentModelLifeCycleStageStatus";
	/** Condition key: sagemaker:CustomerMetadataProperties/${MetadataKey} (String) */
	static readonly CUSTOMER_METADATA_PROPERTIES = "sagemaker:CustomerMetadataProperties/${MetadataKey}";
	/** Condition key: sagemaker:CustomerMetadataPropertiesToRemove (ArrayOfString) */
	static readonly CUSTOMER_METADATA_PROPERTIES_TO_REMOVE = "sagemaker:CustomerMetadataPropertiesToRemove";
	/** Condition key: sagemaker:DirectGatedModelAccess (String) */
	static readonly DIRECT_GATED_MODEL_ACCESS = "sagemaker:DirectGatedModelAccess";
	...
	static readonly DOMAIN_SHARING_OUTPUT_KMS_KEY = "sagemaker:DomainSharingOutputKmsKey";
	/** Condition key: sagemaker:DomainSharingOutputKmsKeyArn (ARN) */
	static readonly DOMAIN_SHARING_OUTPUT_KMS_KEY_ARN = "sagemaker:DomainSharingOutputKmsKeyArn";
	...
	static readonly FEATURE_GROUP_DISABLE_GLUE_TABLE_CREATION = "sagemaker:FeatureGroupDisableGlueTableCreation";
	/** Condition key: sagemaker:FeatureGroupEnableOnlineStore (Bool) */
	static readonly FEATURE_GROUP_ENABLE_ONLINE_STORE = "sagemaker:FeatureGroupEnableOnlineStore";
	/** Condition key: sagemaker:FeatureGroupOfflineStoreConfig (Bool) */
	static readonly FEATURE_GROUP_OFFLINE_STORE_CONFIG = "sagemaker:FeatureGroupOfflineStoreConfig";
	/** Condition key: sagemaker:FeatureGroupOfflineStoreKmsKey (ARN) */
	static readonly FEATURE_GROUP_OFFLINE_STORE_KMS_KEY = "sagemaker:FeatureGroupOfflineStoreKmsKey";
	/** Condition key: sagemaker:FeatureGroupOfflineStoreKmsKeyArn (ARN) */
	static readonly FEATURE_GROUP_OFFLINE_STORE_KMS_KEY_ARN = "sagemaker:FeatureGroupOfflineStoreKmsKeyArn";
	/** Condition key: sagemaker:FeatureGroupOfflineStoreS3Uri (String) */
	static readonly FEATURE_GROUP_OFFLINE_STORE_S3_URI = "sagemaker:FeatureGroupOfflineStoreS3Uri";
	/** Condition key: sagemaker:FeatureGroupOnlineStoreKmsKey (ARN) */
	static readonly FEATURE_GROUP_ONLINE_STORE_KMS_KEY = "sagemaker:FeatureGroupOnlineStoreKmsKey";
	/** Condition key: sagemaker:FeatureGroupOnlineStoreKmsKeyArn (ARN) */
	static readonly FEATURE_GROUP_ONLINE_STORE_KMS_KEY_ARN = "sagemaker:FeatureGroupOnlineStoreKmsKeyArn";
	...
	static readonly FILE_SYSTEM_DIRECTORY_PATH = "sagemaker:FileSystemDirectoryPath";
	...
	static readonly HOME_EFS_FILE_SYSTEM_KMS_KEY = "sagemaker:HomeEfsFileSystemKmsKey";
	...
	static readonly INTER_CONTAINER_TRAFFIC_ENCRYPTION = "sagemaker:InterContainerTrafficEncryption";
	...
	static readonly MINIMUM_INSTANCE_METADATA_SERVICE_VERSION = "sagemaker:MinimumInstanceMetadataServiceVersion";
	...
	static readonly MODEL_LIFE_CYCLE:STAGE = "sagemaker:ModelLifeCycle:Stage";
	/** Condition key: sagemaker:ModelLifeCycle:StageStatus (String) */
	static readonly MODEL_LIFE_CYCLE:STAGE_STATUS = "sagemaker:ModelLifeCycle:StageStatus";
	...
	static readonly NOTEBOOK_INSTANCE_LIFECYCLE_CONFIG_ARNS = "sagemaker:NotebookInstanceLifecycleConfigArns";
	...
	static readonly SEARCH_VISIBILITY_CONDITION = "sagemaker:SearchVisibilityCondition/${FilterKey}";
	/** Condition key: sagemaker:ServerlessMaxConcurrency (Numeric) */
	static readonly SERVERLESS_MAX_CONCURRENCY = "sagemaker:ServerlessMaxConcurrency";
	...
	static readonly STUDIO_LIFECYCLE_CONFIG_ARNS = "sagemaker:StudioLifecycleConfigArns";
	 ...
	 */
	static acceleratorTypes(values: string[]): Record<string, Record<string, string[]>> {
		return { "ForAllValues:StringEquals": { "sagemaker:AcceleratorTypes": values } };
	}

	/**
	 * Generates a condition block for `sagemaker:AppNetworkAccessType`.
	 */
	static appNetworkAccessType(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static bearerTokenType(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static currentCustomerMetadataProperties(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "sagemaker:CurrentCustomerMetadataProperties/${MetadataKey}": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:CurrentModelLifeCycleStage`.
	 */
	static currentModelLifeCycleStage(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static currentModelLifeCycleStageStatus(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "sagemaker:CurrentModelLifeCycleStageStatus": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:CustomerMetadataProperties/${MetadataKey}`.
	 */
	static customerMetadataProperties(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "sagemaker:CustomerMetadataProperties/${MetadataKey}": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:CustomerMetadataPropertiesToRemove`.
	 */
	static customerMetadataPropertiesToRemove(values: string[]): Record<string, Record<string, string[]>> {
		return { "ForAllValues:StringEquals": { "sagemaker:CustomerMetadataPropertiesToRemove": values } };
	}

	/**
	 * Generates a condition block for `sagemaker:DirectGatedModelAccess`.
	 */
	static directGatedModelAccess(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static directInternetAccess(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static domainSharingOutputKMSKey(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static domainSharingOutputKMSKeyARN(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static enableRemoteDebug(value: boolean): Record<string, Record<string, boolean>> {
	 ...
	 */
	static featureGroupDisableGlueTableCreation(value: boolean): Record<string, Record<string, boolean>> {
		return { "Bool": { "sagemaker:FeatureGroupDisableGlueTableCreation": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:FeatureGroupEnableOnlineStore`.
	 */
	static featureGroupEnableOnlineStore(value: boolean): Record<string, Record<string, boolean>> {
	 ...
	 */
	static featureGroupOfflineStoreConfig(value: boolean): Record<string, Record<string, boolean>> {
	 ...
	 */
	static featureGroupOfflineStoreKMSKey(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static featureGroupOfflineStoreKMSKeyARN(value: string): Record<string, Record<string, string>> {
		return { "ArnEquals": { "sagemaker:FeatureGroupOfflineStoreKmsKeyArn": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:FeatureGroupOfflineStoreS3Uri`.
	 */
	static featureGroupOfflineStoreS3URI(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "sagemaker:FeatureGroupOfflineStoreS3Uri": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:FeatureGroupOnlineStoreKmsKey`.
	 */
	static featureGroupOnlineStoreKMSKey(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static featureGroupOnlineStoreKMSKeyARN(value: string): Record<string, Record<string, string>> {
		return { "ArnEquals": { "sagemaker:FeatureGroupOnlineStoreKmsKeyArn": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:FileSystemAccessMode`.
	 */
	static fileSystemAccessMode(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static fileSystemDirectoryPath(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static homeEFSFileSystemKMSKey(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static imageVersionArns(values: string[]): Record<string, Record<string, string[]>> {
		return { "ForAllValues:ArnEquals": { "sagemaker:ImageVersionArns": values } };
	}

	/**
	 * Generates a condition block for `sagemaker:InstanceTypes`.
	 */
	static instanceTypes(values: string[]): Record<string, Record<string, string[]>> {
		return { "ForAllValues:StringEquals": { "sagemaker:InstanceTypes": values } };
	}

	/**
	 * Generates a condition block for `sagemaker:InterContainerTrafficEncryption`.
	 */
	static interContainerTrafficEncryption(value: boolean): Record<string, Record<string, boolean>> {
	 ...
	 */
	static keepAlivePeriod(value: number): Record<string, Record<string, number>> {
	 ...
	 */
	static maxRuntimeInSeconds(value: number): Record<string, Record<string, number>> {
	 ...
	 */
	static minimumInstanceMetadataServiceVersion(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "sagemaker:MinimumInstanceMetadataServiceVersion": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:ModelApprovalStatus`.
	 */
	static modelApprovalStatus(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static modelLifeCycle:stage(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static modelLifeCycle:stageStatus(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static networkIsolation(value: boolean): Record<string, Record<string, boolean>> {
	 ...
	 */
	static notebookInstanceLifecycleConfigArns(values: string[]): Record<string, Record<string, string[]>> {
		return { "ForAllValues:ArnEquals": { "sagemaker:NotebookInstanceLifecycleConfigArns": values } };
	}
	 ...
	 */
	static outputKMSKeyARN(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static ownerUserProfileARN(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static pipelineVersionId(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static searchVisibilityCondition(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "sagemaker:SearchVisibilityCondition/${FilterKey}": value } };
	}

	/**
	 * Generates a condition block for `sagemaker:ServerlessMaxConcurrency`.
	 */
	static serverlessMaxConcurrency(value: number): Record<string, Record<string, number>> {
	 ...
	 */
	static serverlessMemorySize(value: number): Record<string, Record<string, number>> {
	 ...
	 */
	static spaceSharingType(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static studioLifecycleConfigArns(values: string[]): Record<string, Record<string, string[]>> {
		return { "ForAllValues:ArnEquals": { "sagemaker:StudioLifecycleConfigArns": values } };
	}
	 ...
	 */
	static userProfileName(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static volumeKMSKeyARN(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static vpcSecurityGroupIds(values: string[]): Record<string, Record<string, string[]>> {
		return { "ForAllValues:StringEquals": { "sagemaker:VpcSecurityGroupIds": values } };
	}

	/**
	 * Generates a condition block for `sagemaker:VpcSubnets`.
	 */
	static vpcSubnets(values: string[]): Record<string, Record<string, string[]>> {
