...
export class ElasticloadbalancingActions {
	...
	static readonly ADD_LISTENER_CERTIFICATES =
	...
	static readonly ADD_TRUST_STORE_REVOCATIONS =
	...
	static readonly CREATE_LOAD_BALANCER =
		"elasticloadbalancing:CreateLoadBalancer";
	/** [Write] elasticloadbalancing:CreateLoadBalancerListeners */
	static readonly CREATE_LOAD_BALANCER_LISTENERS =
		"elasticloadbalancing:CreateLoadBalancerListeners";
	/** [Write] elasticloadbalancing:CreateLoadBalancerPolicy */
	static readonly CREATE_LOAD_BALANCER_POLICY =
	...
	static readonly CREATE_TARGET_GROUP =
	...
	static readonly CREATE_WEB_ACL_ASSOCIATION =
	...
	static readonly DELETE_LOAD_BALANCER =
		"elasticloadbalancing:DeleteLoadBalancer";
	/** [Write] elasticloadbalancing:DeleteLoadBalancerListeners */
	static readonly DELETE_LOAD_BALANCER_LISTENERS =
		"elasticloadbalancing:DeleteLoadBalancerListeners";
	/** [Write] elasticloadbalancing:DeleteLoadBalancerPolicy */
	static readonly DELETE_LOAD_BALANCER_POLICY =
	...
	static readonly DESCRIBE_SSL_POLICIES =
	...
	static readonly MODIFY_LISTENER_ATTRIBUTES =
		"elasticloadbalancing:ModifyListenerAttributes";
	/** [Write] elasticloadbalancing:ModifyLoadBalancerAttributes */
	static readonly MODIFY_LOAD_BALANCER_ATTRIBUTES =
	...
	static readonly MODIFY_TARGET_GROUP =
		"elasticloadbalancing:ModifyTargetGroup";
	/** [Write] elasticloadbalancing:ModifyTargetGroupAttributes */
	static readonly MODIFY_TARGET_GROUP_ATTRIBUTES =
	...
	static readonly REGISTER_INSTANCES_WITH_LOAD_BALANCER =
	...
	static readonly REMOVE_LISTENER_CERTIFICATES =
	...
	static readonly REMOVE_TRUST_STORE_REVOCATIONS =
	...
	static readonly READ_ACTIONS: string[] = [
		ElasticloadbalancingActions.DESCRIBE_ACCOUNT_LIMITS,
		ElasticloadbalancingActions.DESCRIBE_CAPACITY_RESERVATION,
		ElasticloadbalancingActions.DESCRIBE_INSTANCE_HEALTH,
		ElasticloadbalancingActions.DESCRIBE_LISTENER_ATTRIBUTES,
		ElasticloadbalancingActions.DESCRIBE_LISTENER_CERTIFICATES,
		ElasticloadbalancingActions.DESCRIBE_LISTENERS,
		ElasticloadbalancingActions.DESCRIBE_LOAD_BALANCER_ATTRIBUTES,
		ElasticloadbalancingActions.DESCRIBE_LOAD_BALANCER_POLICIES,
		ElasticloadbalancingActions.DESCRIBE_LOAD_BALANCER_POLICY_TYPES,
		ElasticloadbalancingActions.DESCRIBE_RULES,
		ElasticloadbalancingActions.DESCRIBE_SSL_POLICIES,
		ElasticloadbalancingActions.DESCRIBE_TAGS,
		ElasticloadbalancingActions.DESCRIBE_TARGET_GROUP_ATTRIBUTES,
		ElasticloadbalancingActions.DESCRIBE_TARGET_GROUPS,
		ElasticloadbalancingActions.DESCRIBE_TARGET_HEALTH,
		ElasticloadbalancingActions.DESCRIBE_TRUST_STORE_ASSOCIATIONS,
		ElasticloadbalancingActions.DESCRIBE_TRUST_STORE_REVOCATIONS,
		ElasticloadbalancingActions.DESCRIBE_TRUST_STORES,
		ElasticloadbalancingActions.GET_LOAD_BALANCER_WEB_ACL,
		ElasticloadbalancingActions.GET_RESOURCE_POLICY,
		ElasticloadbalancingActions.GET_TRUST_STORE_CA_CERTIFICATES_BUNDLE,
		ElasticloadbalancingActions.GET_TRUST_STORE_REVOCATION_CONTENT,
	];
	/** All write-level actions. */
	static readonly WRITE_ACTIONS: string[] = [
		ElasticloadbalancingActions.ADD_LISTENER_CERTIFICATES,
		ElasticloadbalancingActions.ADD_TRUST_STORE_REVOCATIONS,
		ElasticloadbalancingActions.APPLY_SECURITY_GROUPS_TO_LOAD_BALANCER,
		ElasticloadbalancingActions.ATTACH_LOAD_BALANCER_TO_SUBNETS,
		ElasticloadbalancingActions.CONFIGURE_HEALTH_CHECK,
		ElasticloadbalancingActions.CREATE_APP_COOKIE_STICKINESS_POLICY,
		ElasticloadbalancingActions.CREATE_LB_COOKIE_STICKINESS_POLICY,
		ElasticloadbalancingActions.CREATE_LISTENER,
		ElasticloadbalancingActions.CREATE_LOAD_BALANCER,
		ElasticloadbalancingActions.CREATE_LOAD_BALANCER_LISTENERS,
		ElasticloadbalancingActions.CREATE_LOAD_BALANCER_POLICY,
		ElasticloadbalancingActions.CREATE_RULE,
		ElasticloadbalancingActions.CREATE_TARGET_GROUP,
		ElasticloadbalancingActions.CREATE_TRUST_STORE,
		ElasticloadbalancingActions.CREATE_WEB_ACL_ASSOCIATION,
		ElasticloadbalancingActions.DELETE_LISTENER,
		ElasticloadbalancingActions.DELETE_LOAD_BALANCER,
		ElasticloadbalancingActions.DELETE_LOAD_BALANCER_LISTENERS,
		ElasticloadbalancingActions.DELETE_LOAD_BALANCER_POLICY,
		ElasticloadbalancingActions.DELETE_RULE,
		ElasticloadbalancingActions.DELETE_SHARED_TRUST_STORE_ASSOCIATION,
		ElasticloadbalancingActions.DELETE_TARGET_GROUP,
		ElasticloadbalancingActions.DELETE_TRUST_STORE,
		ElasticloadbalancingActions.DELETE_WEB_ACL_ASSOCIATION,
		ElasticloadbalancingActions.DEREGISTER_INSTANCES_FROM_LOAD_BALANCER,
		ElasticloadbalancingActions.DEREGISTER_TARGETS,
		ElasticloadbalancingActions.DETACH_LOAD_BALANCER_FROM_SUBNETS,
		ElasticloadbalancingActions.DISABLE_AVAILABILITY_ZONES_FOR_LOAD_BALANCER,
		ElasticloadbalancingActions.ENABLE_AVAILABILITY_ZONES_FOR_LOAD_BALANCER,
		ElasticloadbalancingActions.MODIFY_CAPACITY_RESERVATION,
		ElasticloadbalancingActions.MODIFY_IP_POOLS,
		ElasticloadbalancingActions.MODIFY_LISTENER,
		ElasticloadbalancingActions.MODIFY_LISTENER_ATTRIBUTES,
		ElasticloadbalancingActions.MODIFY_LOAD_BALANCER_ATTRIBUTES,
		ElasticloadbalancingActions.MODIFY_RULE,
		ElasticloadbalancingActions.MODIFY_TARGET_GROUP,
		ElasticloadbalancingActions.MODIFY_TARGET_GROUP_ATTRIBUTES,
		ElasticloadbalancingActions.MODIFY_TRUST_STORE,
		ElasticloadbalancingActions.REGISTER_INSTANCES_WITH_LOAD_BALANCER,
		ElasticloadbalancingActions.REGISTER_TARGETS,
		ElasticloadbalancingActions.REMOVE_LISTENER_CERTIFICATES,
		ElasticloadbalancingActions.REMOVE_TRUST_STORE_REVOCATIONS,
		ElasticloadbalancingActions.SET_IP_ADDRESS_TYPE,
		ElasticloadbalancingActions.SET_LOAD_BALANCER_LISTENER_SSL_CERTIFICATE,
		ElasticloadbalancingActions.SET_LOAD_BALANCER_POLICIES_FOR_BACKEND_SERVER,
		ElasticloadbalancingActions.SET_LOAD_BALANCER_POLICIES_OF_LISTENER,
		ElasticloadbalancingActions.SET_RULE_PRIORITIES,
		ElasticloadbalancingActions.SET_SECURITY_GROUPS,
		ElasticloadbalancingActions.SET_SUBNETS,
		ElasticloadbalancingActions.SET_WEB_ACL,
	];
	/** All list-level actions. */
	static readonly LIST_ACTIONS: string[] = [
		ElasticloadbalancingActions.DESCRIBE_LOAD_BALANCERS,
		ElasticloadbalancingActions.DESCRIBE_WEB_ACL_ASSOCIATION,
	];
	/** All permission-management-level actions. */
	static readonly PERMISSION_MANAGEMENT_ACTIONS: string[] = [
		ElasticloadbalancingActions.ALLOW_VENDED_LOG_DELIVERY_FOR_RESOURCE,
	];
	/** All tagging-level actions. */
	static readonly TAGGING_ACTIONS: string[] = [
		ElasticloadbalancingActions.ADD_TAGS,
		ElasticloadbalancingActions.REMOVE_TAGS,
	];
}

const ListenerRuleAppArnRegex = new RegExp(
...
const ListenerRuleNetArnRegex = new RegExp(
...
export class ElasticloadbalancingResources {
	 ...
	 */
	static isValidListenerRuleAppArn(arn: string): boolean {
		return ListenerRuleAppArnRegex.test(arn);
	}
	 ...
	 */
	static parseListenerRuleAppArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		...
		const match = ListenerRuleAppArnRegex.exec(arn);
		if (!match?.groups) {
	 ...
	 */
	static isValidListenerRuleNetArn(arn: string): boolean {
		return ListenerRuleNetArnRegex.test(arn);
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseListenerRuleNetArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		loadBalancerName: string;
		...
		const match = ListenerRuleNetArnRegex.exec(arn);
		if (!match?.groups) {
	 ...
	 */
	static isValidListenerAppArn(arn: string): boolean {
		return ListenerAppArnRegex.test(arn);
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseListenerAppArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		loadBalancerName: string;
		...
		const match = ListenerAppArnRegex.exec(arn);
		if (!match?.groups) {
	 ...
	 */
	static isValidListenerGwyArn(arn: string): boolean {
		return ListenerGwyArnRegex.test(arn);
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseListenerGwyArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		loadBalancerName: string;
		...
		const match = ListenerGwyArnRegex.exec(arn);
		if (!match?.groups) {
	 ...
	 */
	static isValidListenerNetArn(arn: string): boolean {
		return ListenerNetArnRegex.test(arn);
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseListenerNetArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		loadBalancerName: string;
		...
		const match = ListenerNetArnRegex.exec(arn);
		if (!match?.groups) {
	 ...
	 */
	static isValidLoadbalancerGwyArn(arn: string): boolean {
		return LoadbalancerGwyArnRegex.test(arn);
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseLoadbalancerGwyArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		loadBalancerName: string;
		...
		const match = LoadbalancerGwyArnRegex.exec(arn);
		if (!match?.groups) {
	 ...
	 */
	static isValidLoadbalancerNetArn(arn: string): boolean {
		return LoadbalancerNetArnRegex.test(arn);
	}
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseLoadbalancerNetArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		loadBalancerName: string;
		...
		const match = LoadbalancerNetArnRegex.exec(arn);
		if (!match?.groups) {
...
export class ElasticloadbalancingOperations {
	...
	static readonly ADD_LISTENER_CERTIFICATES: string[] = [
		"elasticloadbalancing:AddListenerCertificates",
	];
	...
	static readonly CREATE_LOAD_BALANCER_LISTENERS: string[] = [
		"elasticloadbalancing:CreateLoadBalancerListeners",
	];
	/** IAM actions required for the CreateLoadBalancerPolicy API call. */
	static readonly CREATE_LOAD_BALANCER_POLICY: string[] = [
		"elasticloadbalancing:CreateLoadBalancerPolicy",
	];
	...
	static readonly DELETE_LOAD_BALANCER_LISTENERS: string[] = [
		"elasticloadbalancing:DeleteLoadBalancerListeners",
	];
	/** IAM actions required for the DeleteLoadBalancerPolicy API call. */
	static readonly DELETE_LOAD_BALANCER_POLICY: string[] = [
		"elasticloadbalancing:DeleteLoadBalancerPolicy",
	];
	...
	static readonly DELETE_SHARED_TRUST_STORE_ASSOCIATION: string[] = [
		"elasticloadbalancing:DeleteSharedTrustStoreAssociation",
	];
	...
	static readonly DEREGISTER_INSTANCES_FROM_LOAD_BALANCER: string[] = [
		"elasticloadbalancing:DeregisterInstancesFromLoadBalancer",
	];
	...
	static readonly GET_TRUST_STORE_CA_CERTIFICATES_BUNDLE: string[] = [
		"elasticloadbalancing:GetTrustStoreCaCertificatesBundle",
	];
	/** IAM actions required for the GetTrustStoreRevocationContent API call. */
	static readonly GET_TRUST_STORE_REVOCATION_CONTENT: string[] = [
		"elasticloadbalancing:GetTrustStoreRevocationContent",
	];
	...
	static readonly REMOVE_TRUST_STORE_REVOCATIONS: string[] = [
		"elasticloadbalancing:RemoveTrustStoreRevocations",
	];
	...
	static readonly SET_LOAD_BALANCER_LISTENER_SSL_CERTIFICATE: string[] = [
		"elasticloadbalancing:SetLoadBalancerListenerSSLCertificate",
	];
	/** IAM actions required for the SetLoadBalancerPoliciesForBackendServer API call. */
	static readonly SET_LOAD_BALANCER_POLICIES_FOR_BACKEND_SERVER: string[] = [
		"elasticloadbalancing:SetLoadBalancerPoliciesForBackendServer",
	];
	/** IAM actions required for the SetLoadBalancerPoliciesOfListener API call. */
	static readonly SET_LOAD_BALANCER_POLICIES_OF_LISTENER: string[] = [
		"elasticloadbalancing:SetLoadBalancerPoliciesOfListener",
	];
	/** IAM actions required for the SetRulePriorities API call. */
	static readonly SET_RULE_PRIORITIES: string[] = [
		"elasticloadbalancing:SetRulePriorities",
	];
	/** IAM actions required for the SetSecurityGroups API call. */
	static readonly SET_SECURITY_GROUPS: string[] = [
		"elasticloadbalancing:SetSecurityGroups",
	];
...
export class ElasticloadbalancingConditions {
	...
	static readonly ADD_LISTENER_CERTIFICATES_CONDITION_KEYS: string[] = [
	...
	static readonly ADD_TRUST_STORE_REVOCATIONS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the ApplySecurityGroupsToLoadBalancer action. */
	static readonly APPLY_SECURITY_GROUPS_TO_LOAD_BALANCER_CONDITION_KEYS: string[] =
		[
			"aws:ResourceTag/${TagKey}",
			"elasticloadbalancing:ResourceTag/${TagKey}",
	...
	static readonly ATTACH_LOAD_BALANCER_TO_SUBNETS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
		"elasticloadbalancing:Subnet",
	];
	/** Condition keys applicable to the ConfigureHealthCheck action. */
	static readonly CONFIGURE_HEALTH_CHECK_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the CreateAppCookieStickinessPolicy action. */
	static readonly CREATE_APP_COOKIE_STICKINESS_POLICY_CONDITION_KEYS: string[] =
	...
	static readonly CREATE_LB_COOKIE_STICKINESS_POLICY_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	...
	static readonly CREATE_LOAD_BALANCER_LISTENERS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ListenerProtocol",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the CreateLoadBalancerPolicy action. */
	static readonly CREATE_LOAD_BALANCER_POLICY_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
		"elasticloadbalancing:SecurityPolicy",
	];
	...
	static readonly CREATE_WEB_ACL_ASSOCIATION_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	...
	static readonly DELETE_LOAD_BALANCER_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the DeleteLoadBalancerListeners action. */
	static readonly DELETE_LOAD_BALANCER_LISTENERS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the DeleteLoadBalancerPolicy action. */
	static readonly DELETE_LOAD_BALANCER_POLICY_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	...
	static readonly DELETE_SHARED_TRUST_STORE_ASSOCIATION_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	...
	static readonly DELETE_TRUST_STORE_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the DeleteWebACLAssociation action. */
	static readonly DELETE_WEB_ACL_ASSOCIATION_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the DeregisterInstancesFromLoadBalancer action. */
	static readonly DEREGISTER_INSTANCES_FROM_LOAD_BALANCER_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	/** Condition keys applicable to the DeregisterTargets action. */
	static readonly DEREGISTER_TARGETS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the DetachLoadBalancerFromSubnets action. */
	static readonly DETACH_LOAD_BALANCER_FROM_SUBNETS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the DisableAvailabilityZonesForLoadBalancer action. */
	static readonly DISABLE_AVAILABILITY_ZONES_FOR_LOAD_BALANCER_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	/** Condition keys applicable to the EnableAvailabilityZonesForLoadBalancer action. */
	static readonly ENABLE_AVAILABILITY_ZONES_FOR_LOAD_BALANCER_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	/** Condition keys applicable to the GetLoadBalancerWebACL action. */
	static readonly GET_LOAD_BALANCER_WEB_ACL_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	...
	static readonly GET_TRUST_STORE_CA_CERTIFICATES_BUNDLE_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	/** Condition keys applicable to the GetTrustStoreRevocationContent action. */
	static readonly GET_TRUST_STORE_REVOCATION_CONTENT_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	...
	static readonly MODIFY_IP_POOLS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the ModifyListener action. */
	static readonly MODIFY_LISTENER_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ListenerProtocol",
		"elasticloadbalancing:ResourceTag/${TagKey}",
		"elasticloadbalancing:SecurityPolicy",
	...
	static readonly MODIFY_LISTENER_ATTRIBUTES_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the ModifyLoadBalancerAttributes action. */
	static readonly MODIFY_LOAD_BALANCER_ATTRIBUTES_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the ModifyRule action. */
	static readonly MODIFY_RULE_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the ModifyTargetGroup action. */
	static readonly MODIFY_TARGET_GROUP_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the ModifyTargetGroupAttributes action. */
	static readonly MODIFY_TARGET_GROUP_ATTRIBUTES_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the ModifyTrustStore action. */
	static readonly MODIFY_TRUST_STORE_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the RegisterInstancesWithLoadBalancer action. */
	static readonly REGISTER_INSTANCES_WITH_LOAD_BALANCER_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	/** Condition keys applicable to the RegisterTargets action. */
	static readonly REGISTER_TARGETS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the RemoveListenerCertificates action. */
	static readonly REMOVE_LISTENER_CERTIFICATES_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	...
	static readonly REMOVE_TRUST_STORE_REVOCATIONS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the SetIpAddressType action. */
	static readonly SET_IP_ADDRESS_TYPE_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the SetLoadBalancerListenerSSLCertificate action. */
	static readonly SET_LOAD_BALANCER_LISTENER_SSL_CERTIFICATE_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	/** Condition keys applicable to the SetLoadBalancerPoliciesForBackendServer action. */
	static readonly SET_LOAD_BALANCER_POLICIES_FOR_BACKEND_SERVER_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}", "elasticloadbalancing:ResourceTag/${TagKey}"];
	/** Condition keys applicable to the SetLoadBalancerPoliciesOfListener action. */
	static readonly SET_LOAD_BALANCER_POLICIES_OF_LISTENER_CONDITION_KEYS: string[] =
		[
			"aws:ResourceTag/${TagKey}",
			"elasticloadbalancing:ResourceTag/${TagKey}",
			"elasticloadbalancing:SecurityPolicy",
	...
	static readonly SET_SECURITY_GROUPS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
		"elasticloadbalancing:SecurityGroup",
	];
	/** Condition keys applicable to the SetSubnets action. */
	static readonly SET_SUBNETS_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"elasticloadbalancing:ResourceTag/${TagKey}",
		"elasticloadbalancing:Subnet",
	];
	...
	static listenerProtocol(
		...
		return {
			"ForAllValues:StringEquals": {
				"elasticloadbalancing:ListenerProtocol": values,
			},
		};
	}
	...
	static resourceTag(value: string): Record<string, Record<string, string>> {
		return {
			StringEquals: { "elasticloadbalancing:ResourceTag/${TagKey}": value },
		};
	}
	...
	static securityGroup(
		...
		return {
			"ForAllValues:StringEquals": {
				"elasticloadbalancing:SecurityGroup": values,
			},
		};
	}
	...
	static securityPolicy(
		...
		return {
			"ForAllValues:StringEquals": {
				"elasticloadbalancing:SecurityPolicy": values,
			},
		};
	}
	...
	static subnet(values: string[]): Record<string, Record<string, string[]>> {
		return {
			"ForAllValues:StringEquals": { "elasticloadbalancing:Subnet": values },
		};
	}
}
