...
export class Wafv2Actions {
	...
	static readonly DELETE_FIREWALL_MANAGER_RULE_GROUPS =
	...
	static readonly GENERATE_MOBILE_SDK_RELEASE_URL =
	...
	static readonly GET_RATE_BASED_STATEMENT_MANAGED_KEYS =
	...
	static readonly GET_REVENUE_STATISTICS_SUMMARY =
		"wafv2:GetRevenueStatisticsSummary";
	/** [Read] wafv2:GetRevenueStatisticsTimeSeries */
	static readonly GET_REVENUE_STATISTICS_TIME_SERIES =
	...
	static readonly GET_TOP_PATH_STATISTICS_BY_TRAFFIC =
	...
	static readonly LIST_AVAILABLE_MANAGED_RULE_GROUP_VERSIONS =
		"wafv2:ListAvailableManagedRuleGroupVersions";
	/** [List] wafv2:ListAvailableManagedRuleGroups */
	static readonly LIST_AVAILABLE_MANAGED_RULE_GROUPS =
	...
	static readonly PUT_FIREWALL_MANAGER_RULE_GROUPS =
	...
	static readonly PUT_MANAGED_RULE_SET_VERSIONS =
	...
	static readonly UPDATE_MANAGED_RULE_SET_VERSION_EXPIRY_DATE =
	...
	static readonly READ_ACTIONS: string[] = [
		Wafv2Actions.CHECK_CAPACITY,
		Wafv2Actions.DESCRIBE_ALL_MANAGED_PRODUCTS,
		Wafv2Actions.DESCRIBE_MANAGED_PRODUCTS_BY_VENDOR,
		Wafv2Actions.DESCRIBE_MANAGED_RULE_GROUP,
		Wafv2Actions.GENERATE_MOBILE_SDK_RELEASE_URL,
		Wafv2Actions.GET_DECRYPTED_API_KEY,
		Wafv2Actions.GET_IP_SET,
		Wafv2Actions.GET_LOGGING_CONFIGURATION,
		Wafv2Actions.GET_MANAGED_RULE_SET,
		Wafv2Actions.GET_MOBILE_SDK_RELEASE,
		Wafv2Actions.GET_PERMISSION_POLICY,
		Wafv2Actions.GET_RATE_BASED_STATEMENT_MANAGED_KEYS,
		Wafv2Actions.GET_REGEX_PATTERN_SET,
		Wafv2Actions.GET_REVENUE_STATISTICS,
		Wafv2Actions.GET_REVENUE_STATISTICS_SUMMARY,
		Wafv2Actions.GET_REVENUE_STATISTICS_TIME_SERIES,
		Wafv2Actions.GET_RULE_GROUP,
		Wafv2Actions.GET_SAMPLED_REQUESTS,
		Wafv2Actions.GET_TOP_PATH_STATISTICS_BY_TRAFFIC,
		Wafv2Actions.GET_WEB_ACL,
		Wafv2Actions.GET_WEB_ACL_FOR_RESOURCE,
		Wafv2Actions.LIST_TAGS_FOR_RESOURCE,
	];
	/** All write-level actions. */
	static readonly WRITE_ACTIONS: string[] = [
		Wafv2Actions.ASSOCIATE_WEB_ACL,
		Wafv2Actions.CREATE_API_KEY,
		Wafv2Actions.CREATE_IP_SET,
		Wafv2Actions.CREATE_REGEX_PATTERN_SET,
		Wafv2Actions.CREATE_RULE_GROUP,
		Wafv2Actions.CREATE_WEB_ACL,
		Wafv2Actions.DELETE_API_KEY,
		Wafv2Actions.DELETE_FIREWALL_MANAGER_RULE_GROUPS,
		Wafv2Actions.DELETE_IP_SET,
		Wafv2Actions.DELETE_LOGGING_CONFIGURATION,
		Wafv2Actions.DELETE_REGEX_PATTERN_SET,
		Wafv2Actions.DELETE_RULE_GROUP,
		Wafv2Actions.DELETE_WEB_ACL,
		Wafv2Actions.DISASSOCIATE_FIREWALL_MANAGER,
		Wafv2Actions.DISASSOCIATE_WEB_ACL,
		Wafv2Actions.PUT_FIREWALL_MANAGER_RULE_GROUPS,
		Wafv2Actions.PUT_LOGGING_CONFIGURATION,
		Wafv2Actions.PUT_MANAGED_RULE_SET_VERSIONS,
		Wafv2Actions.UPDATE_IP_SET,
		Wafv2Actions.UPDATE_MANAGED_RULE_SET_VERSION_EXPIRY_DATE,
		Wafv2Actions.UPDATE_REGEX_PATTERN_SET,
		Wafv2Actions.UPDATE_RULE_GROUP,
		Wafv2Actions.UPDATE_WEB_ACL,
	];
	/** All list-level actions. */
	static readonly LIST_ACTIONS: string[] = [
		Wafv2Actions.LIST_API_KEYS,
		Wafv2Actions.LIST_AVAILABLE_MANAGED_RULE_GROUP_VERSIONS,
		Wafv2Actions.LIST_AVAILABLE_MANAGED_RULE_GROUPS,
		Wafv2Actions.LIST_IP_SETS,
		Wafv2Actions.LIST_LOGGING_CONFIGURATIONS,
		Wafv2Actions.LIST_MANAGED_RULE_SETS,
		Wafv2Actions.LIST_MOBILE_SDK_RELEASES,
		Wafv2Actions.LIST_REGEX_PATTERN_SETS,
		Wafv2Actions.LIST_RESOURCES_FOR_WEB_ACL,
		Wafv2Actions.LIST_RULE_GROUPS,
		Wafv2Actions.LIST_SETTLEMENT_RECORDS,
		Wafv2Actions.LIST_WEB_AC_LS,
	];
	/** All permission-management-level actions. */
	static readonly PERMISSION_MANAGEMENT_ACTIONS: string[] = [
		Wafv2Actions.DELETE_PERMISSION_POLICY,
		Wafv2Actions.PUT_PERMISSION_POLICY,
	];
	/** All tagging-level actions. */
	static readonly TAGGING_ACTIONS: string[] = [
		Wafv2Actions.TAG_RESOURCE,
		Wafv2Actions.UNTAG_RESOURCE,
	];
}

const AgentcoreGatewayArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):bedrock-agentcore:(?<region>[^:]*):(?<account>[^:]*):gateway/(?<gatewayId>[^:/?]+)$",
);
const AmplifyAppArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):amplify:(?<region>[^:]*):(?<account>[^:]*):apps/(?<appId>[^:/?]+)$",
);
const ApigatewayArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):apigateway:(?<region>[^:]*)::/restapis/(?<apiId>[^:/?]+)/stages/(?<stageName>[^:/?]+)$",
);
const ApprunnerArnRegex = new RegExp(
	"^arn:(?<partition>[^:]+):apprunner:(?<region>[^:]*):(?<account>[^:]*):service/(?<serviceName>[^:/?]+)/(?<serviceId>[^:/?]+)$",
);
const AppsyncArnRegex = new RegExp(
...
const ManagedrulesetArnRegex = new RegExp(
...
export class Wafv2Resources {
	 ...
	 */
	static parseAgentcoreGatewayArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		gatewayId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAmplifyAppArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		appId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseApigatewayArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		apiId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseApprunnerArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		serviceName: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseAppsyncArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		graphQlapiId: string;
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseManagedrulesetArn(arn: string): {
		partition: string;
		region: string;
		account: string;
		scope: string;
...
export class Wafv2Operations {
	...
	static readonly DELETE_FIREWALL_MANAGER_RULE_GROUPS: string[] = [
		"wafv2:DeleteFirewallManagerRuleGroups",
	];
	...
	static readonly DESCRIBE_ALL_MANAGED_PRODUCTS: string[] = [
		"wafv2:DescribeAllManagedProducts",
	];
	/** IAM actions required for the DescribeManagedProductsByVendor API call. */
	static readonly DESCRIBE_MANAGED_PRODUCTS_BY_VENDOR: string[] = [
		"wafv2:DescribeManagedProductsByVendor",
	];
	/** IAM actions required for the DescribeManagedRuleGroup API call. */
	static readonly DESCRIBE_MANAGED_RULE_GROUP: string[] = [
		"wafv2:DescribeManagedRuleGroup",
	];
	...
	static readonly GENERATE_MOBILE_SDK_RELEASE_URL: string[] = [
		"wafv2:GenerateMobileSdkReleaseUrl",
	];
	/** IAM actions required for the GetDecryptedAPIKey API call. */
	static readonly GET_DECRYPTED_API_KEY: string[] = [
	...
	static readonly GET_MOBILE_SDK_RELEASE: string[] = [
	...
	static readonly GET_RATE_BASED_STATEMENT_MANAGED_KEYS: string[] = [
		"wafv2:GetRateBasedStatementManagedKeys",
	];
	...
	static readonly GET_TOP_PATH_STATISTICS_BY_TRAFFIC: string[] = [
		"wafv2:GetTopPathStatisticsByTraffic",
	];
	...
	static readonly LIST_AVAILABLE_MANAGED_RULE_GROUP_VERSIONS: string[] = [
		"wafv2:ListAvailableManagedRuleGroupVersions",
	];
	/** IAM actions required for the ListAvailableManagedRuleGroups API call. */
	static readonly LIST_AVAILABLE_MANAGED_RULE_GROUPS: string[] = [
		"wafv2:ListAvailableManagedRuleGroups",
	];
	...
	static readonly LIST_MANAGED_RULE_SETS: string[] = [
		"wafv2:ListManagedRuleSets",
	];
	/** IAM actions required for the ListMobileSdkReleases API call. */
	static readonly LIST_MOBILE_SDK_RELEASES: string[] = [
	...
	static readonly LIST_SETTLEMENT_RECORDS: string[] = [
	...
	static readonly PUT_MANAGED_RULE_SET_VERSIONS: string[] = [
		"wafv2:PutManagedRuleSetVersions",
	];
	...
	static readonly UPDATE_MANAGED_RULE_SET_VERSION_EXPIRY_DATE: string[] = [
		"wafv2:UpdateManagedRuleSetVersionExpiryDate",
	];
...
export class Wafv2Conditions {
	...
	static readonly CREATE_REGEX_PATTERN_SET_CONDITION_KEYS: string[] = [
		"aws:RequestTag/${TagKey}",
		"aws:TagKeys",
	];
	...
	static readonly GET_IP_SET_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the GetLoggingConfiguration action. */
	static readonly GET_LOGGING_CONFIGURATION_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
		"wafv2:LogScope",
	];
	/** Condition keys applicable to the GetRateBasedStatementManagedKeys action. */
	static readonly GET_RATE_BASED_STATEMENT_MANAGED_KEYS_CONDITION_KEYS: string[] =
		["aws:ResourceTag/${TagKey}"];
	/** Condition keys applicable to the GetRegexPatternSet action. */
	static readonly GET_REGEX_PATTERN_SET_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the GetRuleGroup action. */
	static readonly GET_RULE_GROUP_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the GetWebACL action. */
	static readonly GET_WEB_ACL_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the ListLoggingConfigurations action. */
	static readonly LIST_LOGGING_CONFIGURATIONS_CONDITION_KEYS: string[] = [
		"wafv2:LogScope",
	];
	...
	static readonly PUT_LOGGING_CONFIGURATION_CONDITION_KEYS: string[] = [
	...
	static readonly UPDATE_IP_SET_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the UpdateRegexPatternSet action. */
	static readonly UPDATE_REGEX_PATTERN_SET_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the UpdateRuleGroup action. */
	static readonly UPDATE_RULE_GROUP_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
	];
	/** Condition keys applicable to the UpdateWebACL action. */
	static readonly UPDATE_WEB_ACL_CONDITION_KEYS: string[] = [
		"aws:ResourceTag/${TagKey}",
	];
