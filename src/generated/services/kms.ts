...
export class KMSActions {
	...
	static readonly DELETE_IMPORTED_KEY_MATERIAL = "kms:DeleteImportedKeyMaterial";
	...
	static readonly GENERATE_DATA_KEY_PAIR_WITHOUT_PLAINTEXT = "kms:GenerateDataKeyPairWithoutPlaintext";
	/** [Write] kms:GenerateDataKeyWithoutPlaintext */
	static readonly GENERATE_DATA_KEY_WITHOUT_PLAINTEXT = "kms:GenerateDataKeyWithoutPlaintext";
	...
	static readonly SYNCHRONIZE_MULTI_REGION_KEY = "kms:SynchronizeMultiRegionKey";
	...
	static readonly READ_ACTIONS: string[] = [KMSActions.DESCRIBE_CUSTOM_KEY_STORES, KMSActions.DESCRIBE_KEY, KMSActions.GET_KEY_LAST_USAGE, KMSActions.GET_KEY_POLICY, KMSActions.GET_KEY_ROTATION_STATUS, KMSActions.GET_PARAMETERS_FOR_IMPORT, KMSActions.GET_PUBLIC_KEY];
	/** All write-level actions. */
	static readonly WRITE_ACTIONS: string[] = [KMSActions.CANCEL_KEY_DELETION, KMSActions.CONNECT_CUSTOM_KEY_STORE, KMSActions.CREATE_ALIAS, KMSActions.CREATE_CUSTOM_KEY_STORE, KMSActions.CREATE_KEY, KMSActions.DECRYPT, KMSActions.DELETE_ALIAS, KMSActions.DELETE_CUSTOM_KEY_STORE, KMSActions.DELETE_IMPORTED_KEY_MATERIAL, KMSActions.DERIVE_SHARED_SECRET, KMSActions.DISABLE_KEY, KMSActions.DISABLE_KEY_ROTATION, KMSActions.DISCONNECT_CUSTOM_KEY_STORE, KMSActions.ENABLE_KEY, KMSActions.ENABLE_KEY_ROTATION, KMSActions.ENCRYPT, KMSActions.GENERATE_DATA_KEY, KMSActions.GENERATE_DATA_KEY_PAIR, KMSActions.GENERATE_DATA_KEY_PAIR_WITHOUT_PLAINTEXT, KMSActions.GENERATE_DATA_KEY_WITHOUT_PLAINTEXT, KMSActions.GENERATE_MAC, KMSActions.GENERATE_RANDOM, KMSActions.IMPORT_KEY_MATERIAL, KMSActions.RE_ENCRYPT_FROM, KMSActions.RE_ENCRYPT_TO, KMSActions.REPLICATE_KEY, KMSActions.ROTATE_KEY_ON_DEMAND, KMSActions.SCHEDULE_KEY_DELETION, KMSActions.SIGN, KMSActions.SYNCHRONIZE_MULTI_REGION_KEY, KMSActions.UPDATE_ALIAS, KMSActions.UPDATE_CUSTOM_KEY_STORE, KMSActions.UPDATE_KEY_DESCRIPTION, KMSActions.UPDATE_PRIMARY_REGION, KMSActions.VERIFY, KMSActions.VERIFY_MAC];
	/** All list-level actions. */
	static readonly LIST_ACTIONS: string[] = [KMSActions.LIST_ALIASES, KMSActions.LIST_GRANTS, KMSActions.LIST_KEY_POLICIES, KMSActions.LIST_KEY_ROTATIONS, KMSActions.LIST_KEYS, KMSActions.LIST_RESOURCE_TAGS, KMSActions.LIST_RETIRABLE_GRANTS];
	/** All permission-management-level actions. */
	static readonly PERMISSION_MANAGEMENT_ACTIONS: string[] = [KMSActions.CREATE_GRANT, KMSActions.PUT_KEY_POLICY, KMSActions.RETIRE_GRANT, KMSActions.REVOKE_GRANT];
	/** All tagging-level actions. */
	static readonly TAGGING_ACTIONS: string[] = [KMSActions.TAG_RESOURCE, KMSActions.UNTAG_RESOURCE];
}

const AliasArnRegex = new RegExp("^arn:(?<partition>[^:]+):kms:(?<region>[^:]*):(?<account>[^:]*):alias/(?<alias>[^:/?]+)$");
const KeyArnRegex = new RegExp("^arn:(?<partition>[^:]+):kms:(?<region>[^:]*):(?<account>[^:]*):key/(?<keyId>[^:/?]+)$");
...
export class KMSResources {
	 ...
	 */
	static parseAliasArn(arn: string): { partition: string; region: string; account: string; alias: string } {
	 ...
	 * @throws Error if the ARN does not match the expected format.
	 */
	static parseKeyArn(arn: string): { partition: string; region: string; account: string; keyId: string } {
...
export class KMSOperations {
	...
	static readonly CONNECT_CUSTOM_KEY_STORE: string[] = ["kms:ConnectCustomKeyStore"];
	...
	static readonly CREATE_CUSTOM_KEY_STORE: string[] = ["kms:CreateCustomKeyStore"];
	...
	static readonly CREATE_KEY: string[] = ["kms:CreateKey", "kms:PutKeyPolicy", "kms:TagResource"];
	...
	static readonly DELETE_CUSTOM_KEY_STORE: string[] = ["kms:DeleteCustomKeyStore"];
	/** IAM actions required for the DeleteImportedKeyMaterial API call. */
	static readonly DELETE_IMPORTED_KEY_MATERIAL: string[] = ["kms:DeleteImportedKeyMaterial"];
	...
	static readonly DESCRIBE_CUSTOM_KEY_STORES: string[] = ["kms:DescribeCustomKeyStores"];
	...
	static readonly DISCONNECT_CUSTOM_KEY_STORE: string[] = ["kms:DisconnectCustomKeyStore"];
	...
	static readonly GENERATE_DATA_KEY_PAIR: string[] = ["kms:GenerateDataKeyPair"];
	/** IAM actions required for the GenerateDataKeyPairWithoutPlaintext API call. */
	static readonly GENERATE_DATA_KEY_PAIR_WITHOUT_PLAINTEXT: string[] = ["kms:GenerateDataKeyPairWithoutPlaintext"];
	/** IAM actions required for the GenerateDataKeyWithoutPlaintext API call. */
	static readonly GENERATE_DATA_KEY_WITHOUT_PLAINTEXT: string[] = ["kms:GenerateDataKeyWithoutPlaintext"];
	...
	static readonly GET_KEY_ROTATION_STATUS: string[] = ["kms:GetKeyRotationStatus"];
	/** IAM actions required for the GetParametersForImport API call. */
	static readonly GET_PARAMETERS_FOR_IMPORT: string[] = ["kms:GetParametersForImport"];
	...
	static readonly RE_ENCRYPT: string[] = ["kms:ReEncryptFrom", "kms:ReEncryptTo"];
	...
	static readonly UPDATE_CUSTOM_KEY_STORE: string[] = ["kms:UpdateCustomKeyStore"];
	/** IAM actions required for the UpdateKeyDescription API call. */
	static readonly UPDATE_KEY_DESCRIPTION: string[] = ["kms:UpdateKeyDescription"];
...
export class KMSConditions {
	...
	static readonly CANCEL_KEY_DELETION_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the ConnectCustomKeyStore action. */
	static readonly CONNECT_CUSTOM_KEY_STORE_CONDITION_KEYS: string[] = ["kms:CallerAccount"];
	/** Condition keys applicable to the CreateAlias action. */
	static readonly CREATE_ALIAS_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the CreateCustomKeyStore action. */
	static readonly CREATE_CUSTOM_KEY_STORE_CONDITION_KEYS: string[] = ["kms:CallerAccount"];
	/** Condition keys applicable to the CreateGrant action. */
	static readonly CREATE_GRANT_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:GrantConstraintSourceArn", "kms:GrantConstraintType", "kms:GrantIsForAWSResource", "kms:GrantOperations", "kms:GranteePrincipal", "kms:GranteeServicePrincipal", "kms:RetiringPrincipal", "kms:RetiringServicePrincipal", "kms:ViaService"];
	/** Condition keys applicable to the CreateKey action. */
	static readonly CREATE_KEY_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:ResourceTag/${TagKey}", "aws:TagKeys", "kms:BypassPolicyLockoutSafetyCheck", "kms:CallerAccount", "kms:KeyOrigin", "kms:KeySpec", "kms:KeyUsage", "kms:MultiRegion", "kms:MultiRegionKeyType", "kms:ViaService"];
	...
	static readonly DELETE_ALIAS_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the DeleteCustomKeyStore action. */
	static readonly DELETE_CUSTOM_KEY_STORE_CONDITION_KEYS: string[] = ["kms:CallerAccount"];
	/** Condition keys applicable to the DeleteImportedKeyMaterial action. */
	static readonly DELETE_IMPORTED_KEY_MATERIAL_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the DeriveSharedSecret action. */
	static readonly DERIVE_SHARED_SECRET_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:KeyAgreementAlgorithm", "kms:RecipientAttestation:ImageSha384", "kms:RecipientAttestation:NitroTPMPCR0", "kms:RecipientAttestation:NitroTPMPCR1", "kms:RecipientAttestation:NitroTPMPCR10", "kms:RecipientAttestation:NitroTPMPCR11", "kms:RecipientAttestation:NitroTPMPCR12", "kms:RecipientAttestation:NitroTPMPCR13", "kms:RecipientAttestation:NitroTPMPCR14", "kms:RecipientAttestation:NitroTPMPCR15", "kms:RecipientAttestation:NitroTPMPCR16", "kms:RecipientAttestation:NitroTPMPCR17", "kms:RecipientAttestation:NitroTPMPCR18", "kms:RecipientAttestation:NitroTPMPCR19", "kms:RecipientAttestation:NitroTPMPCR2", "kms:RecipientAttestation:NitroTPMPCR20", "kms:RecipientAttestation:NitroTPMPCR21", "kms:RecipientAttestation:NitroTPMPCR22", "kms:RecipientAttestation:NitroTPMPCR23", "kms:RecipientAttestation:NitroTPMPCR3", "kms:RecipientAttestation:NitroTPMPCR4", "kms:RecipientAttestation:NitroTPMPCR5", "kms:RecipientAttestation:NitroTPMPCR6", "kms:RecipientAttestation:NitroTPMPCR7", "kms:RecipientAttestation:NitroTPMPCR8", "kms:RecipientAttestation:NitroTPMPCR9", "kms:RecipientAttestation:PCR0", "kms:RecipientAttestation:PCR1", "kms:RecipientAttestation:PCR10", "kms:RecipientAttestation:PCR11", "kms:RecipientAttestation:PCR12", "kms:RecipientAttestation:PCR13", "kms:RecipientAttestation:PCR14", "kms:RecipientAttestation:PCR15", "kms:RecipientAttestation:PCR16", "kms:RecipientAttestation:PCR17", "kms:RecipientAttestation:PCR18", "kms:RecipientAttestation:PCR19", "kms:RecipientAttestation:PCR2", "kms:RecipientAttestation:PCR20", "kms:RecipientAttestation:PCR21", "kms:RecipientAttestation:PCR22", "kms:RecipientAttestation:PCR23", "kms:RecipientAttestation:PCR24", "kms:RecipientAttestation:PCR25", "kms:RecipientAttestation:PCR26", "kms:RecipientAttestation:PCR27", "kms:RecipientAttestation:PCR28", "kms:RecipientAttestation:PCR29", "kms:RecipientAttestation:PCR3", "kms:RecipientAttestation:PCR30", "kms:RecipientAttestation:PCR31", "kms:RecipientAttestation:PCR4", "kms:RecipientAttestation:PCR5", "kms:RecipientAttestation:PCR6", "kms:RecipientAttestation:PCR7", "kms:RecipientAttestation:PCR8", "kms:RecipientAttestation:PCR9", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the DescribeCustomKeyStores action. */
	static readonly DESCRIBE_CUSTOM_KEY_STORES_CONDITION_KEYS: string[] = ["kms:CallerAccount"];
	/** Condition keys applicable to the DescribeKey action. */
	static readonly DESCRIBE_KEY_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the DisableKey action. */
	static readonly DISABLE_KEY_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:TrailingDaysWithoutKeyUsage", "kms:ViaService"];
	/** Condition keys applicable to the DisableKeyRotation action. */
	static readonly DISABLE_KEY_ROTATION_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the DisconnectCustomKeyStore action. */
	static readonly DISCONNECT_CUSTOM_KEY_STORE_CONDITION_KEYS: string[] = ["kms:CallerAccount"];
	/** Condition keys applicable to the EnableKey action. */
	static readonly ENABLE_KEY_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the EnableKeyRotation action. */
	static readonly ENABLE_KEY_ROTATION_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:RotationPeriodInDays", "kms:ViaService"];
	/** Condition keys applicable to the Encrypt action. */
	static readonly ENCRYPT_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:EncryptionAlgorithm", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the GenerateDataKey action. */
	static readonly GENERATE_DATA_KEY_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:EncryptionAlgorithm", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:RecipientAttestation:ImageSha384", "kms:RecipientAttestation:NitroTPMPCR0", "kms:RecipientAttestation:NitroTPMPCR1", "kms:RecipientAttestation:NitroTPMPCR10", "kms:RecipientAttestation:NitroTPMPCR11", "kms:RecipientAttestation:NitroTPMPCR12", "kms:RecipientAttestation:NitroTPMPCR13", "kms:RecipientAttestation:NitroTPMPCR14", "kms:RecipientAttestation:NitroTPMPCR15", "kms:RecipientAttestation:NitroTPMPCR16", "kms:RecipientAttestation:NitroTPMPCR17", "kms:RecipientAttestation:NitroTPMPCR18", "kms:RecipientAttestation:NitroTPMPCR19", "kms:RecipientAttestation:NitroTPMPCR2", "kms:RecipientAttestation:NitroTPMPCR20", "kms:RecipientAttestation:NitroTPMPCR21", "kms:RecipientAttestation:NitroTPMPCR22", "kms:RecipientAttestation:NitroTPMPCR23", "kms:RecipientAttestation:NitroTPMPCR3", "kms:RecipientAttestation:NitroTPMPCR4", "kms:RecipientAttestation:NitroTPMPCR5", "kms:RecipientAttestation:NitroTPMPCR6", "kms:RecipientAttestation:NitroTPMPCR7", "kms:RecipientAttestation:NitroTPMPCR8", "kms:RecipientAttestation:NitroTPMPCR9", "kms:RecipientAttestation:PCR0", "kms:RecipientAttestation:PCR1", "kms:RecipientAttestation:PCR10", "kms:RecipientAttestation:PCR11", "kms:RecipientAttestation:PCR12", "kms:RecipientAttestation:PCR13", "kms:RecipientAttestation:PCR14", "kms:RecipientAttestation:PCR15", "kms:RecipientAttestation:PCR16", "kms:RecipientAttestation:PCR17", "kms:RecipientAttestation:PCR18", "kms:RecipientAttestation:PCR19", "kms:RecipientAttestation:PCR2", "kms:RecipientAttestation:PCR20", "kms:RecipientAttestation:PCR21", "kms:RecipientAttestation:PCR22", "kms:RecipientAttestation:PCR23", "kms:RecipientAttestation:PCR24", "kms:RecipientAttestation:PCR25", "kms:RecipientAttestation:PCR26", "kms:RecipientAttestation:PCR27", "kms:RecipientAttestation:PCR28", "kms:RecipientAttestation:PCR29", "kms:RecipientAttestation:PCR3", "kms:RecipientAttestation:PCR30", "kms:RecipientAttestation:PCR31", "kms:RecipientAttestation:PCR4", "kms:RecipientAttestation:PCR5", "kms:RecipientAttestation:PCR6", "kms:RecipientAttestation:PCR7", "kms:RecipientAttestation:PCR8", "kms:RecipientAttestation:PCR9", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the GenerateDataKeyPair action. */
	static readonly GENERATE_DATA_KEY_PAIR_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:DataKeyPairSpec", "kms:EncryptionAlgorithm", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:RecipientAttestation:ImageSha384", "kms:RecipientAttestation:NitroTPMPCR0", "kms:RecipientAttestation:NitroTPMPCR1", "kms:RecipientAttestation:NitroTPMPCR10", "kms:RecipientAttestation:NitroTPMPCR11", "kms:RecipientAttestation:NitroTPMPCR12", "kms:RecipientAttestation:NitroTPMPCR13", "kms:RecipientAttestation:NitroTPMPCR14", "kms:RecipientAttestation:NitroTPMPCR15", "kms:RecipientAttestation:NitroTPMPCR16", "kms:RecipientAttestation:NitroTPMPCR17", "kms:RecipientAttestation:NitroTPMPCR18", "kms:RecipientAttestation:NitroTPMPCR19", "kms:RecipientAttestation:NitroTPMPCR2", "kms:RecipientAttestation:NitroTPMPCR20", "kms:RecipientAttestation:NitroTPMPCR21", "kms:RecipientAttestation:NitroTPMPCR22", "kms:RecipientAttestation:NitroTPMPCR23", "kms:RecipientAttestation:NitroTPMPCR3", "kms:RecipientAttestation:NitroTPMPCR4", "kms:RecipientAttestation:NitroTPMPCR5", "kms:RecipientAttestation:NitroTPMPCR6", "kms:RecipientAttestation:NitroTPMPCR7", "kms:RecipientAttestation:NitroTPMPCR8", "kms:RecipientAttestation:NitroTPMPCR9", "kms:RecipientAttestation:PCR0", "kms:RecipientAttestation:PCR1", "kms:RecipientAttestation:PCR10", "kms:RecipientAttestation:PCR11", "kms:RecipientAttestation:PCR12", "kms:RecipientAttestation:PCR13", "kms:RecipientAttestation:PCR14", "kms:RecipientAttestation:PCR15", "kms:RecipientAttestation:PCR16", "kms:RecipientAttestation:PCR17", "kms:RecipientAttestation:PCR18", "kms:RecipientAttestation:PCR19", "kms:RecipientAttestation:PCR2", "kms:RecipientAttestation:PCR20", "kms:RecipientAttestation:PCR21", "kms:RecipientAttestation:PCR22", "kms:RecipientAttestation:PCR23", "kms:RecipientAttestation:PCR24", "kms:RecipientAttestation:PCR25", "kms:RecipientAttestation:PCR26", "kms:RecipientAttestation:PCR27", "kms:RecipientAttestation:PCR28", "kms:RecipientAttestation:PCR29", "kms:RecipientAttestation:PCR3", "kms:RecipientAttestation:PCR30", "kms:RecipientAttestation:PCR31", "kms:RecipientAttestation:PCR4", "kms:RecipientAttestation:PCR5", "kms:RecipientAttestation:PCR6", "kms:RecipientAttestation:PCR7", "kms:RecipientAttestation:PCR8", "kms:RecipientAttestation:PCR9", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the GenerateDataKeyPairWithoutPlaintext action. */
	static readonly GENERATE_DATA_KEY_PAIR_WITHOUT_PLAINTEXT_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:DataKeyPairSpec", "kms:EncryptionAlgorithm", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the GenerateDataKeyWithoutPlaintext action. */
	static readonly GENERATE_DATA_KEY_WITHOUT_PLAINTEXT_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:EncryptionAlgorithm", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the GenerateMac action. */
	static readonly GENERATE_MAC_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:MacAlgorithm", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the GenerateRandom action. */
	static readonly GENERATE_RANDOM_CONDITION_KEYS: string[] = ["kms:RecipientAttestation:ImageSha384", "kms:RecipientAttestation:NitroTPMPCR0", "kms:RecipientAttestation:NitroTPMPCR1", "kms:RecipientAttestation:NitroTPMPCR10", "kms:RecipientAttestation:NitroTPMPCR11", "kms:RecipientAttestation:NitroTPMPCR12", "kms:RecipientAttestation:NitroTPMPCR13", "kms:RecipientAttestation:NitroTPMPCR14", "kms:RecipientAttestation:NitroTPMPCR15", "kms:RecipientAttestation:NitroTPMPCR16", "kms:RecipientAttestation:NitroTPMPCR17", "kms:RecipientAttestation:NitroTPMPCR18", "kms:RecipientAttestation:NitroTPMPCR19", "kms:RecipientAttestation:NitroTPMPCR2", "kms:RecipientAttestation:NitroTPMPCR20", "kms:RecipientAttestation:NitroTPMPCR21", "kms:RecipientAttestation:NitroTPMPCR22", "kms:RecipientAttestation:NitroTPMPCR23", "kms:RecipientAttestation:NitroTPMPCR3", "kms:RecipientAttestation:NitroTPMPCR4", "kms:RecipientAttestation:NitroTPMPCR5", "kms:RecipientAttestation:NitroTPMPCR6", "kms:RecipientAttestation:NitroTPMPCR7", "kms:RecipientAttestation:NitroTPMPCR8", "kms:RecipientAttestation:NitroTPMPCR9", "kms:RecipientAttestation:PCR0", "kms:RecipientAttestation:PCR1", "kms:RecipientAttestation:PCR10", "kms:RecipientAttestation:PCR11", "kms:RecipientAttestation:PCR12", "kms:RecipientAttestation:PCR13", "kms:RecipientAttestation:PCR14", "kms:RecipientAttestation:PCR15", "kms:RecipientAttestation:PCR16", "kms:RecipientAttestation:PCR17", "kms:RecipientAttestation:PCR18", "kms:RecipientAttestation:PCR19", "kms:RecipientAttestation:PCR2", "kms:RecipientAttestation:PCR20", "kms:RecipientAttestation:PCR21", "kms:RecipientAttestation:PCR22", "kms:RecipientAttestation:PCR23", "kms:RecipientAttestation:PCR24", "kms:RecipientAttestation:PCR25", "kms:RecipientAttestation:PCR26", "kms:RecipientAttestation:PCR27", "kms:RecipientAttestation:PCR28", "kms:RecipientAttestation:PCR29", "kms:RecipientAttestation:PCR3", "kms:RecipientAttestation:PCR30", "kms:RecipientAttestation:PCR31", "kms:RecipientAttestation:PCR4", "kms:RecipientAttestation:PCR5", "kms:RecipientAttestation:PCR6", "kms:RecipientAttestation:PCR7", "kms:RecipientAttestation:PCR8", "kms:RecipientAttestation:PCR9"];
	/** Condition keys applicable to the GetKeyLastUsage action. */
	static readonly GET_KEY_LAST_USAGE_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the GetKeyPolicy action. */
	static readonly GET_KEY_POLICY_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the GetKeyRotationStatus action. */
	static readonly GET_KEY_ROTATION_STATUS_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the GetParametersForImport action. */
	static readonly GET_PARAMETERS_FOR_IMPORT_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService", "kms:WrappingAlgorithm", "kms:WrappingKeySpec"];
	/** Condition keys applicable to the GetPublicKey action. */
	static readonly GET_PUBLIC_KEY_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the ImportKeyMaterial action. */
	static readonly IMPORT_KEY_MATERIAL_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ExpirationModel", "kms:ValidTo", "kms:ViaService"];
	/** Condition keys applicable to the ListGrants action. */
	static readonly LIST_GRANTS_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:GrantIsForAWSResource", "kms:ViaService"];
	/** Condition keys applicable to the ListKeyPolicies action. */
	static readonly LIST_KEY_POLICIES_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the ListKeyRotations action. */
	static readonly LIST_KEY_ROTATIONS_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the ListResourceTags action. */
	static readonly LIST_RESOURCE_TAGS_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the PutKeyPolicy action. */
	static readonly PUT_KEY_POLICY_CONDITION_KEYS: string[] = ["kms:BypassPolicyLockoutSafetyCheck", "kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the ReEncryptFrom action. */
	static readonly RE_ENCRYPT_FROM_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:EncryptionAlgorithm", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:ReEncryptOnSameKey", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the ReEncryptTo action. */
	static readonly RE_ENCRYPT_TO_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:EncryptionAlgorithm", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:ReEncryptOnSameKey", "kms:RequestAlias", "kms:ViaService"];
	/** Condition keys applicable to the ReplicateKey action. */
	static readonly REPLICATE_KEY_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ReplicaRegion", "kms:ViaService"];
	/** Condition keys applicable to the RetireGrant action. */
	static readonly RETIRE_GRANT_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:EncryptionContext:${EncryptionContextKey}", "kms:EncryptionContextKeys", "kms:GrantConstraintType", "kms:ViaService"];
	/** Condition keys applicable to the RevokeGrant action. */
	static readonly REVOKE_GRANT_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:GrantIsForAWSResource", "kms:ViaService"];
	/** Condition keys applicable to the RotateKeyOnDemand action. */
	static readonly ROTATE_KEY_ON_DEMAND_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the ScheduleKeyDeletion action. */
	static readonly SCHEDULE_KEY_DELETION_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ScheduleKeyDeletionPendingWindowInDays", "kms:TrailingDaysWithoutKeyUsage", "kms:ViaService"];
	/** Condition keys applicable to the Sign action. */
	static readonly SIGN_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:MessageType", "kms:RequestAlias", "kms:SigningAlgorithm", "kms:ViaService"];
	/** Condition keys applicable to the TagResource action. */
	static readonly TAG_RESOURCE_CONDITION_KEYS: string[] = ["aws:RequestTag/${TagKey}", "aws:TagKeys", "kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the UntagResource action. */
	static readonly UNTAG_RESOURCE_CONDITION_KEYS: string[] = ["aws:TagKeys", "kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the UpdateAlias action. */
	static readonly UPDATE_ALIAS_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the UpdateCustomKeyStore action. */
	static readonly UPDATE_CUSTOM_KEY_STORE_CONDITION_KEYS: string[] = ["kms:CallerAccount"];
	/** Condition keys applicable to the UpdateKeyDescription action. */
	static readonly UPDATE_KEY_DESCRIPTION_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:ViaService"];
	/** Condition keys applicable to the UpdatePrimaryRegion action. */
	static readonly UPDATE_PRIMARY_REGION_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:PrimaryRegion", "kms:ViaService"];
	/** Condition keys applicable to the Verify action. */
	static readonly VERIFY_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:MessageType", "kms:RequestAlias", "kms:SigningAlgorithm", "kms:ViaService"];
	/** Condition keys applicable to the VerifyMac action. */
	static readonly VERIFY_MAC_CONDITION_KEYS: string[] = ["kms:CallerAccount", "kms:MacAlgorithm", "kms:RequestAlias", "kms:ViaService"];
	...
	static readonly BYPASS_POLICY_LOCKOUT_SAFETY_CHECK = "kms:BypassPolicyLockoutSafetyCheck";
	...
	static readonly ENCRYPTION_CONTEXT: = "kms:EncryptionContext:${EncryptionContextKey}";
	...
	static readonly RECIPIENT_ATTESTATION:IMAGE_SHA384 = "kms:RecipientAttestation:ImageSha384";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR0 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR0 = "kms:RecipientAttestation:NitroTPMPCR0";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR1 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR1 = "kms:RecipientAttestation:NitroTPMPCR1";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR10 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR10 = "kms:RecipientAttestation:NitroTPMPCR10";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR11 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR11 = "kms:RecipientAttestation:NitroTPMPCR11";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR12 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR12 = "kms:RecipientAttestation:NitroTPMPCR12";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR13 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR13 = "kms:RecipientAttestation:NitroTPMPCR13";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR14 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR14 = "kms:RecipientAttestation:NitroTPMPCR14";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR15 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR15 = "kms:RecipientAttestation:NitroTPMPCR15";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR16 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR16 = "kms:RecipientAttestation:NitroTPMPCR16";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR17 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR17 = "kms:RecipientAttestation:NitroTPMPCR17";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR18 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR18 = "kms:RecipientAttestation:NitroTPMPCR18";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR19 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR19 = "kms:RecipientAttestation:NitroTPMPCR19";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR2 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR2 = "kms:RecipientAttestation:NitroTPMPCR2";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR20 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR20 = "kms:RecipientAttestation:NitroTPMPCR20";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR21 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR21 = "kms:RecipientAttestation:NitroTPMPCR21";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR22 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR22 = "kms:RecipientAttestation:NitroTPMPCR22";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR23 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR23 = "kms:RecipientAttestation:NitroTPMPCR23";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR3 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR3 = "kms:RecipientAttestation:NitroTPMPCR3";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR4 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR4 = "kms:RecipientAttestation:NitroTPMPCR4";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR5 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR5 = "kms:RecipientAttestation:NitroTPMPCR5";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR6 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR6 = "kms:RecipientAttestation:NitroTPMPCR6";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR7 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR7 = "kms:RecipientAttestation:NitroTPMPCR7";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR8 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR8 = "kms:RecipientAttestation:NitroTPMPCR8";
	/** Condition key: kms:RecipientAttestation:NitroTPMPCR9 (String) */
	static readonly RECIPIENT_ATTESTATION:NITRO_TPMPCR9 = "kms:RecipientAttestation:NitroTPMPCR9";
	/** Condition key: kms:RecipientAttestation:PCR0 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR0 = "kms:RecipientAttestation:PCR0";
	/** Condition key: kms:RecipientAttestation:PCR1 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR1 = "kms:RecipientAttestation:PCR1";
	/** Condition key: kms:RecipientAttestation:PCR10 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR10 = "kms:RecipientAttestation:PCR10";
	/** Condition key: kms:RecipientAttestation:PCR11 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR11 = "kms:RecipientAttestation:PCR11";
	/** Condition key: kms:RecipientAttestation:PCR12 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR12 = "kms:RecipientAttestation:PCR12";
	/** Condition key: kms:RecipientAttestation:PCR13 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR13 = "kms:RecipientAttestation:PCR13";
	/** Condition key: kms:RecipientAttestation:PCR14 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR14 = "kms:RecipientAttestation:PCR14";
	/** Condition key: kms:RecipientAttestation:PCR15 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR15 = "kms:RecipientAttestation:PCR15";
	/** Condition key: kms:RecipientAttestation:PCR16 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR16 = "kms:RecipientAttestation:PCR16";
	/** Condition key: kms:RecipientAttestation:PCR17 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR17 = "kms:RecipientAttestation:PCR17";
	/** Condition key: kms:RecipientAttestation:PCR18 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR18 = "kms:RecipientAttestation:PCR18";
	/** Condition key: kms:RecipientAttestation:PCR19 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR19 = "kms:RecipientAttestation:PCR19";
	/** Condition key: kms:RecipientAttestation:PCR2 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR2 = "kms:RecipientAttestation:PCR2";
	/** Condition key: kms:RecipientAttestation:PCR20 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR20 = "kms:RecipientAttestation:PCR20";
	/** Condition key: kms:RecipientAttestation:PCR21 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR21 = "kms:RecipientAttestation:PCR21";
	/** Condition key: kms:RecipientAttestation:PCR22 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR22 = "kms:RecipientAttestation:PCR22";
	/** Condition key: kms:RecipientAttestation:PCR23 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR23 = "kms:RecipientAttestation:PCR23";
	/** Condition key: kms:RecipientAttestation:PCR24 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR24 = "kms:RecipientAttestation:PCR24";
	/** Condition key: kms:RecipientAttestation:PCR25 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR25 = "kms:RecipientAttestation:PCR25";
	/** Condition key: kms:RecipientAttestation:PCR26 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR26 = "kms:RecipientAttestation:PCR26";
	/** Condition key: kms:RecipientAttestation:PCR27 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR27 = "kms:RecipientAttestation:PCR27";
	/** Condition key: kms:RecipientAttestation:PCR28 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR28 = "kms:RecipientAttestation:PCR28";
	/** Condition key: kms:RecipientAttestation:PCR29 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR29 = "kms:RecipientAttestation:PCR29";
	/** Condition key: kms:RecipientAttestation:PCR3 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR3 = "kms:RecipientAttestation:PCR3";
	/** Condition key: kms:RecipientAttestation:PCR30 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR30 = "kms:RecipientAttestation:PCR30";
	/** Condition key: kms:RecipientAttestation:PCR31 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR31 = "kms:RecipientAttestation:PCR31";
	/** Condition key: kms:RecipientAttestation:PCR4 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR4 = "kms:RecipientAttestation:PCR4";
	/** Condition key: kms:RecipientAttestation:PCR5 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR5 = "kms:RecipientAttestation:PCR5";
	/** Condition key: kms:RecipientAttestation:PCR6 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR6 = "kms:RecipientAttestation:PCR6";
	/** Condition key: kms:RecipientAttestation:PCR7 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR7 = "kms:RecipientAttestation:PCR7";
	/** Condition key: kms:RecipientAttestation:PCR8 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR8 = "kms:RecipientAttestation:PCR8";
	/** Condition key: kms:RecipientAttestation:PCR9 (String) */
	static readonly RECIPIENT_ATTESTATION:PCR9 = "kms:RecipientAttestation:PCR9";
	...
	static readonly SCHEDULE_KEY_DELETION_PENDING_WINDOW_IN_DAYS = "kms:ScheduleKeyDeletionPendingWindowInDays";
	...
	static readonly TRAILING_DAYS_WITHOUT_KEY_USAGE = "kms:TrailingDaysWithoutKeyUsage";
	 ...
	 */
	static bypassPolicyLockoutSafetyCheck(value: boolean): Record<string, Record<string, boolean>> {
	 ...
	 */
	static customerMasterKeySpec(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static customerMasterKeyUsage(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static dataKeyPairSpec(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static encryptionAlgorithm(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static encryptionContext:(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:EncryptionContext:${EncryptionContextKey}": value } };
	}

	/**
	 * Generates a condition block for `kms:EncryptionContextKeys`.
	 */
	static encryptionContextKeys(values: string[]): Record<string, Record<string, string[]>> {
		return { "ForAllValues:StringEquals": { "kms:EncryptionContextKeys": values } };
	}

	/**
	 * Generates a condition block for `kms:ExpirationModel`.
	 */
	static expirationModel(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static grantConstraintSourceARN(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static grantConstraintType(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static grantIsForAWSResource(value: boolean): Record<string, Record<string, boolean>> {
	 ...
	 */
	static grantOperations(values: string[]): Record<string, Record<string, string[]>> {
	 ...
	 */
	static granteePrincipal(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static granteeServicePrincipal(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static keyAgreementAlgorithm(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static multiRegionKeyType(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static reEncryptOnSameKey(value: boolean): Record<string, Record<string, boolean>> {
	 ...
	 */
	static recipientAttestation:imageSha384(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr0(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr1(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr10(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR10": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR11`.
	 */
	static recipientAttestation:nitroTpmpcr11(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR11": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR12`.
	 */
	static recipientAttestation:nitroTpmpcr12(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR12": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR13`.
	 */
	static recipientAttestation:nitroTpmpcr13(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR13": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR14`.
	 */
	static recipientAttestation:nitroTpmpcr14(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR14": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR15`.
	 */
	static recipientAttestation:nitroTpmpcr15(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR15": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR16`.
	 */
	static recipientAttestation:nitroTpmpcr16(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR16": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR17`.
	 */
	static recipientAttestation:nitroTpmpcr17(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR17": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR18`.
	 */
	static recipientAttestation:nitroTpmpcr18(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR18": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR19`.
	 */
	static recipientAttestation:nitroTpmpcr19(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR19": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR2`.
	 */
	static recipientAttestation:nitroTpmpcr2(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr20(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR20": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR21`.
	 */
	static recipientAttestation:nitroTpmpcr21(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR21": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR22`.
	 */
	static recipientAttestation:nitroTpmpcr22(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR22": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR23`.
	 */
	static recipientAttestation:nitroTpmpcr23(value: string): Record<string, Record<string, string>> {
		return { "StringEquals": { "kms:RecipientAttestation:NitroTPMPCR23": value } };
	}

	/**
	 * Generates a condition block for `kms:RecipientAttestation:NitroTPMPCR3`.
	 */
	static recipientAttestation:nitroTpmpcr3(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr4(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr5(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr6(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr7(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr8(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:nitroTpmpcr9(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr0(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr1(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr10(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr11(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr12(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr13(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr14(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr15(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr16(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr17(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr18(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr19(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr2(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr20(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr21(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr22(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr23(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr24(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr25(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr26(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr27(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr28(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr29(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr3(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr30(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr31(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr4(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr5(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr6(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr7(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr8(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static recipientAttestation:pcr9(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static resourceAliases(values: string[]): Record<string, Record<string, string[]>> {
	 ...
	 */
	static retiringPrincipal(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static retiringServicePrincipal(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static rotationPeriodInDays(value: number): Record<string, Record<string, number>> {
	 ...
	 */
	static scheduleKeyDeletionPendingWindowInDays(value: number): Record<string, Record<string, number>> {
		return { "NumericEquals": { "kms:ScheduleKeyDeletionPendingWindowInDays": value } };
	}
	 ...
	 */
	static trailingDaysWithoutKeyUsage(value: number): Record<string, Record<string, number>> {
	 ...
	 */
	static wrappingAlgorithm(value: string): Record<string, Record<string, string>> {
	 ...
	 */
	static wrappingKeySpec(value: string): Record<string, Record<string, string>> {
