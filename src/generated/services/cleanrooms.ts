...
// Source: data/service-reference/cleanrooms.json
 ...
 */
export class CleanroomsActions {
 ...
 */
export class CleanroomsResources {
	/**
	 ...
	 */
	static isValidAnalysistemplateArn(arn: string): boolean {
		return AnalysistemplateArnRegex.test(arn);
	}
	...
	static parseAnalysistemplateArn(
		...
		return {
			...
			analysisTemplateId: match.groups!.analysisTemplateId,
		};
	}
	 ...
	 */
	static isValidCollaborationArn(arn: string): boolean {
		return CollaborationArnRegex.test(arn);
	}
	...
	static parseCollaborationArn(
		...
		return {
			...
			region: match.groups.region,
			account: match.groups.account,
			collaborationId: match.groups!.collaborationId,
		};
	}
	 ...
	 */
	static isValidConfiguredaudiencemodelassociationArn(arn: string): boolean {
		return ConfiguredaudiencemodelassociationArnRegex.test(arn);
	}
	...
	static parseConfiguredaudiencemodelassociationArn(
		...
		return {
			...
			account: match.groups.account,
			membershipId: match.groups!.membershipId,
			configuredAudienceModelAssociationId:
				match.groups!.configuredAudienceModelAssociationId,
		};
	}
	 ...
	 */
	static isValidConfiguredtableArn(arn: string): boolean {
		return ConfiguredtableArnRegex.test(arn);
	}
	...
	static parseConfiguredtableArn(
		...
		return {
			...
			region: match.groups.region,
			account: match.groups.account,
			configuredTableId: match.groups!.configuredTableId,
		};
	}
	 ...
	 */
	static isValidConfiguredtableassociationArn(arn: string): boolean {
		return ConfiguredtableassociationArnRegex.test(arn);
	}
	...
	static parseConfiguredtableassociationArn(
		...
		return {
			...
			account: match.groups.account,
			membershipId: match.groups!.membershipId,
			configuredTableAssociationId: match.groups!.configuredTableAssociationId,
		};
	}
	 ...
	 */
	static isValidIdmappingtableArn(arn: string): boolean {
		return IdmappingtableArnRegex.test(arn);
	}
	...
	static parseIdmappingtableArn(
		...
		return {
			...
			account: match.groups.account,
			membershipId: match.groups!.membershipId,
			idMappingTableId: match.groups!.idMappingTableId,
		};
	}
	 ...
	 */
	static isValidIdnamespaceassociationArn(arn: string): boolean {
		return IdnamespaceassociationArnRegex.test(arn);
	}
	...
	static parseIdnamespaceassociationArn(
		...
		return {
			...
			account: match.groups.account,
			membershipId: match.groups!.membershipId,
			idNamespaceAssociationId: match.groups!.idNamespaceAssociationId,
		};
	}
	 ...
	 */
	static isValidIntermediatetableArn(arn: string): boolean {
		return IntermediatetableArnRegex.test(arn);
	}
	...
	static parseIntermediatetableArn(
		...
		return {
			...
			account: match.groups.account,
			membershipId: match.groups!.membershipId,
			intermediateTableId: match.groups!.intermediateTableId,
		};
	}
	 ...
	 */
	static isValidPrivacybudgettemplateArn(arn: string): boolean {
		return PrivacybudgettemplateArnRegex.test(arn);
	}
	...
	static parsePrivacybudgettemplateArn(
		...
		return {
			...
			account: match.groups.account,
			membershipId: match.groups!.membershipId,
			privacyBudgetTemplateId: match.groups!.privacyBudgetTemplateId,
		};
	}
}
